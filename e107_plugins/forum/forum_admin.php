...
if(!deftrue('OLD_FORUMADMIN'))
{
	...
	class forum_admin extends e_admin_dispatcher
	{
		...
		protected $menuTitle = e_PAGETITLE;
	...
	class forum_ui extends e_admin_ui
	{
		...
		protected $pluginTitle		= e_PAGETITLE;
	...
	//	protected $listOrder 	    = ' COALESCE(NULLIF(forum_parent,0), forum_id), forum_parent > 0, forum_order ';
		...
		protected $fields 		= array (
		    ...
		    'forum_sef'                 =>   array ( 'title' => LAN_SEFURL, 'type' => 'text', 'inline'=>true, 'noedit'=>false, 'data' => 'str', 'width' => 'auto', 'help' => FORLAN_214, 'readParms' => '', 'writeParms' => 'size=xxlarge', 'class' => 'left', 'thclass' => 'left',  ),
