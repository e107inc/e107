...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/forum/languages/Thai/lan_forum_viewforum.php,v $
|     $Revision: 1.1 $
...
define("LAN_02", "กลับสู่ด้านบน");
define("LAN_03", "ไป");
define("LAN_53", "Thread");
define("LAN_54", "Starter");
define("LAN_55", "ตอบกลับ");
define("LAN_56", "ดู");
define("LAN_57", "ข้อความที่โพสต์ล่าุสุด");
define("LAN_58", "ยังไม่มีหัวข้อในอภิปรายนี้.");
define("LAN_59", "คุณต้องสมัครสมาชิกและเข้าสู่ระบบเพื่อโพสต์ข้อความในอภิืปราย .เข้าสู่ระบบได้ที่เมนYou must be a registered member and logged in to post on this forum. Click on signup or login from the login menu.");
