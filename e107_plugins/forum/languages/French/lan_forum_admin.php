...
*/
  ...
  //  define("FORLAN_124", "Les Liens dans une nouvelle fenêtre");
  //  define("FORLAN_125", "Cocher cette case pour que tous les liens poster dans le forum s'ouvrent dans une nouvelle fenêtre (<i>cela s'appliquera dans le site entier</i>). ");
