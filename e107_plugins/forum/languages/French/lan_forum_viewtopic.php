 ...
 *
 * $Source: /cvsroot/touchatou/e107_french/e107_plugins/forum/languages/French/lan_forum_viewtopic.php,v $
 * $Revision: 1.11 $
...
define('LAN_405', 'Pas de sujet ultérieur');
...
define('LAN_414', 'Signaler ce message aux modérateurs');
define('LAN_415', 'Titre du sujet');
define('LAN_416', 'Saisissez votre message');
define('LAN_417', 'Les administrateurs vont être prévenus du caractère sensible de ce message. Expliquez ici ce que vous y trouvez de répréhensible.');
define('LAN_418', '<strong>Ne pas</strong> utiliser ce formulaire pour contacter un administrateur pour tout autres raisons.');
define('LAN_419', 'Envoyer votre message');
define('LAN_420', 'Cliquer pour retourner au message');
define('LAN_421', 'Alerte sur un sujet du forum par');
define('LAN_422', 'Ce message a été rapporté du site ');
define('LAN_423', 'Le message ne peut être envoyé. ');
define('LAN_424', 'Le message a été envoyé à un modérateur.<br />Merci.');
define('LAN_425', 'Message de: ');
define('LAN_426', 'Alerte pour le sujet: ');
define('LAN_427', 'Erreur lors de l’envoi de l’email');
define('LAN_428', 'Le message a été envoyé');
define('LAN_429', 'Cliquer ici pour retourner au forum');
...
define('FORLAN_101', 'Sujet par email');
define('FORLAN_102', 'Vue imprimable');
define('FORLAN_103', '[membre supprimé]');
define('FORLAN_104', 'Sujet non trouvé');
define('FORLAN_HIDDEN', 'Caché. Vous devez être connecté et répondre pour voir.');
