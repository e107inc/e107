...
//			$sql->db_Update('forum', "forum_replies=forum_replies+1, forum_lastpost_user='{$thread_poster['post_userid'])', _time}".chr(1)."{$thread_parent}' WHERE forum_id='$thread_forum_id' ");
