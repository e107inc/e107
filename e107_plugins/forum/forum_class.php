...
*/
	...
	*/
	 ...
	 *                       Empty for a query with no alias to qualify, which is
	 *                       what e_db::count() builds; the rule is stated here
	 *                       once either way.
	...
	public static function threadVisibleSql($alias = 't')
	{
		...
		$column = ($alias === '' ? '' : $alias.'.').'thread_forum_id';

		return $column.' IN ('.implode(',', array_map('intval', $visible)).')';
	}
