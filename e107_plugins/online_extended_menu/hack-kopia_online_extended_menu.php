...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/online_extended_menu/hack-kopia_online_extended_menu.php,v $
|     $Revision: 1.1 $
|     $Date: 2005-06-22 20:03:46 $
|     $Author: jacek_c $
+----------------------------------------------------------------------------+
*/
if(!defined("e_PLUGIN")){ exit; }
$text = ONLINE_EL1.GUESTS_ONLINE.",<br /> ";
//        if($pref['user_reg'] == 1){
...
$text .= "<br />".ONLINE_EL8." ".($menu_pref['most_members_online'] + $menu_pref['most_guests_online'])."<br />&nbsp;-".strtolower(ONLINE_EL2).$menu_pref['most_members_online']."<br />
&nbsp;-".strtolower(ONLINE_EL1).$menu_pref['most_guests_online']."<br />
".ONLINE_EL9." ".$datestamp."<br />";
