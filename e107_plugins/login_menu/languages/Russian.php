...
define("LOGIN_MENU_L7", "Пользователь не опознан (возможно повреждены cookies).<br />Нажмите <a href=\"".e_BASE."index.php?logout\">сюда</a> для удаления cookie.");
...
define("LOGIN_MENU_L40", "Отправить заново письмо активации"); //Re-Send Activation Email
