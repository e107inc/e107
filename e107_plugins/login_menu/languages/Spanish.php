...
define("LOGIN_MENU_L7", "No se reconoce el ID único de suario (posiblemente la cookie esté dañada).<br />Por favor <a href=\"index.php?logout\">pulse aquí</a> para borrar la cookie.");
...
// New config options
define('LOGIN_MENU_L31', 'Mostrar nuevos envios de noticias');
...
define('LOGIN_MENU_L35', 'Mostrar nuevos envios del foro');
