	...
	public function config($ui)
	{
		...
		switch($type)
		{
			...
			case "news":
				...
				{
					$config['fields']['twitter'] =   array ( 'title' => LAN_SOC_TWIT_POST, 'type' => 'text', 'tab'=>2,  'writeParms'=> array('size'=>'xxlarge', 'placeholder'=>LAN_SOC_TWIT_PHOLD), 'width' => 'auto', 'help' => '', 'readParms' => '', 'class' => 'left', 'thclass' => 'left',  );
				}
				break;
		}
