...
define("LAN_SOCIAL_205",  "Facebook comments requires that you have a facebook App ID. See the 'social login' area in admin-preferences to add one.");
define("LAN_SOCIAL_206",  "Unable to render comments. Missing Facebook appID.");
