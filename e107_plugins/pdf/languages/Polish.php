...
|
|     $Revision: 1.4 $
|     $Date: 2007-10-23 17:07:49 $
|     $Author: marcelis_pl $
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/pdf/languages/Polish.php,v $
+-----------------------------------------------------------------------------+
|     Zgodne z: /e107_plugins/pdf/languages/English.php rev. 1.3
+-----------------------------------------------------------------------------+
*/
 
define("PDF_PLUGIN_LAN_1", "PDF");
define("PDF_PLUGIN_LAN_2", "Wsparcie dla tworzenia plików PDF");
define("PDF_PLUGIN_LAN_3", "PDF");
define("PDF_PLUGIN_LAN_4", "Plugin został zainstalowany i jest gotowy do użycia.");

define("PDF_LAN_1", "PDF");
define("PDF_LAN_2", "Preferencje PDF");
define("PDF_LAN_3", "Włączone");
define("PDF_LAN_4", "Wyłączone");
define("PDF_LAN_5", "Lewy margines strony");
define("PDF_LAN_6", "Prawy margines strony");
define("PDF_LAN_7", "Górny margines strony");
...
define("PDF_LAN_19", "Strona");
define("PDF_LAN_20", "Raportowanie błędów");
