...
|
|     $Revision: 1.4 $
|     $Date: 2007-10-23 17:04:04 $
|     $Author: marcelis_pl $
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/alt_auth/languages/Polish/lan_ldap_auth.php,v $
+-----------------------------------------------------------------------------+
...
define("LDAPLAN_10", "Ustawienia zostały zaktualizowane");
define("LDAPLAN_11", "OSTRZEŻENIE:  Wystąpił problem! Moduł LDAP jest obecnie niedostepny, w związku z czym Twoje ustawienia autentykacji LDAP nie będą działać!"); // It appears as if the ldap module is not currently available, setting your auth method to LDAP will probably not work!
