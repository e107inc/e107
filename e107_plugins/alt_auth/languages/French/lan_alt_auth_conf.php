...
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/alt_auth/languages/French/lan_alt_auth_conf.php,v $
|     $Revision: 1.5 $
...
define("LAN_ALT_7", "Si la connexion échoue en employant la méthode alternative, que doit il se passer?");
define("LAN_ALT_8", "Action si l'utilisateur n'est pas trouvé");
define("LAN_ALT_9", "Si l'identifiant (username) n'est pas trouvé en employant la méthode alternative, que doit-il se passer?");
