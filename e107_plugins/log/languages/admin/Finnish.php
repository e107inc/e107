...
define("ADSTAT_ON", "Päällä");
define("ADSTAT_OFF", "Pois päältä");
...
define("ADSTAT_L2", "The statistics logger has been successfully installed. To activate, please go to the config screen ja click Activate.<br /><b>You must set the permissions of the e107_plugins/log/logs folder to 777 (chmod 777)</b>");
...
define("ADSTAT_L11", "Etsi queries");
...
define("ADSTAT_L24", "Päivitä to update script");
define("ADSTAT_L25", "Valitseed stats reset");
