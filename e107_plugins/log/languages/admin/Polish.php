...
+-----------------------------------------------------------------------------+
|     Zgodne z: /e107_plugins/log/languages/admin/English.php rev. 1.10
+-----------------------------------------------------------------------------+
*/
...
define("ADSTAT_L13", "ta opcja wymaże statystyki - ostrożnie!");
define("ADSTAT_L14", "Ilość stron");
define("ADSTAT_L15", "Aktualizuj ustawienia");
define("ADSTAT_L16", "Ustawienia statystyk");
define("ADSTAT_L17", "Ustawienia statystyk zostały zaktualizowane");
...
define("ADSTAT_L25", "Wybrane statystyki zostały zresetowane");
