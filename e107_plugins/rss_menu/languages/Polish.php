...
|
|     $Revision: 1.11 $
|     $Date: 2007-10-23 17:08:18 $
|     $Author: marcelis_pl $
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/rss_menu/languages/Polish.php,v $
+-----------------------------------------------------------------------------+
|     Zgodne z: /e107_plugins/rss_menu/languages/English.php rev. 1.15
+-----------------------------------------------------------------------------+
*/
...
define("RSS_FSP","Określone posty na forum"); // Forum Specific Post
...
define("RSS_PLUGIN_LAN_14", "Komentarze");

define("RSS_LAN_ADMINMENU_1", "Opcje RSS");  
define("RSS_LAN_ADMINMENU_2", "Wykaz");
define("RSS_LAN_ADMINMENU_4", "Import");

define("RSS_LAN_ERROR_1", "To nie jest poprawny kanał rss<br /><br /><a href='".e_SELF."'><< powróć do listy kanałów rss</a>");
define("RSS_LAN_ERROR_2", "Twój plik e107_config.php lub pliki językowe zawierają spacje bądź znaki ﻿ï»¿ przed znakami &lt;?. Powinieneś je usunąć przy pomocy edytora tekstu w formacie nie-utf8 jeśli chcesz dysponować poprawnym modułem RSS.");
...
define("RSS_LAN_ERROR_5", "Wpis rss nie istnieje"); // This rss entry does not exist
