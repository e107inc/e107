...
|
|     $Source: /cvs_backup/e107_0.7/e107_plugins/chatbox_menu/chatbox_ajax_menu.php,v $
|     $Revision: 1.1 $
|     $Date: 2005-12-05 15:35:10 $
|     $Author: mcfly_e107 $
+----------------------------------------------------------------------------+
*/
...
global $tp, $e107cache, $e_event, $e107, $footer_js, $PLUGINS_DIRECTORY, $pref;
...
else
{
	...
	$texta =  "\n<form id='chatbox' action='javascript:;' onsubmit='return(0)'><div style='text-align:center; width: 100%'>";
	if(($pref['anon_post'] == "1" && USER == FALSE))
	{
		$texta .= "\n<input class='tbox' type='text' name='nick' id='nick' value='' maxlength='50' style='width: ".$cb_width.";' /><br />";
	}
	$texta .= "\n<textarea class='tbox chatbox' name='cmessage' id='cmessage' cols='20' rows='5' style='width:".$cb_width."; overflow: auto' onselect='storeCaret(this);' onclick='storeCaret(this);' onkeyup='storeCaret(this);'></textarea>\n<br />\n<input class='button' type='submit' id='chat_submit' name='chat_submit' value='".CHATBOX_L4."' onclick=\"javascript:sendInfo('".$pref['siteurl'].$PLUGINS_DIRECTORY."chatbox_menu/chatbox_ajax_menu.php', 'chatbox_posts', this.form);\" />\n<input class='button' type='reset' name='reset' value='".CHATBOX_L5."' />";
...
{
	$ns -> tablerender($caption, "<div id='chatbox_posts'>".$text."</div>", 'chatbox');
}
?>