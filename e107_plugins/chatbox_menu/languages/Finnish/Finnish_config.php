...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/chatbox_menu/languages/Finnish/Finnish_config.php,v $
|     $Revision: 1.1 $
...
define("CHBLAN_4", "Käyttäjä");
define("CHBLAN_5", "Vieras");
define("CHBLAN_6", "unblock");
define("CHBLAN_7", "block");
define("CHBLAN_8", "poista");
define("CHBLAN_9", "Moderate Chatbox");
define("CHBLAN_10", "Moderate posts");
define("CHBLAN_11", "Pikaviestejä to display");
...
define("CHBLAN_19", "Päivitä Chatbox Settings");
...
define("CHBLAN_32", "Ylläpitäjä userclass");
