...
if (file_exists(e_PLUGIN."chatbox_menu/languages/".e_LANGUAGE."_chat.php")) {
	include_once(e_PLUGIN."chatbox_menu/languages/".e_LANGUAGE."_chat.php");
} else {
	include_once(e_PLUGIN."chatbox_menu/languages/English_chat.php");
}
