...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/list_new/languages/Norwegian.php,v $
|     $Revision: 1.1 $
...
define("PAGE_NAME", "List nye funksjoner");

define("LIST_PLUGIN_1", "List");
define("LIST_PLUGIN_2", "Denne pluginen lar deg få se en liste over de nyeste tilleggene i alle e107 kategoriene. Du kan enten se listen med data siden ditt siste besøk ,eller se en generell liste over siste funksjoner. Ved siden av siden er det også en meny. Hver sekjon er programmerbar via admin seksjonen.");
define("LIST_PLUGIN_3", "Konfigurer hovedmeny");
define("LIST_PLUGIN_4", "List_pluginen er nå klar til bruk.");
define("LIST_PLUGIN_5", "list");
define("LIST_PLUGIN_6", "Pluginen er ikke installert.");

define("LIST_ADMIN_1", "siste");
define("LIST_ADMIN_2", "oppdater innstillinger");
define("LIST_ADMIN_3", "Innstillinger oppdatert");
...
define("LIST_ADMIN_13", "Velkommen til den nye siden til ".SITENAME." ! This page shows for the most common sections of this site a list with the most recent additions in these sections.");
define("LIST_ADMIN_14", "siste tilleg");
define("LIST_ADMIN_15", "nytt siden ditt siste besøk");
