...
define("FBLAN_07", "Titre / Légende");
define("FBLAN_08", "Texte du message");
define("FBLAN_09", "Visibilité du message");
define("FBLAN_10", "Créer un nouveau message");
define("FBLAN_11", "Mettre à jour le message");
...
define("FBLAN_17", "Champ(s) non rempli(s)");
...
define("FBLAN_26", "Vous pouvez employer un modèle différent pour chaque message, ajoutez des modèles dans le répertoire ".e_PLUGIN."featurebox/templates/");
?>
