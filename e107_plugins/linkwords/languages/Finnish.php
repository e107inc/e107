...
define("LWLAN_1", "Kenttä (kentät)  jätetty täyttämättä.");
define("LWLAN_2", "Linkki word saved.");
define("LWLAN_3", "Linkki word updated.");
define("LWLAN_4", "No link words defined yet.");
define("LWLAN_5", "Word");
define("LWLAN_6", "Linkkiki");
define("LWLAN_7", "Active?");
define("LWLAN_8", "Options");
define("LWLAN_9", "yes");
define("LWLAN_10", "ei");
define("LWLAN_11", "Existing Linkkiwords");
define("LWLAN_12", "Kyllä");
define("LWLAN_13", "Ei");
define("LWLAN_14", "Lähetä LinkkiWord");
define("LWLAN_15", "Päivitä LinkkiWord");
define("LWLAN_16", "Muokkaa");
define("LWLAN_17", "Poista");
define("LWLAN_18", "Are you sure you want to delete this linkword?");
define("LWLAN_19", "Linkkiword poistettu.");
define("LWLAN_20", "Unable to find that linkword entry.");
define("LWLAN_21","Word to autolink");
define("LWLAN_22","Activate?");

define("LWLANINS_1", "Linkkiwords");
define("LWLANINS_2", "This plugin will link specified words with a defined link");
define("LWLANINS_3", "Configure LinkkiWords");
