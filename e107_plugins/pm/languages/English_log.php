...
define("LAN_AL_PM_ADM_11", "PM: Stored attachments could not be protected from direct download");
define("LAN_AL_PM_ADM_12", "PM: Attachment refused, its directory could not be protected from direct download");
