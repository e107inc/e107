...
define('ADLAN_PM_1', "To activate please go to your menus screen ja select the private_msg into one of your menu areas. <br /><br />If you need to convert messages from a previous version, please go to the main config page for this plugin ja select the 'convert' link.");
define('ADLAN_PM_2', "Configure Private Messenger");
define('ADLAN_PM_3', "PM settings not found, default values set");
define('ADLAN_PM_4', "Options Päivitäd");
define('ADLAN_PM_5', "Limit for selected käyttäjäclass already exists");
...
define('ADLAN_PM_16', "Plugin Otsikko");
define('ADLAN_PM_17', "Näytä new PM animation");
define('ADLAN_PM_18', "Näytä käyttäjä dropdown");
...
define('ADLAN_PM_26', "Kaikkiow käyttäjä to request read receipt email notifications");
define('ADLAN_PM_27', "Kaikkiow posting of attachments");
define('ADLAN_PM_28', "Maximum attachment size");
define('ADLAN_PM_29', "Kaikkiow sending to all members");
define('ADLAN_PM_30', "Kaikkiow sending to multiple receipients");
define('ADLAN_PM_31', "Enable sending to käyttäjäclass");
define('ADLAN_PM_32', "Päivitä Settings");
...
define('ADLAN_PM_38', "Koko limits (in KB)");
define('ADLAN_PM_39', "Saapuneet :");
define('ADLAN_PM_40', "Lähtevät :");
define('ADLAN_PM_41', "Keskustelualueella on currently no limits set.");
define('ADLAN_PM_42', "Päivitä Limits");
define('ADLAN_PM_43', "Add Uusi Limit");
define('ADLAN_PM_44', "sekuntia");
