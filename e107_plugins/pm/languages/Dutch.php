...
define('LAN_PM_13', "Je outbox is momenteel {PERCENT}% vol, je kan geen PM's verzenden tot je wat items verwijderd.");
define('LAN_PM_14', "FOUT: Mogelijke dubbel post, PM niet gestuurd");
define('LAN_PM_15', "je mag niet naar userclass verzenden");
...
define('LAN_PM_19', "Je outbox is vol, je mag geen PM's verzenden");
define('LAN_PM_21', "het Toevoegen van deze PM zal je maximum outbox grootte overschrijden, PM niet verzonden.");
...
define('LAN_PM_40', "PM verzenden naar gebruiker");
define('LAN_PM_41', "Er niet in geslaagd om PM aan je Outbox toe te voegen.");
...
define('LAN_PM_60', "Je hebt niet te permissies om dit bericht te bekijken");
