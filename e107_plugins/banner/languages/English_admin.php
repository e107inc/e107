...
return [
    ...
    'BNRLAN_TITLE_REMOTE_IMAGE' => "This will override any local image you have set.",
    'BNRLAN_MENU_MANAGER_CONFIG' => "The menu is now configured within the menu-manager.",
    'BNRLAN_PLACEHOLDER_OR_NEW_CLIENT' => "Or enter a new client",
    'BNRLAN_PLACEHOLDER_ENTER_CAMPAIGN' => "Enter a campaign name",
];
