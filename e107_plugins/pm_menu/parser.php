...
function pm_menu_parse($match, $referrer) {
	...
	if ('SENDPM' == $match[1] AND (check_class($pref['pm_userclass']) || $referrer == 'admin')) {
		$img = (file_exists(THEME."forum/pm.png")) ? "<img src='".THEME."forum/pm.png' alt='".PMLAN_PM."' title='".PMLAN_PM."' style='border:0' />" :
		 "<img src='".e_IMAGE."forum/pm.png' alt='".PMLAN_PM."' title='".PMLAN_PM."' style='border:0' />";
