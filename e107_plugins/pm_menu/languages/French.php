...
define(PMLAN_3, "utilisateur bloqué");
define(PMLAN_4, "utilisateurs bloqués");
define(PMLAN_5, "Envoyer un nouveau message");
define(PMLAN_6, "Voir");
define(PMLAN_7, "Pas autorisé");
define(PMLAN_8, "Vous devez être enregistré/connecté pour utiliser le système de messagerie.");
...
define(PMLAN_14, "Message effacé");
define(PMLAN_15, "Message envoyé avec succès à ");
define(PMLAN_16, "Vous n'êtes pas autorisé actuellement à utiliser la messagerie ");
define(PMLAN_17, "Cet utilisateur a bloqué vos messages.");
define(PMLAN_18, "Vous avez bien bloqué les messages de ");
define(PMLAN_19, " n'est pas autorisé à vous envoyer des messages.");
define(PMLAN_20, "Vous n'êtes pas autorisé à supprimer ce filtre!");
define(PMLAN_21, "Filtre déjà existant ");
define(PMLAN_22, "Message commencé le : ");
define(PMLAN_23, " messages ont été bloqués.");
define(PMLAN_24, "Filtre actif non trouvé.");
define(PMLAN_25, "Messages actuellement bloqués");
define(PMLAN_26, "Répondre au message privé");
