...
+----------------------------------------------------------------------------+
*/
define(PMLAN_PM,"Mensajería Privada");
define(PM_ADLAN_PM,"Mensajero Privado");
define(PM_ADLAN_1,"Configuración de MP");
define(PM_ADLAN_2,"Funciones de MP");
define(PM_ADLAN_3,"Actualizar configuración de MP");
define(PM_ADLAN_4,"Seleccionar Usuario");
define(PM_ADLAN_5,"Todos los mensajes borrados");
define(PM_ADLAN_6,"Mensajes para/de");
define(PM_ADLAN_7,"borrado");
define(PM_ADLAN_8,"Mensajes mas viejos que ");
define(PM_ADLAN_9,"días");
define(PM_ADLAN_10,"Esto borrará todos los mensajes de más de ");
define(PM_ADLAN_11,"Confirmar Borrado");
define(PM_ADLAN_12,"Cancelar");
define(PM_ADLAN_13,"Debes poner un valor.");
define(PM_ADLAN_14,"Borrar mensajes");
define(PM_ADLAN_15,"Esto borrará todos los mensajes enviados por o para el usuario: ");
define(PM_ADLAN_16,"Debes seleccionar un usuario antes.");
define(PM_ADLAN_17,"Borrar mensajes de/a usuario");
...
define(PM_ADLAN_44,"Puede activar este plugin desde el área -Menús- dentro de su área de administración.");
define(PM_ADLAN_45,"MP ha sido actualizado a la versión");
?>