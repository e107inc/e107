...
+----------------------------------------------------------------------------+
*/
// if(!defined("PAGE_NAME")){define("PAGE_NAME", "Linkkiit");}  <--
// Lisa, could you please move this out of the language file ?



define("LCLAN_PLUGIN_LAN_1", "Linkkis Page");
define("LCLAN_PLUGIN_LAN_2", "Linkkis Page For Displaying External Web Linkkis");
define("LCLAN_PLUGIN_LAN_3", "Configure Linkkis Page");
define("LCLAN_PLUGIN_LAN_4", "linkit");
define("LCLAN_PLUGIN_LAN_5", "Linkkis page has successfully installed, please configure it from the Linkkis Page link on the admin front page.");
define("LCLAN_PLUGIN_LAN_6", "Linkkis_page successfully upgraded, now using version");
...
define("LCLAN_PAGETITLE_1", "Linkkiit");
...
define("LCLAN_PAGETITLE_7", "Personal Linkki Manager");
define("LCLAN_PAGETITLE_8", "Linkki Kommentit");
define("LCLAN_PAGETITLE_9", "Lähetä Linkki");
define("LCLAN_PAGETITLE_10", "");


define("LCLAN_OPT_1", "general options");
define("LCLAN_OPT_2", "Linkki Page Options");
...
define("LCLAN_OPT_27", "allow käyttäjäs to rate links");
...
define("LCLAN_OPT_47", "these käyttäjäs can add/edit their own personal links");
...
define("LCLAN_OPT_72", "show uusimmat links");
define("LCLAN_OPT_73", "display which data");
define("LCLAN_OPT_74", "how many uusimmat links are displayed");
...
define("LCLAN_ADMIN_2", "Linkki saved to tietokanta.");
define("LCLAN_ADMIN_3", "Linkki updated in tietokanta.");
define("LCLAN_ADMIN_4", "Linkki Aihepiiri Saved");
define("LCLAN_ADMIN_5", "Linkki Aihepiiri Päivitäd");
...
define("LCLAN_ADMIN_10", "Linkkiki");
define("LCLAN_ADMIN_11", "poistettu");
define("LCLAN_ADMIN_12", "Linkki Aihepiiri");
define("LCLAN_ADMIN_13", "Lähetäted link poistettu");
define("LCLAN_ADMIN_14", "Linkkiit");

define("LCLAN_SL_1", "Lähetäted Linkkis");
define("LCLAN_SL_2", "No submitted links");
define("LCLAN_SL_3", "Linkkiki");
...
define("LCLAN_SL_9", "After submitting your link it will be reviewed by a site admin ja if appropriate it will be added to the main links page.");
...
define("LCLAN_CAT_9", "Näytä Linkkis");
...
define("LCLAN_CAT_26", "Päivitä Linkki Aihepiiri");
define("LCLAN_CAT_27", "Tyhjennä lomake");
define("LCLAN_CAT_28", "Create Linkki Aihepiiri");
define("LCLAN_CAT_29", "Linkki Aihepiiri");
...
define("LCLAN_ITEM_22", "Päivitä Linkki");
define("LCLAN_ITEM_23", "Create link");
define("LCLAN_ITEM_24", "Linkkiit");
define("LCLAN_ITEM_25", "Kuva");
define("LCLAN_ITEM_26", "Linkki Name");
...
define("LCLAN_ADMINMENU_1", "Linkki Options");
define("LCLAN_ADMINMENU_2", "Manage Linkki Aihepiirit");
define("LCLAN_ADMINMENU_3", "Create Linkki Aihepiiri");
define("LCLAN_ADMINMENU_4", "Manage Linkkis");
define("LCLAN_ADMINMENU_5", "Create Linkki");
define("LCLAN_ADMINMENU_6", "Options");
define("LCLAN_ADMINMENU_7", "Lähetäted Linkkis");
define("LCLAN_ADMINMENU_8", "Aihepiirit");

define("NT_LAN_LP_1", "Linkkis Page Events");
define("NT_LAN_LP_2", "Linkki submitted by käyttäjä");
define("NT_LAN_LP_3", "Linkki Lähetäted");

define("LNK_SCH_LAN_2", "Kaikki Linkkis Aihepiirit");
define("LNK_SCH_LAN_3", "Kaikki links details");
...
define("LAN_LINKS_10", "Top Linkkis : Refer");
define("LAN_LINKS_11", "Top Linkkis : Rating");
...
define("LAN_LINKS_33", "No Linkkis are rated yet.");
define("LAN_LINKS_34", "Keskustelualueella on currently no links");
...
define("LAN_LINKS_45", "Linkki Aihepiiri");
define("LAN_LINKS_46", "Linkki Subcategories");
define("LAN_LINKS_47", "");
define("LAN_LINKS_48", "");
define("LAN_LINKS_49", "");
...
define("LAN_ADMIN_HELP_1", "<i>the manage link categories page shows all categories present.</i><br /><br /><b>detailed list</b><br />You see a list of all categories with their icon, name ja description, options, ja sorting options.<br /><br /><b>explanation of icons</b><br />
...
define("LAN_ADMIN_HELP_5", "<i>the submitted links page shows all links that are submitted by käyttäjäs</i><br /><br /><b>detailed list</b><br />You see the link url, the name of the käyttäjä who submitted the link ja options.<br /><br /><b>explanation of icons</b><br />
...
the personal link managers are priviliged käyttäjäs who can manage their own personally added links.<br /><br />
category page<br />
...
define("LAN_ADMIN_HELP_8", "<i>this page shows all existing links in the selected category.</i><br /><br /><b>detailed list</b><br />You see a list of the links with their kuva, name, options, ja sorting options.<br /><br /><b>explanation of icons</b><br />
...
<br />
<b>order</b><br />here you can manually set the order of all the links. You need to change the values in the select boxes to the order of your kind ja press the reorder button below to save the new order.<br />");
...
define("LAN_ADMIN_HELP_10", "<i>the post submitted link page allows you to add a submitted link to the existing links</i><br /><br />A small submitted text is added into the description field.<br /><br />You can upload a new icon, ja after uploading assign the icon to the link.<br /><br />the open type allows you to define how the link will be opened when a käyttäjä clicks on it.");
?>
