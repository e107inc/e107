...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/links_page/languages/Dutch_formal.php,v $
|     $Revision: 1.2 $
...
define("LCLAN_OPT_3", "geactiveerd");
define("LCLAN_OPT_4", "gedeactiveerd");
...
define("LCLAN_OPT_11", "aantal links per pagina");
define("LCLAN_OPT_12", "categoriepagina");
define("LCLAN_OPT_13", "welke secties tonen");
define("LCLAN_OPT_14", "pictogram");
define("LCLAN_OPT_15", "beschrijving");
define("LCLAN_OPT_16", "aantal");
define("LCLAN_OPT_17", "verwijzer");
define("LCLAN_OPT_18", "url");
define("LCLAN_OPT_19", "totale categorie info regel (regel onderaan de pagina)");
define("LCLAN_OPT_20", "link naar top links : verwijzer");
define("LCLAN_OPT_21", "link naar top links : waardering");
define("LCLAN_OPT_22", "toon standaard pictogram als er geen aanwezig is");
define("LCLAN_OPT_23", "standaard sorteer methode");
define("LCLAN_OPT_24", "standaard volgorde");
define("LCLAN_OPT_25", "standaard verschalingswaarde");
define("LCLAN_OPT_26", "linkspagina");
define("LCLAN_OPT_27", "toestaan dat gebruikers links beoordelen");
define("LCLAN_OPT_28", "toon standaard pictogram als er geen aanwezig is");
define("LCLAN_OPT_29", "tonen sorteer en volgorde menu");
define("LCLAN_OPT_30", "OP");
define("LCLAN_OPT_31", "NEER");
define("LCLAN_OPT_32", "methode link openen negeren");
define("LCLAN_OPT_33", "standaard verschalingswaarde");
define("LCLAN_OPT_34", "link_naam");
...
define("LCLAN_ADMIN_4", "Linkcategorie opgeslagen");
define("LCLAN_ADMIN_5", "Linkcategorie bijgewerkt");
define("LCLAN_ADMIN_6", "Opties bewaard");
define("LCLAN_ADMIN_7", "link pictogram succesvol geupload!");
define("LCLAN_ADMIN_8", "link pictogram werd niet geupload !");
define("LCLAN_ADMIN_9", "Volorde bijgewerkt");
define("LCLAN_ADMIN_10", "Link");
define("LCLAN_ADMIN_11", "verwijderd");
...
define("LCLAN_SL_4", "Aangemeld door");
define("LCLAN_SL_5", "Opties");
define("LCLAN_SL_6", "Plaatsen");
define("LCLAN_SL_7", "Verwijderen");
define("LCLAN_SL_8", "Weet u zeker dat je deze aangemelde link wilt verwijderen?");
define("LCLAN_SL_9", "Nadat u de link hebt aangemeld, zal een beheerder de link beoordelen en, als die passend is, plaatsen.");
define("LCLAN_SL_10", "Categorie:");
define("LCLAN_SL_11", "naam");
define("LCLAN_SL_12", "url");
define("LCLAN_SL_13", "beschrijving");
define("LCLAN_SL_14", "URL naar link knop:");
define("LCLAN_SL_15", "Onderstreepte velden zijn verplicht.");
...
define("LCLAN_CAT_4", "verplaatsen");
define("LCLAN_CAT_5", "Sorteren");
define("LCLAN_CAT_6", "Bewerken");
define("LCLAN_CAT_7", "ben");
define("LCLAN_CAT_8", "Weet u zeker dat je deze categorie wilt verwijderen?");
define("LCLAN_CAT_9", "Bekijk links");
define("LCLAN_CAT_10", "Hersorteren");
define("LCLAN_CAT_11", "Geen linkcategorieën");
define("LCLAN_CAT_12", "Aanwezige linkcategorieën");
define("LCLAN_CAT_13", "Naam:");
define("LCLAN_CAT_14", "Beschrijving:");
define("LCLAN_CAT_15", "Upload en nieuw pictogram:");
define("LCLAN_CAT_16", "Auto-Thumbnail afmetingen:");
define("LCLAN_CAT_17", "Deze optie is gedeactiveerd omdat het uploaden van bestanden op uw server niet is toegestaan");
define("LCLAN_CAT_18", "De");
define("LCLAN_CAT_19", "map is niet beschrijfbaar, u moet CHMOD'den naar 777 voor het uploaden");
define("LCLAN_CAT_20", "px");
define("LCLAN_CAT_21", "upload");
define("LCLAN_CAT_22", "Kies een pictogram:");
define("LCLAN_CAT_23", "Bekijk afbeeldingen");
define("LCLAN_CAT_24", "Zichtbaar voor:");
define("LCLAN_CAT_25", "aankruisen om het datumstempel op de huidige tijd in te stellen");
define("LCLAN_CAT_26", "Update linkcategorie");
...
define("LCLAN_ITEM_4", "Naam:");
define("LCLAN_ITEM_5", "Url:");
define("LCLAN_ITEM_6", "Beschrijving:");
define("LCLAN_ITEM_7", "Upload een pictogram:");
define("LCLAN_ITEM_8", "Auto-Thumbnail afmetingen:");
define("LCLAN_ITEM_9", "Deze optie is gedeactiveerd omdat het uploaden van bestanden op uw server niet is toegestaan");
define("LCLAN_ITEM_10", "De");
define("LCLAN_ITEM_11", "map is niet beschrijfbaar, u moet CHMOD'den naar 777 voor het uploaden");
define("LCLAN_ITEM_12", "px");
define("LCLAN_ITEM_13", "upload");
define("LCLAN_ITEM_14", "Kies een pictogram:");
define("LCLAN_ITEM_15", "Bekijk afbeeldingen");
define("LCLAN_ITEM_16", "Open Type:");
define("LCLAN_ITEM_17", "Openen in hetzelfde venster");
define("LCLAN_ITEM_18", "Openen in een nieuw venster");
define("LCLAN_ITEM_19", "Openen in 600x400 minivenster");
define("LCLAN_ITEM_20", "Zichtbaar voor:");
define("LCLAN_ITEM_21", "aankruisen om het datumstempel op de huidige tijd in te stellen");
define("LCLAN_ITEM_22", "Bijwerken link");
define("LCLAN_ITEM_23", "Creëren link");
define("LCLAN_ITEM_24", "Links");
define("LCLAN_ITEM_25", "Afbeelding");
define("LCLAN_ITEM_26", "Naam link");
define("LCLAN_ITEM_27", "Opties");
define("LCLAN_ITEM_28", "Verplaatsen");
define("LCLAN_ITEM_29", "Sorteren");
define("LCLAN_ITEM_30", "hersorteren");
define("LCLAN_ITEM_31", "bewerken");
define("LCLAN_ITEM_32", "verwijderen");
define("LCLAN_ITEM_33", "Weet u zeker dat u deze link wilt verwijderen?");
...
define("LAN_LINKS_MANAGER_4", "u hebt nu nog geen links");
...
define("LAN_LINKS_19", "categorieën");
define("LAN_LINKS_20", "categorie");
define("LAN_LINKS_21", "Er");
define("LAN_LINKS_22", "is");
define("LAN_LINKS_23", "zijn");
define("LAN_LINKS_24", "totaal in");
define("LAN_LINKS_25", "Toon alle Links");
define("LAN_LINKS_26", "Verwijzingen:");
define("LAN_LINKS_27", "Klik hier om een link aan te melden");
define("LAN_LINKS_28", "Bedankt");
define("LAN_LINKS_29", "Uw link is opgeslagen en wordt beoordeeld door een beheerder.");
define("LAN_LINKS_30", "Linkcategorieën");
define("LAN_LINKS_31", "Een link aanmelden");
...
define("LAN_LINKS_50", "U hebt nu niet de autorisatie om links aan te melden");

define("LAN_ADMIN_HELP_0", "linkspage helpfunctie");

define("LAN_ADMIN_HELP_1", "<i>De pagina Beheren linkcategorieën toont alle aanwezige categorieën.</i><br /><br /><b>detailoverzicht</b><br />U ziet een overzicht van alle categorieën met hun pictogram, naam, bescrhijving, opties en sorteerinstelling.<br /><br /><b>uitleg van de pictogrammen</b><br />".LINK_ICON_LINK." : link naar de categorie<br /><br />".LINK_ICON_EDIT." : bewerk de categorie<br /><br />".LINK_ICON_DELETE." : verwijder de categorie<br /><br />".LINK_ICON_ORDER_UP." : de omhoog pijl verplaatst de categorie omhoog in de volgorde.<br /><br />".LINK_ICON_ORDER_DOWN." : de omlaag knop verplaatst de categorie naar beneden.<br /><br /><b>volgorde</b><br />hier kunt u de categorievolgorde handmatig instellen. Wijzig de waarden in de selectieveldjes naar believen en druk op de sorteerknop.<br />");

define("LAN_ADMIN_HELP_2", "<i>de maak link categorie pagina laat u nieuwe categorieën aanmaken</i><br /><br />U kunt een nieuw pictogram uploaden en het na de upload toewijzen aan de categorie.");

define("LAN_ADMIN_HELP_3", "<i>de pagina Beheren links toont eerst alle categorieën.</i><br /><br />".LINK_ICON_LINK." : link naar de categorie<br /><br />".LINK_ICON_EDIT." : klikt u op het pictogram om alle links in deze categorie te bekijken<br />");

define("LAN_ADMIN_HELP_4", "<i>de creëer link pagina staat u toe een nieuwe link op te voeren</i><br /><br />U kunt een nieuw pictogram uploaden en het na de upload toewijzen aan de link.<br /><br />Open Type laat u instellen hoe de link wordt geopend als iemand erop klikt.");

define("LAN_ADMIN_HELP_5", "<i>de pagina met aangemelde links toont alle links die door gebruikers zijn aangemeld</i><br /><br /><b>detailoverzicht</b><br />U ziet de link url, de naam van de gebruiker die de link heeft aangemeld en opties.<br /><br /><b>uitleg van de pictogrammen</b><br />".LINK_ICON_EDIT." : verplaats de aangemelde link naar het Creëer link formulier<br /><br />".LINK_ICON_DELETE." : verwijder de aangemelde link<br />");

define("LAN_ADMIN_HELP_6", "<i>via de Opties pagina kunt u het gedrag van de links_page plugin wijzigen</i><br /><br />algemene opties<br />deze instellingen worden op alle linkpagina's gebruikt.<br /><br />persoonlijke linkbeheerders<br />De persoonlijke linkbeheerders zijn geprivilegeerde leden die hun eigen toegevoegde links kunnen beheren.<br /><br />categorie pagina<br />Hier kunt u de opties voor de categoriepagina wijzigen.<br /><br />links pagina<br />Deze instellingen worden gebruikt op de link pagina's.<br /><br />verwijzingenpagina<br />Deze instellingen gelden voor de top verwijzingen linkspagina.<br /><br />beoordelingen pagina<br />Deze instellingen worden gebruikt op de hoogst gewaardeerde links pagina.<br />");

define("LAN_ADMIN_HELP_7", "<i>op de Bewerken link categorie pagina kunt u een bestaande categorie wijzigen</i><br /><br />U kunt een nieuw pictogram uploaden en het na de upload toewijzen aan de categorie.<br />U kunt datum/tijd van de link aanpassen door het vakje aan te kruisen.");

define("LAN_ADMIN_HELP_8", "<i>deze pagina toont alle aanwezige links in de geselecteerde categorie.</i><br /><br /><b>detailoverzicht</b><br />U ziet een lijst met links met hun afbeelding, naam, opties en sorteeropties.<br /><br /><b>uitleg van de pictogrammen</b><br />".LINK_ICON_LINK." : link naar de website<br /><br />".LINK_ICON_EDIT." : bewerk de link<br /><br />".LINK_ICON_DELETE." : verwijder de link<br /><br />".LINK_ICON_ORDER_UP." : de omhoog knop verplaatst de link één regel omhoog.<br /><br />".LINK_ICON_ORDER_DOWN." : de omlaag knop verplaatst de link één regel omlaag.<br /><br /><b>volgorde</b><br />hier kan de volgorde van alle links handmatig worden ingesteld. Wijzig de waarde in de selectieveldjes naar wens om de volgorde in te stellen en druk op de Sorteer knop.<br />");

define("LAN_ADMIN_HELP_9", "<i>u kunt een link wijzigen op de Bewerk link pagina</i><br /><br />U kunt een nieuw pictogram uploaden en het na de upload toewijzen aan de link.<br /><br />Open Type laat u instellen hoe de link wordt geopend als iemand erop klikt.");

define("LAN_ADMIN_HELP_10", "<i>de post aangemelde link pagina laat u een aangemelde link toevoegen aan de aanwezige links</i><br /><br />Een kleine tekst met Aangemeld wordt toegevoegd aan de beschrijving.<br /><br />U kunt een nieuw pictogram uploaden en het na de upload toewijzen aan de link.<br /><br />Open Type laat u instellen hoe de link wordt geopend als iemand erop klikt.");
