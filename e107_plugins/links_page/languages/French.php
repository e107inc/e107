...
define("LCLAN_OPT_MENU_5", "page référence");
define("LCLAN_OPT_MENU_6", "page d'évaluation");
define("LCLAN_OPT_MENU_7", "menu");
define("LCLAN_PAGETITLE_1", "Liens");
define("LCLAN_PAGETITLE_2", "Toutes les catégories");
define("LCLAN_PAGETITLE_3", "Tous les Liens");
define("LCLAN_PAGETITLE_4", "Catégorie");
define("LCLAN_PAGETITLE_5", "Top évaluation");
define("LCLAN_PAGETITLE_6", "Top Référants");
define("LCLAN_PAGETITLE_7", "Gestionnaire personnel de liens");
define("LCLAN_PAGETITLE_8", "Lien de Commentaires");
define("LCLAN_PAGETITLE_9", "Lien Proposé");
define("LCLAN_PAGETITLE_10", "");
define("LCLAN_OPT_1", "Options générales");
define("LCLAN_OPT_2", "Options Page des liens");
define("LCLAN_OPT_3", "Activé");
define("LCLAN_OPT_4", "Désactivé");
define("LCLAN_OPT_5", "px");
define("LCLAN_OPT_6", "");
define("LCLAN_OPT_7", "Divisez des catégories en pages individuelles");
define("LCLAN_OPT_8", "Autoriser la proposition de liens");
define("LCLAN_OPT_9", "Qui peut proposer des liens");
define("LCLAN_OPT_10", "Utilisez des pages multiples pour afficher les liens");
define("LCLAN_OPT_11", "Nombre de liens par page");
define("LCLAN_OPT_12", "page catégorie");
define("LCLAN_OPT_13", "Afficher quelles sections");
define("LCLAN_OPT_14", "icône");
define("LCLAN_OPT_15", "description");
define("LCLAN_OPT_16", "somme");
define("LCLAN_OPT_17", "référant");
define("LCLAN_OPT_18", "url");
define("LCLAN_OPT_19", "Ligne d'infos de catégorie totale");
define("LCLAN_OPT_20", "lien vers le top référants");
...
define("LCLAN_OPT_29", "Afficher le menu tri et ordre ");
...
define("LCLAN_OPT_37", "référant");
define("LCLAN_OPT_38", "");
define("LCLAN_OPT_39", "");
define("LCLAN_OPT_40", "nom");
define("LCLAN_OPT_41", "id");
define("LCLAN_OPT_42", "Utiliser les paramètres de lien individuel ");
define("LCLAN_OPT_43", "Ouvrir dans la même fenêtre");
define("LCLAN_OPT_44", "Ouvrir une nouvelle fenêtre");
define("LCLAN_OPT_45", "Ouvrir dans une minifenêtre de 600x400");
...
define("LCLAN_OPT_54", "Autoriser la gestion des liens personnels");
define("LCLAN_OPT_55", "Autoriser les commentaires sur tous les liens");
define("LCLAN_OPT_56", "Valeur de référence minimum");
...
define("LCLAN_OPT_65", "Afficher les catégories vides");
define("LCLAN_OPT_66", "lien vers chaque catégorie");
define("LCLAN_OPT_67", "lien vers tous les liens");
define("LCLAN_OPT_68", "Voir tous les liens");
define("LCLAN_OPT_69", "Rendu-Type de liens Navigateur ");
define("LCLAN_OPT_70", "Voir les liens de la catégorie");
define("LCLAN_OPT_71", "Rendu-Type de liens de la catégorie");
define("LCLAN_OPT_72", "Voir les liens récents");
...
define("LCLAN_OPT_80", "Légende catégories");
define("LCLAN_OPT_81", "Légende Nouveautés");
define("LCLAN_OPT_82", "Navigateur");
define("LCLAN_OPT_83", "catégories");
define("LCLAN_OPT_84", "Liste Nouveautés");
define("LCLAN_OPT_85", "Légende du menu");
...
define("LCLAN_ADMIN_5", "Catégorie de lien  mis à jour");
define("LCLAN_ADMIN_6", "Options sauvegardée");
define("LCLAN_ADMIN_7", "L'icône de liaison a été téléchargée avec succès!");
...
define("LCLAN_ADMIN_15", "Cette catégorie contient encore des liens, veuillez d'abord les enlever/déplacer.");
define("LCLAN_SL_1", "Liens proposé");
define("LCLAN_SL_2", "Pas de lien proposé");
define("LCLAN_SL_3", "Lien");
define("LCLAN_SL_4", "Proposé par");
...
define("LCLAN_SL_14", "URL vers le bouton lien:");
define("LCLAN_SL_15", "les champs soulignés sont requis.");
define("LCLAN_SL_16", "Proposer un Lien");
define("LCLAN_SL_17", "");
define("LCLAN_SL_18", "");
...
define("LCLAN_CAT_8", "Êtes vous sûr de vouloir supprimer cette catégorie?");
define("LCLAN_CAT_9", "Voir les Liens");
define("LCLAN_CAT_10", "Réordonner");
define("LCLAN_CAT_11", "Pas de catégories de liens");
define("LCLAN_CAT_12", "Catégorie de liens existantes");
define("LCLAN_CAT_13", "Nom:");
define("LCLAN_CAT_14", "Description:");
define("LCLAN_CAT_15", "Uploader une nouvelle icône");
define("LCLAN_CAT_16", "Taille de la vignette Automatique :");
define("LCLAN_CAT_17", "Cette option est déactivée tant que le téléchargement vers votre serveur n';est pas activé");
define("LCLAN_CAT_18", "le dossier ");
...
define("LCLAN_CAT_26", "Mettre à jour la catégorie de liens");
define("LCLAN_CAT_27", "Vider le Formulaire");
define("LCLAN_CAT_28", "Créer une catégorie de liens");
define("LCLAN_CAT_29", "Catégorie de liens");
define("LCLAN_ITEM_1", "Proposé par ");
define("LCLAN_ITEM_2", "Catégorie;");
define("LCLAN_ITEM_3", "Pas de catégories pour le moment");
...
define("LCLAN_ITEM_11", " n'est pas ouvert en écriture, vous devez CHMODer à 777 ce dossier avant le téléchargement vers votre serveur");
define("LCLAN_ITEM_12", "px");
define("LCLAN_ITEM_13", "upload");
define("LCLAN_ITEM_14", "Choisir une icône:");
define("LCLAN_ITEM_15", "Voir les Images");
define("LCLAN_ITEM_16", "Type d'ouverture:");
define("LCLAN_ITEM_17", "Ouvrir dans la même fenêtre");
define("LCLAN_ITEM_18", "Ouvrir dans une nouvelle fenêtre");
define("LCLAN_ITEM_19", "Ouvrir dans une mini-fenêtre 600x400");
define("LCLAN_ITEM_20", "Visible pour:");
define("LCLAN_ITEM_21", "Cocher pour mettre à jour le cachet de publication à l'heure en cours");
define("LCLAN_ITEM_22", "Mettre à  jour un lien");
define("LCLAN_ITEM_23", "Créer un lien");
define("LCLAN_ITEM_24", "Liens");
define("LCLAN_ITEM_25", "Image");
define("LCLAN_ITEM_26", "Nom du lien");
define("LCLAN_ITEM_27", "Options");
define("LCLAN_ITEM_28", "Déplacer");
define("LCLAN_ITEM_29", "Ordre");
define("LCLAN_ITEM_30", "Réordonner");
...
define("LCLAN_ADMINMENU_2", "Gérer les catégories de liens");
define("LCLAN_ADMINMENU_3", "Créer une catégorie de liens");
define("LCLAN_ADMINMENU_4", "Gérer les Liens");
define("LCLAN_ADMINMENU_5", "Créer un Lien");
define("LCLAN_ADMINMENU_6", "Options");
define("LCLAN_ADMINMENU_7", "Lien proposé");
define("LCLAN_ADMINMENU_8", "Catégories");
define("NT_LAN_LP_1", "Événements de page de liens");
define("NT_LAN_LP_2", "Lien proposé par l'utilisateur");
define("NT_LAN_LP_3", "Lien proposé");
define("LNK_SCH_LAN_2", "Toutes les catégories de liens");
define("LNK_SCH_LAN_3", "Tous les détails sur les liens");
define("LAN_LINKS_MANAGER_0", "icône");
define("LAN_LINKS_MANAGER_1", "lien");
define("LAN_LINKS_MANAGER_2", "options");
define("LAN_LINKS_MANAGER_3", "Créer un nouveau lien");
define("LAN_LINKS_MANAGER_4", "Vous n'avez pas de lien présent ");
define("LAN_LINKS_MANAGER_5", "catégorie");
define("LAN_LINKS_MANAGER_6", "");
define("LAN_LINKS_MANAGER_7", "");
define("LAN_LINKS_MANAGER_8", "");
define("LAN_LINKS_MANAGER_9", "");
define("LAN_LINKS_1", "Total des liens");
define("LAN_LINKS_2", "Total des liens activé");
define("LAN_LINKS_3", "Anonyme");
define("LAN_LINKS_4", "heading");
define("LAN_LINKS_5", "url");
define("LAN_LINKS_6", "ordre");
define("LAN_LINKS_7", "référants");
define("LAN_LINKS_8", "ascendant");
define("LAN_LINKS_9", "descendant");
define("LAN_LINKS_10", "Top liens : Référants");
define("LAN_LINKS_11", "Top liens : Évaluations");
define("LAN_LINKS_12", "Voir liens par référence");
define("LAN_LINKS_13", "Voir liens par évaluations");
define("LAN_LINKS_14", "Page d'accueil des liens");
define("LAN_LINKS_15", "trié par ");
define("LAN_LINKS_16", "dans cette catégorie");
define("LAN_LINKS_17", "lien");
define("LAN_LINKS_18", "liens");
define("LAN_LINKS_19", "catégories");
define("LAN_LINKS_20", "catégorie");
define("LAN_LINKS_21", "Il");
define("LAN_LINKS_22", "y a");
define("LAN_LINKS_23", "sont");
define("LAN_LINKS_24", "au total dans");
define("LAN_LINKS_25", "afficher tous les liens");
define("LAN_LINKS_26", "Références :");
define("LAN_LINKS_27", "proposer un lien");
define("LAN_LINKS_28", "Merci");
define("LAN_LINKS_29", "Votre lien a été sauvegardé et sera passé en revue par un administrateur de site.");
define("LAN_LINKS_30", "Catégorie de liens");
define("LAN_LINKS_31", "Proposer un lien");
define("LAN_LINKS_32", "Catégorie:");
define("LAN_LINKS_33", "Il n'y a aucun lien noté pour le moment.");
...
define("LAN_LINKS_41", "Pas de catégorie pour le moment");
define("LAN_LINKS_42", "Pas de liens référants pour le moment");
define("LAN_LINKS_43", "Voir les catégories");
define("LAN_LINKS_44", "id");
define("LAN_LINKS_45", "Catégorie de liens");
define("LAN_LINKS_46", "Sous-catégorie de liens");
