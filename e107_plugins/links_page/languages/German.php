...
define("LCLAN_OPT_MENU_4", "Linkanzeige");
...
define("LCLAN_PAGETITLE_5", "Bestbewertet");
define("LCLAN_PAGETITLE_6", "Top Referrals");
define("LCLAN_PAGETITLE_7", "Persönlicher Linkmanager");
...
define("LCLAN_OPT_8", "Erlauben Sie es, Links zu übermitteln");
define("LCLAN_OPT_9", "Wer kann Links übermitteln?");
define("LCLAN_OPT_10", "Zeige alle Links auf einer Seite");
define("LCLAN_OPT_11", "Anzahl der Links pro Seite");
define("LCLAN_OPT_12", "Kategorie Seite");
define("LCLAN_OPT_13", "Welche Bereiche sollen angezeigt werden?");
define("LCLAN_OPT_14", "Icon");
define("LCLAN_OPT_15", "Beschreibung");
define("LCLAN_OPT_16", "Anzahl");
define("LCLAN_OPT_17", "Referal");
define("LCLAN_OPT_18", "Url");
define("LCLAN_OPT_19", "Infozeile Kategorien insgesamt (Zeile ganz unten)");
define("LCLAN_OPT_20", "Link zu Top Links : Refer");
define("LCLAN_OPT_21", "Link zu Top Links : Bewertung");
define("LCLAN_OPT_22", "Zeige das gesetzte Icon, falls kein anderes vorhanden");
define("LCLAN_OPT_23", "Gesetzte Sortierungsmethode");
define("LCLAN_OPT_24", "Gesetzte Anordnungsmethode");
define("LCLAN_OPT_25", "Gesetzter Resizewert");
define("LCLAN_OPT_26", "Links Seite");
define("LCLAN_OPT_27", "Erlaube es Benutzern Links zu bewerten");
define("LCLAN_OPT_28", "Zeige das gesetzte Icon, falls kein anderes vorhanden");
define("LCLAN_OPT_29", "Zeige das Sortierungs,- und Anordnungsmenü");
define("LCLAN_OPT_30", "Aufsteigend");
define("LCLAN_OPT_31", "Absteigend");
define("LCLAN_OPT_32", "Benutze das Überschreiben der Linksöffnungsmethode");
define("LCLAN_OPT_33", "Gesetzter Resizewert");
define("LCLAN_OPT_34", "Link Name");
define("LCLAN_OPT_35", "Link Url");
define("LCLAN_OPT_36", "Link Anordnung");
define("LCLAN_OPT_37", "Link Refer");
define("LCLAN_OPT_38", "Link Icon");
define("LCLAN_OPT_39", "Link Absteigend");
define("LCLAN_OPT_40", "Link Kategorie Name");
define("LCLAN_OPT_41", "Link Kategorie Id");
define("LCLAN_OPT_42", "Benutze eigene Linkvoreinstellungen");
define("LCLAN_OPT_43", "Öffnet im selben Fenster");
define("LCLAN_OPT_44", "Öffnet im neuen Fenster");
define("LCLAN_OPT_45", "Öffnet in einem 600x400 Fenster");
...
define("LCLAN_OPT_55", "Erlaube für alle Links Kommentare");
define("LCLAN_OPT_56", "Minimum Refer Wert");
define("LCLAN_OPT_57", "Nur Links mit einem Referwert größer als der Eingetragene, werden angezeigt (0 oder leer = alle)");
define("LCLAN_OPT_58", "Link zur Linkübermittlung");
define("LCLAN_OPT_59", "Link zum persönlichen Manager (nur falls erlaubt)");
define("LCLAN_OPT_60", "Link zur Linkhauptseite");
define("LCLAN_OPT_61", "Link zu allen Kategorien");
define("LCLAN_OPT_62", "Link-Navigator anzeigen");
define("LCLAN_OPT_63", "Minimum Bewertungswert");
define("LCLAN_OPT_64", "Nur Links mit einer Bewertung größer als der eingetragene Wert, werden angezeigt (0 oder leer = alle)");
define("LCLAN_OPT_65", "Leere Kategorien anzeigen");
...
define("LCLAN_OPT_76", "Auswahlbox");
...
define("LCLAN_ADMIN_4", "Link Kategorie gespeichert");
define("LCLAN_ADMIN_5", "Link Kategorie aktualisiert");
define("LCLAN_ADMIN_6", "Optionen gespeichert");
define("LCLAN_ADMIN_7", "Link Icon wurde erfolgreich hochgeladen !");
define("LCLAN_ADMIN_8", "Link Icon wurde nicht hochgeladen !");
define("LCLAN_ADMIN_9", "Anordnung aktualisiert");
define("LCLAN_ADMIN_10", "Link");
define("LCLAN_ADMIN_11", "Gelöscht");
...
define("LCLAN_SL_4", "Übermittelt von");
define("LCLAN_SL_5", "Optionen");
define("LCLAN_SL_6", "Eintrag");
define("LCLAN_SL_7", "Löschen");
define("LCLAN_SL_8", "Sind Sie sicher diesen übermittelten Link löschen zu wollen?");
define("LCLAN_SL_9", "Nachdem Sie den Link übermittelt haben, wird er von einem Seitenadministrator überprüft und falls er angenommen wird, erscheint er auf der Links Hauptseite.");
define("LCLAN_SL_10", "Kategorie:");
define("LCLAN_SL_11", "Name");
define("LCLAN_SL_12", "Url");
define("LCLAN_SL_13", "Beschreibung");
define("LCLAN_SL_14", "URL zum Linkbutton:");
define("LCLAN_SL_15", "Unterstrichene Felder sind erforderlich.");
...
define("LCLAN_CAT_4", "Verschieben");
define("LCLAN_CAT_5", "Anordnen");
define("LCLAN_CAT_6", "Bearbeiten");
define("LCLAN_CAT_7", "sind");
define("LCLAN_CAT_8", "Sind Sie sicher diese Kategorie löschen zu wollen?");
define("LCLAN_CAT_9", "Links ansehen");
define("LCLAN_CAT_10", "Neu anordnen");
define("LCLAN_CAT_11", "Keine Link Kategorien");
define("LCLAN_CAT_12", "Bestehende Link Kategorien");
...
define("LCLAN_CAT_21", "Hochladen");
define("LCLAN_CAT_22", "Wählen Sie ein Icon:");
define("LCLAN_CAT_23", "Bilder ansehen");
define("LCLAN_CAT_24", "Sichtbar für:");
define("LCLAN_CAT_25", "Hier markieren um den Zeitstempel auf die jetzige Zeit einzustellen");
define("LCLAN_CAT_26", "Link Kategorien aktualisieren");
...
define("LCLAN_ITEM_13", "Hochladen");
define("LCLAN_ITEM_14", "Wählen Sie ein Icon:");
define("LCLAN_ITEM_15", "Bilder ansehen");
define("LCLAN_ITEM_16", "Öffnungsmethode:");
define("LCLAN_ITEM_17", "Öffnet im selben Fenster");
define("LCLAN_ITEM_18", "Öffnet im neuen Fenster");
define("LCLAN_ITEM_19", "Öffnet in einem 600x400 Fenster");
define("LCLAN_ITEM_20", "Sichtbar für:");
define("LCLAN_ITEM_21", "Hier markieren um den Zeitstempel auf die jetzige Zeit einzustellen");
define("LCLAN_ITEM_22", "Link aktualisieren");
define("LCLAN_ITEM_23", "Link erstellen");
define("LCLAN_ITEM_24", "Links");
define("LCLAN_ITEM_25", "Bild");
define("LCLAN_ITEM_26", "Link Name");
define("LCLAN_ITEM_27", "Optionen");
define("LCLAN_ITEM_28", "Verschieben");
define("LCLAN_ITEM_29", "Anordnen");
define("LCLAN_ITEM_30", "Neu anordnen");
define("LCLAN_ITEM_31", "Bearbeiten");
define("LCLAN_ITEM_32", "Löschen");
define("LCLAN_ITEM_33", "Sind Sie sicher diesen Link löschen zu wollen?");
define("LCLAN_ITEM_34", "Kein Icon");
define("LCLAN_ITEM_35", "Persönliche Links managen");
...
define("LCLAN_ADMINMENU_4", "Links managen");
...
define("LAN_LINKS_MANAGER_4", "Sie haben keine Links");
...
define("LAN_LINKS_8", "Aufsteigend");
define("LAN_LINKS_9", "Absteigend");
define("LAN_LINKS_10", "Top Links : Refer");
define("LAN_LINKS_11", "Top Links : Bewertung");
define("LAN_LINKS_12", "Top Links ansehen nach Refer");
...
define("LAN_LINKS_19", "Kategorien");
define("LAN_LINKS_20", "Kategorie");
define("LAN_LINKS_21", "Es");
define("LAN_LINKS_22", "gibt");
define("LAN_LINKS_23", "nun");
define("LAN_LINKS_24", "insgesamt");
define("LAN_LINKS_25", "Zeige alle Links");
define("LAN_LINKS_26", "Referrals:");
define("LAN_LINKS_27", "Bitte klicken Sie hier um einen Link zu übermitteln");
define("LAN_LINKS_28", "Danke");
define("LAN_LINKS_29", "Ihr Link wurde gespeichert und wird von einem Seitenadministrator überprüft werden.");
define("LAN_LINKS_30", "Link Kategorien");
define("LAN_LINKS_31", "Link übermitteln");
define("LAN_LINKS_32", "Kategorie:");
define("LAN_LINKS_33", "Es wurden bisher keine Links bewertet.");
define("LAN_LINKS_34", "Es gibt keine Links bis jetzt");
define("LAN_LINKS_35", "Persönlicher Link Manager");
define("LAN_LINKS_36", "Link Kommentare");
define("LAN_LINKS_37", "Kommentare:");
define("LAN_LINKS_38", "Datum");
define("LAN_LINKS_39", "Links");
define("LAN_LINKS_40", "Kategorie");
define("LAN_LINKS_41", "Keine Kategorien bis jetzt");
define("LAN_LINKS_42", "Keine Links refered bis jetzt");
define("LAN_LINKS_43", "Alle Kategorien ansehen");
