...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/links_page/languages/Romanian.php,v $
|     $Revision: 1.3 $
|     $Date: 2005-11-07 14:15:16 $
|     $Author: i2gh0st $
+----------------------------------------------------------------------------+
*/
...
define("LCLAN_PLUGIN_LAN_1", "Linkuri");
define("LCLAN_PLUGIN_LAN_2", "Linkuri pentru paginile exterioare");
define("LCLAN_PLUGIN_LAN_3", "Configurare Linkuri");
define("LCLAN_PLUGIN_LAN_4", "linkuri");
define("LCLAN_PLUGIN_LAN_5", "Pagina de linkuri a fost instalata cu succes, va rugam configurati-o de la linkul Linkuri din zona de administrare.");
define("LCLAN_PLUGIN_LAN_6", "Pagina de linkuri upgradata cu succes, folositzi versiunea");

define("LCLAN_OPT_MENU_1", "Optiuni generale");
define("LCLAN_OPT_MENU_2", "personal link managers");
define("LCLAN_OPT_MENU_3", "pagina de categorii");
define("LCLAN_OPT_MENU_4", "links display");
define("LCLAN_OPT_MENU_5", "refer page");
define("LCLAN_OPT_MENU_6", "rating page");
define("LCLAN_OPT_MENU_7", "meniu");

define("LCLAN_PAGETITLE_1", "Linkuri");
define("LCLAN_PAGETITLE_2", "Toate categoriile");
define("LCLAN_PAGETITLE_3", "Toate Linkurile");
...
define("LCLAN_PAGETITLE_8", "Comentarii Link");
define("LCLAN_PAGETITLE_9", "Adauga Link");
define("LCLAN_PAGETITLE_10", "");


define("LCLAN_OPT_1", "optiuni generale");
define("LCLAN_OPT_2", "Optiuni linkuri");
define("LCLAN_OPT_3", "activat");
define("LCLAN_OPT_4", "dezactivat");
define("LCLAN_OPT_5", "px");
define("LCLAN_OPT_6", "");
define("LCLAN_OPT_7", "imparte categoriile in pagini individuale");
define("LCLAN_OPT_8", "Lasa sa fie adaugate linkuri");
define("LCLAN_OPT_9", "cine poate adauga linkuri");
define("LCLAN_OPT_10", "foloseste pagini multiple pentru a arata linkurile");
define("LCLAN_OPT_11", "numarul linkurilor per pagina");
define("LCLAN_OPT_12", "pagina de categorii");
define("LCLAN_OPT_13", "arata care sectiune");
define("LCLAN_OPT_14", "icoana");
define("LCLAN_OPT_15", "descriere");
define("LCLAN_OPT_16", "total");
define("LCLAN_OPT_17", "referinta");
...
define("LCLAN_OPT_30", "crescator");
define("LCLAN_OPT_31", "descrescator");
define("LCLAN_OPT_32", "use override of link open method");
define("LCLAN_OPT_33", "default resize value");
define("LCLAN_OPT_34", "nume");
define("LCLAN_OPT_35", "url");
define("LCLAN_OPT_36", "ordine");
define("LCLAN_OPT_37", "referi");
define("LCLAN_OPT_38", "");
define("LCLAN_OPT_39", "");
define("LCLAN_OPT_40", "nume");
define("LCLAN_OPT_41", "id");
define("LCLAN_OPT_42", "foloseste setari induvidualepentru linkuri");
define("LCLAN_OPT_43", "Deschide in aceiasi fereastra");
define("LCLAN_OPT_44", "Deschide in fereastra noua");
define("LCLAN_OPT_45", "Deschide in fereastra mica de 600x400");
define("LCLAN_OPT_46", "cine poate modifica linkurile");
define("LCLAN_OPT_47", "Acesti useri pota adauga/modifica linkurile personale");
define("LCLAN_OPT_48", "permite adaugarea directa");
define("LCLAN_OPT_49", "daca este selectata linkurile pot fi adaugate direct, daca nu acestea trebuie aprobate de admin");
define("LCLAN_OPT_50", "permite stergerea directa");
define("LCLAN_OPT_51", "daca este selectata managerii linkurilor isi pot sterge linkurile lor");
...
define("LCLAN_OPT_70", "Arata categoriile de linkuri");
define("LCLAN_OPT_71", "rendertype category links");
define("LCLAN_OPT_72", "arata linkurile recente");
define("LCLAN_OPT_73", "display which data");
define("LCLAN_OPT_74", "cate linkuri recente sunt afisate");
define("LCLAN_OPT_75", "hyperlinkuri");
define("LCLAN_OPT_76", "selectbox");
define("LCLAN_OPT_77", "categorie");
define("LCLAN_OPT_78", "descriere");
...
define("LCLAN_ADMIN_9", "Ordine updatata");
define("LCLAN_ADMIN_10", "Link");
define("LCLAN_ADMIN_11", "sters");
define("LCLAN_ADMIN_12", "Categorie Linkuri");
define("LCLAN_ADMIN_13", "Submitted link deleted");
define("LCLAN_ADMIN_14", "Linkuri");

define("LCLAN_SL_1", "Linkuri adaugate");
define("LCLAN_SL_2", "Nu sun linkuri adaugate");
define("LCLAN_SL_3", "Link");
define("LCLAN_SL_4", "Adaugat de");
define("LCLAN_SL_5", "Optiuni");
define("LCLAN_SL_6", "Adauga");
define("LCLAN_SL_7", "Sterge");
define("LCLAN_SL_8", "Esti sigur ca vrei sa stergi linkul?");
define("LCLAN_SL_9", "Dupa adaugarea linkului acesta va fi analizat de admin si daca este aprobat va fi adaugat in pagina principala de linkuri.");
define("LCLAN_SL_10", "Categorie:");
define("LCLAN_SL_11", "nume");
define("LCLAN_SL_12", "url");
define("LCLAN_SL_13", "descriere");
define("LCLAN_SL_14", "URL to link button:");
define("LCLAN_SL_15", "Casutele subliniate sunt necesare.");
define("LCLAN_SL_16", "Adauga Link");
define("LCLAN_SL_17", "");
define("LCLAN_SL_18", "");

define("LCLAN_CAT_1", "Imagine");
define("LCLAN_CAT_2", "Categorie");
define("LCLAN_CAT_3", "Optiuni");
define("LCLAN_CAT_4", "Muta");
define("LCLAN_CAT_5", "Ordoneaza");
define("LCLAN_CAT_6", "Modifica");
define("LCLAN_CAT_7", "Esti");
define("LCLAN_CAT_8", "Esti sigur ca vrei sa stergi categoria?");
define("LCLAN_CAT_9", "Arata linkuri");
define("LCLAN_CAT_10", "Reordoneaza");
define("LCLAN_CAT_11", "Nu exista categorii");
define("LCLAN_CAT_12", "Exista categorii de linkuri");
define("LCLAN_CAT_13", "Nume:");
define("LCLAN_CAT_14", "Descriere:");
define("LCLAN_CAT_15", "Adauga icoana noua:");
