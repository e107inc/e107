...
define("NFLAN_19", "Exemple: 3600. La ressource d'".GLOBAL_LAN_NEWS_1."s sera mise à jour à chaque heure.");
define("NFLAN_20", "Seulement sur la page principale des ressources d'".GLOBAL_LAN_NEWS_1."s");
define("NFLAN_21", "Les deux: menu et page principale des ressources d'".GLOBAL_LAN_NEWS_1."s");
...
define("NFLAN_48", "Incapacité à enregistrer le data brut dans la base de données");
define("NFLAN_49", "Incapacité de désérialiser le data rss - utilisation d'une syntaxe non-standard");
