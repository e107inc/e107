...
define("NFLAN_16", "P채ivit채 Newsfeed");
...
define("NFLAN_18", "P채ivit채 interval in seconds");
...
define("NFLAN_23", "Newsfeed added to tietokanta.");
define("NFLAN_24", "Required field(s) left blank.");
define("NFLAN_25", "Newsfeed updated in tietokanta.");
define("NFLAN_26", "P채ivit채 Interval");
