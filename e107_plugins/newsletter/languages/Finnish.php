...
define("NLLAN_25", "P채ivit채 Newsletter");
define("NLLAN_26", "Create Newsletter");
define("NLLAN_27", "Newsletter updated in tietokanta.");
define("NLLAN_28", "Newsletter defined and saved in tietokanta.");
...
define("NLLAN_36", "P채ivit채 Newsletter Issue");
define("NLLAN_37", "Create Newsletter Issue");
define("NLLAN_38", "Newsletter updated in tietokanta.");
define("NLLAN_39", "Newsletter issue saved in tietokanta - to send out, click the 'Release Issue' button in the Options menu.");
