...
define("Integ_05", "Konnte nicht ge&ouml;ffnet werden...");
define("Integ_06", "File-Integrit&auml;t &uuml;berpr&uuml;fen");
define("Integ_07", "Keine Files vorhanden");
define("Integ_08", "&Uuml;berpr&uuml;fen");
define("Integ_09", "Core Sfv-File erstellen");
define("Integ_10", "Ausgew&auml;hlten Ordner+Unterordner <u>nicht</u> mit einbeziehen.");
define("Integ_11", "Dateiname:");
define("Integ_12", "Sfv-File erstellen");
define("Integ_13", "Integrit&auml;ts-&Uuml;berpr&uuml;fung");
define("Integ_14", "SFV-Erstellung nicht m&ouml;glich, da der Ordner ".e_PLUGIN."integrity_check/<b>{output}</b> nicht beschreibbar ist. Bitte chmodde diesen Ordner mit 777!");
define("Integ_15", "Alle Files sind v&ouml;llig in Ordnung!");
define("Integ_16", "Kein Core-crc-File vorhanden");
define("Integ_17", "Keine Plugin-crc-Files vorhanden");
define("Integ_18", "Erstelle CRC-File für Plugin");
define("Integ_19", "Core-Checksum-Files");
define("Integ_20", "Plugin-Checksum-Files");
define("Integ_21", "W&auml;hle das Plugin aus, f&uuml;r das du ein crc-file erstellen willst.");
define("Integ_22", "Benutze gzip");
define("Integ_23", "Überprüfe nur Themes-Ordner, die auf deinem Host auch existieren");
