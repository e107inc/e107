...
switch(vartrue($action)) {
   ...
   default : {
      ...
      $text .= "<div>";
      $text .= LAN_STATUS."<br/>";
      $text .= " <img src='".ADMIN_TRUE_ICON_PATH."' title='".LAN_ACTIVE_LIMITED."' alt='' style='cursor:help'/> ".LAN_ACTIVE_LIMITED."<br/>";
      $text .= " <img src='".ADMIN_WARNING_ICON_PATH."' title='".LAN_ACTIVE."' alt='' style='cursor:help'/> ".LAN_ACTIVE."<br/>";
      $text .= " <img src='".ADMIN_FALSE_ICON_PATH."' title='".LAN_INACTIVE."' alt='' style='cursor:help'/> ".LAN_INACTIVE."<br/>";
      $text .= "</div>";
