...
$SIGNIN_TEMPLATE['signin'] = '
			<ul class="navbar-nav nav-right">
				...
				<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" data-toggle="dropdown">{LAN=LAN_SIGNIN_SIGNIN} <strong class="caret"></strong></a>
...
$SIGNIN_WRAPPER['signout']['SIGNIN_ADMIN_HREF'] = '<li><a class="dropdown-item signin-sc admin" id="signin-sc-admin" href="{---}"><span class="fa fa-cogs"></span> {LAN=LAN_SIGNIN_ADMIN}</a></li>';
...
$SIGNIN_TEMPLATE['signout'] = '
		...
		<ul class="navbar-nav navbar-right">
			...
			<li class="dropdown dropdown-avatar"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-toggle="dropdown">{USER_AVATAR: w=30&h=30&crop=1&shape=circle} {SIGNIN_USERNAME} <b class="caret"></b></a>
				...
				<li>
					<a class="dropdown-item" role="button" href="{SIGNIN_PROFILE_HREF}"><span class="fa fa-user"></span> {LAN=LAN_SIGNIN_PROFILE}</a>
				</li>
				<li class="divider"></li>
				{SIGNIN_ADMIN_HREF}
