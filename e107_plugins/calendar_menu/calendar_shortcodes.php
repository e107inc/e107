...
global $CALENDAR_CALENDAR_HEADER_DAY, $day, $pref;
...
global $EVENT_CONTACT, $thisevent;
if ($thisevent['event_contact'] == ""){
	//$EVENT_CONTACT = EC_LAN_38; // Not Specified ;
	$EVENT_CONTACT = "";
}else{
	$smailaddr = explode("@", $thisevent['event_contact']);
	$EVENT_CONTACT = "<script type='text/javascript'>
	<!--
