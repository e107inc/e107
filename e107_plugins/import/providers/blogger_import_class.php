...
{	
	...
	function config()
	{
		...
		$var[0]['html'] 	= e107::getForm()->text('bloggerUrl', varset($_POST['bloggerUrl'], ''),255, 'size=xxlarge');
		$var[0]['help']		= "eg. http://blogname.blogspot.com";

		$var[1]['caption']	= "Cleanup HTML in content";
		$var[1]['html'] 	= e107::getForm()->checkbox('bloggerCleanup',1, varset($_POST['bloggerCleanup'], false));
