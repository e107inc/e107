...
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/counter_menu/languages/French.php,v $
|     $Revision: 1.1 $
...
*/
  ...
  define("COUNTER_L8", "Message Admin: <strong>Le compteur est désactivé.</strong><br />Pour l'activer, vous devez installer l'extension Compteur de Statistiques depuis <a href='".e_ADMIN."extension.php'>le gestionnaire d'extensions</a>, ensuite activez le depuis <a href='".e_PLUGIN."log/admin_config.php'>l'écran de configuration</a>.");
  ?>
