...
define("NFPM_L1", "Deze plugin toont een overzicht met de nieuwste forumdiscussies op uw startpagina");
define("NFPM_L2", "Nieuwste forumdiscussies"); 
define("NFPM_L3", "Klikt u op de link in de pluginsectie van uw beheerscherm om deze plugin te configureren");
...
define("NFPM_L13", "Bijwerken New Forum Posts instellingen");
define("NFPM_L14", "New Forum Posts instellingen opgeslagen.");
