 ...
 * @param int       $parm['titleLimit']     number of chars fo news title
 * @param int       $parm['summaryLimit']   number of chars for new summary
 * @param string    $parm['source']         latest (latest news items) | sticky (news items) | template (assigned to news-grid layout)
 * @param int       $parm['order']          n.news_datestamp DESC
 * @param int       $parm['limit']          10
