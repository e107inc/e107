...
class news_search extends e_search // include plugin-folder in the name.
{
	...
	function config()
	{
		...
		$search = array(
			...
			'return_fields'	=> array('n.news_id', 'n.news_title', 'n.news_sef', 'n.news_body', 'n.news_extended', 'n.news_summary', 'n.news_meta_keywords', 'n.news_meta_description', 'n.news_allow_comments', 'n.news_datestamp', 'n.news_category', 'c.category_name'),
