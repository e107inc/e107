...
if(!$menu_pref['banner_rendertype'] || $menu_pref['banner_rendertype'] == "1"){			//show one banner from one campaign in single menu
	$limitbanner = "1";
}elseif($menu_pref['banner_rendertype'] == "2"){										//show one banner from all campaigns in single menu
	$limitbanner = ($menu_pref['banner_amount'] ? $menu_pref['banner_amount'] : "1");
}elseif($menu_pref['banner_rendertype'] == "3"){										//show one banner from all campaigns in multiple menus
	$limitbanner = ($menu_pref['banner_amount'] ? $menu_pref['banner_amount'] : "1");
}
...
if($menu_pref['banner_rendertype'] == "1"){							//show one banner from one campaign in single menu
