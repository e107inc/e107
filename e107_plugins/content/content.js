...
function openPerfectPopup(oSrc, oWidth, oTitle, oText){
	...
	oContent += "<tr><td class='popimagediv' style='white-space:nowrap; width:"+oWidth+"px;'><img class='popimage' src='"+oSrc+"' alt='' style='width:"+oWidth+"px;'  /></td></tr>\n";
	oContent += "<tr><td class='poptext' style='width:"+oWidth+"px;'>"+oText+"</td></tr>\n";
	oContent += "<tr><td colspan='2' class='poplinkitem' style='white-space:nowrap; width:"+oWidth+"px;'>"+buttonclose+"</td></tr>\n";
	oContent += "</table>\n";
	...
	imgWin.document.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"><html>\n'+
		...
		'	color: #000;\n'+
		'}\n'+
		'a.poplink:link { color: #000; text-decoration: none; }\n'+
		'a.poplink:visited { color: #000; text-decoration: none; }\n'+
		'a.poplink:active { color: #000; text-decoration: none; }\n'+
		'a.poplink:hover{ color: #333; text-decoration: none; }\n'+
		'.button{\n'+
...
//open popup with image and text
function openHelpPopup(oWidth, oTitle, oText){
	...
	imgWin.document.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"><html>\n'+
		...
		'	color: #444;\n'+
		'}\n'+
		'a.poplink:link { color: #444; text-decoration: none; }\n'+
		'a.poplink:visited { color: #444; text-decoration: none; }\n'+
		'a.poplink:active { color: #444; text-decoration: none; }\n'+
		'a.poplink:hover{ color: #333; text-decoration: none; }\n'+
		'.button{\n'+
		'	border:1px solid #000;\n'+
		'	color: #444;\n'+
