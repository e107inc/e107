...
|
|     $Source: /cvs_backup/e107_0.7/e107_plugins/content/templates/default/content_content_template_exampleimagesleft.php,v $
|     $Revision: 1.4 $
...
if(!$CONTENT_CONTENT_TABLE){
				...
				<tr>
					<td class='content_image' style='padding-left:0; padding-right:20px;'>{CONTENT_CONTENT_TABLE_IMAGES}</td>
					<td class='content_text' colspan='3' style='width:97%;'>
