...
define("CONTENT_ADMIN_ITEM_LAN_44", "Създаване на Вашата публикация");
...
define("CONTENT_ADMIN_OPT_LAN_106", "none (), bullet (), middot (&middot;), white bullet (є), arrow (&raquo;), category_icon()");
...
define("CONTENT_ADMIN_OPT_LAN_118", "включи основна категория");
define("CONTENT_ADMIN_OPT_LAN_119", "ако е забранено се показват само подкатегориите на основната категория");
