...
define("CONTENT_ADMIN_HELP_LAN_10", "<i>this page shows all categories from the main parent category you have selected at the previous page.</i><br /><br /><b>detailed list</b><br />You see a list of all subcategories with their id, icon, author, category [subheading] and options.<br /><br /><b>edit & delete</b><br />you can edit or delete a content item using the buttons shown.<br /><br /><b>options</b><br />for the main parent category you can also set several options using the button shown.");
...
define("CONTENT_ADMIN_HELP_LAN_12", "<i>this page shows the options you can set for this main parent. Each main parent has their own specific set of options, so be sure to set them all correctly.</i><br /><br /><b>default values</b><br />By default all values are present and already updated in the preferences when you view this page, but change any setting to your own standards.<br /><br /><b>division into eight sections</b><br />the options are divided into eight main sections. You see the different section in the right menu. you can click on them to go to the specific set of options for that section.<br /><br /><b>create</b><br />in this section you can specify options for the creation of content items on the admin pages on the admins end.<br /><br /><b>submit</b><br />in this section you can specify options for the submit form of content items.<br /><br /><b>path and theme</b><br />in this section you can set a theme for this main parent, and provide path locations to where you have stored your images for this main parent.<br /><br /><b>general</b><br />in this section you can specify general options to use throughout all the content pages.<br /><br /><b>list pages</b><br />in this section you can specify options pages, where content items are listed.<br /><br /><b>category pages</b><br />in this section you can specify options how to show the category pages.<br /><br /><b>content pages</b><br />in this section you can specify options how to show the content item page.<br /><br /><b>menu</b><br />in this section you can specify options for the menu of this main parent.<br /><br />");
...
define("CONTENT_ADMIN_HELP_LAN_15", "<br /><br /><b>personal manager</b><br />you can assign admins to certain categories. In doing so, these admins can manage their personal content items within these categories from outside of the admin page (content_manager.php).");
...
define("CONTENT_ADMIN_HELP_LAN_20", "<i>if you have not yet added main parent categories, please do so at the Create New Category page.</i><br /><br /><b>main parent buttons</b><br />select a main parent category by clicking the button.<br /><br /><b>three types of ordering</b><br />there are three different ordering methods available, which will not interfere with each other.<br /><b>order category</b><br />first you can order the subcategories of this main parent (this will be used in the overview of the categories)<br /><b>order items in each category</b><br />secondly you can order the content items in each seperate subcategory (this will be used in the category overview pages of content items)<br /><b>order all items in one list</b><br />thirdly you can order all the content items of the main parent. (this will be used in the recent list of content items).");
