...
define("CONTENT_ADMIN_HELP_LAN_12", "<i>this page shows the options you can set for this main parent category.</i><br /><br /><b>division into two areas</b><br />the options are divided into two main areas.<br /><br /><b>first area</b><br />the first area contains options for the creation of items and categories on the admin pages on the admins end.<br />for instance you can set the amount of images and files to be uploadable for a content item within this main parent category.<br /><br /><b>second area</b><br />the second large area contains settings for displayinging purposes on the users end.<br /><br /><b>topics</b><br />the second area is divided into several topics.<br /><br /><b>default values</b><br />By default all values are present and already updated in the preferences when you view this page, but change any setting to your own standards.");
