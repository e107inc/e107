...
define("CONTENT_ADMIN_DATE_LAN_8", "Września");
define("CONTENT_ADMIN_DATE_LAN_9", "Października");
...
define("CONTENT_ADMIN_DATE_LAN_15", "Data rozpoczęcia");
define("CONTENT_ADMIN_DATE_LAN_16", "Data zakończenia");
define("CONTENT_ADMIN_DATE_LAN_17", "Tutaj możesz ustalić datę, od której ta publikacja będzie widoczna na stronie. Jeśli użyjesz daty, która jeszcze nie nastąpiła, publikacja będzie widoczna dopiero od wybranego przez Ciebie czasu. Jeśli natomiast chcesz opublikować ten materiał od zaraz, pozostaw te pola bez zmian.");
define("CONTENT_ADMIN_DATE_LAN_18", "Tutaj możesz ustalić datę zakończenia wyświetlania publikacji. Za pomocą daty zakończenia możesz określić, do którego momentu czasu wskazana publikacja ma być widoczna. Jeśli chcesz, aby ta publikacja była widoczna przez cały czas od daty rozpoczęcia pozostaw te pola bez zmian.");

define("CONTENT_PAGETITLE_LAN_0", "Publikacje");
define("CONTENT_PAGETITLE_LAN_1", "Strona główna");
...
define("CONTENT_ORDER_LAN_6", "odsłon (malejąco)");
define("CONTENT_ORDER_LAN_7", "działów (rosnąco)");
define("CONTENT_ORDER_LAN_8", "działów (malejąco)");
define("CONTENT_ORDER_LAN_9", "kolejności (rosnąco)");
define("CONTENT_ORDER_LAN_10", "kolejności (malejąco)");
define("CONTENT_ORDER_LAN_11", "autora (rosnąco)");
define("CONTENT_ORDER_LAN_12", "autora (malejąco)");
...
define("CONTENT_LAN_16", "[czytaj więcej]");
...
define("CONTENT_LAN_28", "Podkategorie działu");
...
define("CONTENT_LAN_33", "Przejdź do strony");
...
define("CONTENT_LAN_56", "Wyświetl wybrany dział");//show overview of
define("CONTENT_LAN_57", "Komentarzy:");
define("CONTENT_LAN_58", "Strona główna");
...
define("CONTENT_LAN_71", "publikację");
define("CONTENT_LAN_72", "Pozycja kategorii");
define("CONTENT_LAN_73", "Obecnie nie ma żadnych publikacji.");
define("CONTENT_LAN_74", "");
define("CONTENT_LAN_75", "Wyślij publikację");
