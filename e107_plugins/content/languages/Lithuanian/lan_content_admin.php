...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/content/languages/Lithuanian/lan_content_admin.php,v $
|     $Revision: 1.1 $
|     $Date: 2005-07-23 19:07:17 $
|     $Author: g3d45 $
+----------------------------------------------------------------------------+
*/
...
define("CO TENT_ADMIN_ITEM_LAN_82", "define a score");
...
define("CONTENT_ADMIN_MAIN_LAN_4", "parent tex ");
...
define("CON ENT_ADMIN_MENU_LAN_2", "Manage Category");
...
define("CONTENT_ADMIN_CONVERSION_L N_11", "conversion analysis");
...
define("CONTENT_ADMIN_CONVERSION_LAN_58", "upgrade succesfull<br /><br /><b>Please note:<br />you need to reconfigure the options for each main parent<br />and you need to delete the menus you've crea ed in your content/menus folder, and recreate them by updating the options for the specific main parents you want to use menus for.</b>");
...
define("CONTENT_PRESET_LAN_1", "error : not all fields  re filled in correctly<br />all fields need to be filled in");
...
define("CONTENT_ADMIN_OPT_LAN_19", "path to content item  ttachments
");
