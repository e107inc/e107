...
define("CONTENT_ADMIN_HELP_ITEM_1", "<i>als u nog geen hoofdoudercategorieën hebt aangemaakt, doet u dat dan nu op de <a href='".e_SELF."?type.0.cat.create'>Creëren nieuwe categorie</a> pagina.</i><br /><br />
...
define("CONTENT_ADMIN_HELP_ITEMCREATE_2", "selecteer altijd eerst de categorie voordat u andere velden invult !<br />dat is nodig omdat iedere hoofdoudercategorie (en subcategorieën daarin) andere voorkeuren kunnen hebben.<br /><br /><b>aanmaakformulier</b><br />u kunt nu alle informatie voor dit contentonderwerp invullen en het aanmelden.<br /><br />Let erop dat iedere hoofdoudercategorie andere voorkeuren kan hebben en dat er dus meer of minder velden in te vullen zijn.");

define("CONTENT_ADMIN_HELP_CAT_1", "<i>deze pagina toont alle aanwezige categorieën en subcategorieën.</i><br /><br /><b>detail overzicht</b><br />u ziet een overzicht met alle subcategorieën met hun id, pictogram, auteur, categorie [onderkop] en opties.<br ><br /><b>uitleg over de gebruikte pictogrammen</b><br />".CONTENT_ICON_EDIT." : voor alle categorieën kunt u deze knop gebruiken om de categorie te bewerken.<br />".CONTENT_ICON_DELETE." : voor alle categorieën kun je deze knop gebruiken om de categorie te verwijderen.<br />".CONTENT_ICON_OPTIONS." : alleen voor de hoofdcategorie (bovenaan de lijst) kunt u de knop gebruiken om alle opties in te stellen en beheren.<br />");
...
KIES ALTIJD EERST DE OUDERCATEGORIE VOORDAT U DE ANDERE VELDEN INVULT !<br /><br />
...
<b>detail overzicht</b><br />hier ziet u de categorie id en de categorienaam. ook treft u verschillende opties aan om de volgorde van de categorieën te wijzigen.<br /><br />
...
<img src='".e_IMAGE."admin_images/up.png' alt='' /> de omhoog knop laat u een content onderwerp één positie omhoog verplaatsen.<br />
<img src='".e_IMAGE."admin_images/down.png' alt='' /> de omlaag knop laat u een content onderwerp één positie omlaag plaatsen.<br />
<br />
<b>volgorde</b><br />hier kunt u handmatig de volgorde van alle categorieën in elke ouder bepalen. U moet de waarde in de selectievelden wijzigen in de gewenste waarde en daarna drukt u op de Bijwerken knop hieronder om de nieuwe volgorde vast te leggen.<br />");

define("CONTENT_ADMIN_HELP_ORDER_2", "<i>deze pagina toont alle content onderwerpen in de geselecteerde categorie.</i><br /><br />
<b>detail overzicht</b><br />u ziet het content id, de content auteur en de content kop. ook staan hier verschillende opties om de volgorde van de content onderwerpen te wijzigen.<br />
<br /><b>uitleg over de gebruikte pictogrammen</b><br />
<img src='".e_IMAGE."admin_images/up.png' alt='' /> de omhoog knop laat u een content onderwerp één positie omhoog verplaatsen.<br />
<img src='".e_IMAGE."admin_images/down.png' alt='' /> de omlaag knop laat u een content onderwerp één positie omlaag plaatsen.<br />
<br /><b>volgorde</b><br />hier kunt u handmatig de volgorde van alle categorieën in elke ouder bepalen. U moet de waarde in de selectievelden wijzigen in de gewenste waarde en daarna drukt u op de Bijwerken knop hieronder om de nieuwe volgorde vast te leggen.<br />");
...
<br /><b>uitleg over de gebruikte pictogrammen</b><br />
<img src='".e_IMAGE."admin_images/up.png' alt='' /> de omhoog knop laat u een content onderwerp één positie omhoog verplaatsen.<br />
<img src='".e_IMAGE."admin_images/down.png' alt='' /> de omlaag knop laat u een content onderwerp één positie omlaag verplaatsen.<br />
<br /><b>volgorde</b><br />hier kunt u handmatig de volgorde van alle categorieën in elke ouder bepalen. U moet de waarde in de selectievelden wijzigen in de gewenste waarde en daarna drukt u op de Bijwerken knop hieronder om de nieuwe volgorde vast te leggen.<br />");
...
//define("CONTENT_ADMIN_HELP_OPTION_2", "<i>deze pagina toont de opties die u voor de hoofdouder kunt instellen. Elke hoofdouder heeft een eigen set opties, let u er dus op de juiste gegevens goed in te vullen.</i><br /><br />");
...
<b>detail overzicht</b><br />U ziet hier een overzicht van deze content onderwerpen met hun id, pictogram, hoofd ouder, kop [onderkop], auteur en opties.<br /><br /><b>opties</b><br />u kunt een content onderwerp met behulp van de knoppen plaatsen of verwijderen.");

define("CONTENT_ADMIN_HELP_CAT_5", "");

define("CONTENT_ADMIN_HELP_CAT_6", "<i>deze pagina toont de opties die u voor de hoofdouder in kunt stellen. Iedere hoofdouder heeft een eigen set specifieke opties, let u er dus op om ze allemaal goed in te stellen.</i><br /><br />
<b>standaardwaarden</b><br />Standaard zijn alle waarden al aanwezig en bijgewerkt in de voorkeuren als u deze pagina bekijkt, u kunt alles naar willekeur aanpassen.<br /><br />
...
<b>pad en thema</b><br />in deze sectie kunt u het thema voor deze hoofdouder instellen en de paden opgeven waar de afbeeldingen voor deze hoofdouder te vinden zjin.<br /><br />
...
<b>menu</b><br />in deze sectie kunt u de opties instellen voor het menu van de hoofdouder.<br /><br />
");
...
define("CONTENT_ADMIN_HELP_OPTION_DIV_6", "'Deze opties gelden in het menu voor deze hoofdouder als u het menu hebt geactiveerd.<br /><br />".CONTENT_ADMIN_OPT_LAN_68."<br /><br />".CONTENT_ADMIN_OPT_LAN_118.":<br />".CONTENT_ADMIN_OPT_LAN_119."<br /><br />");
...
define("CONTENT_ADMIN_HELP_OPTION_DIV_10", "De auteurspagina toont een overzicht met alle unieke auteurs van onderwerpen in deze hoofdouder.<br /><br />U kunt instellen welke secties getoond moeten worden door het aan/uitkruisen van de vakjes.<br /><br />U kunt het aantal per pagina te tonen onderwerpen beperken.<br />");

define("CONTENT_ADMIN_HELP_OPTION_DIV_11", "De Archiefpagina toont alle contentonderwerpen in de hoofdouder.<br /><br />U kunt instellen welke secties getoond moeten worden door het aan- en uitkruisen van de vakjes.<br /><br />U kunt het e-mailadres van een auteur/niet-lid laten zien.<br /><br />U kunt het aantal per pagina te tonen onderwerpen beperken.<br /><br />".CONTENT_ADMIN_OPT_LAN_66."<br /><br />".CONTENT_ADMIN_OPT_LAN_68."");
