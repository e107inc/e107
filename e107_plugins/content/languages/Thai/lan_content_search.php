...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/content/languages/Thai/lan_content_search.php,v $
|     $Revision: 1.2 $
...
*/
define("CONT_SCH_LAN_1", "ข่าว:เนื้อหา");
define("CONT_SCH_LAN_2", "หมวดหมู่เนื้อหาทั้งหมด");
define("CONT_SCH_LAN_3", "กระทู้ตอบ:ความคิดเห็น");
define("CONT_SCH_LAN_4", "ใน");
