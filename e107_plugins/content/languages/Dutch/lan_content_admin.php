...
define('CONTENT_LATEST_LAN_1', 'Aangemelde content onderwerpen:');
define('CONTENT_STATUS_LAN_1', 'Content onderwerpen:');
...
define('CONTENT_ADMIN_ITEM_LAN_23', 'map is niet beschrijfbaar. Stel de juiste permissies voor uploaden in (CHMOD is systeem afhankelijk, hou het zo laag mogelijk.) Voor meer informatie en de mogelijkheden wat betreft CHMOD verwijzen wij je naar je hostings provider.');
...
define('CONTENT_ADMIN_ITEM_LAN_68', 'Hieronder kun je maatwerk informatie toevoegen bij dit contentonderwerp. Alle maatwerkgegevens moeten zowel een sleutel als een waarde hebben. Je kunt sleutel in het linker veld definiëren en de bijbehorende waarde in het rechterveld.<br />(bijvoorbeeld: sleutel = &quot;fotografie&quot; en waarde = &quot;al mijn eigen foto’s&quot;.');
...
define('CONTENT_ADMIN_MAIN_LAN_11', 'Omdat de oude tabel al records bevat, kunt u nu kiezen uit de volgende mogelijkheden:');
...
define('CONTENT_ADMIN_SUBMIT_LAN_5', 'Ga terug naar de <a href="'.e_SELF.'">hoofd aanmeldingspagina</a> om meer inhoud aan te melden<br />of<br />Ga naar de <a href="'.e_PLUGIN.'content/content.php">inhoud hoofdpagina</a> om de inhoud te zien.');
...
define('CONTENT_ADMIN_CONVERSION_LAN_63', 'bijwerken');
...
define('CONTENT_ADMIN_OPT_LAN_13', 'hier kunt u bepalen waar de afbeeldingen zijn of worden opgeslagen. gebruik accolades { en } als aanduiding van de gebruikelijke e107 gerelateerde padnamen - zoals {e_PLUGIN} of {e_IMAGE}. er zijn twee pictogrammen nodig voor onderwerpcategorieën: een kleine en een grote set pictogrammen.');
...
define('CONTENT_ADMIN_OPT_LAN_68', 'Voor meer informatie over datumformaten zie de <a href="http://php.net/strftime" rel="external">strftime functie pagina van php.net</a>');
...
define('CONTENT_ADMIN_OPT_LAN_138', 'Beheren content');
define('CONTENT_ADMIN_OPT_LAN_139', 'Aanmaken content');
