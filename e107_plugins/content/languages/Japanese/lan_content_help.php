...
|
|     $Source: /cvs_backup/e107_langpacks/e107_plugins/content/languages/Japanese/lan_content_help.php,v $
|     $Revision: 1.1 $
|     $Date: 2007-09-09 08:04:20 $
|     $Author: e107coders $
+----------------------------------------------------------------------------+
*/

define("CONTENT_ADMIN_HELP_1", "コンテンツ管理ヘルプエリア");

define("CONTENT_ADMIN_HELP_ITEM_1", "<i>最上位カテゴリーをまだ加えていないなら, <a href='".e_SELF."?cat.create'>カテゴリー作成</a> ページで追加してください.</i><br /><br /><b>カテゴリー</b><br />プルダウンメニューからコンテンツにあったカテゴリーを選んでください.<br /><br />プルダウンメニューから最上位カテゴリーを選ぶことは,その上位カテゴリーで全てのコンテンツアイテムを表示することです.<br />サブカテゴリを選ぶことは,指定されたサブカテゴリでそれらのコンテンツアイテムだけを示します.<br /><br />You can also use the menu on the right to view all content items for a specified category.");
...
define("CONTENT_ADMIN_HELP_OPTION_DIV_1", "このページは,管理人がアイテムページを作成する時のオプション設定するのを認めます.<br /><br />管理人（パーソナルコンテンツ管理で）が新しいコンテンツアイテムを作成するとき,どのセクションが利用できるかについて定めることができます<br /><br /><b>カスタムデータタグ</b><br />ユーザーまたは管理人はこれらのカスタムデータタグを用いて任意のフィールドをコンテンツアイテムに加えることができます. これらの任意のフィールドは、空白で key=>value の対で登録します. 例えば: 『カメラマン』というkeyフィールドを追加し,『私による全ての写真』というvalueフィールドを規定することができます. これらのkeyとvalueフィールドは,作成中のフォームの中に空のテキストフィールドとしてあります.<br /><br /><b>プリセットデータタグ</b><br />カスタムデータタグの他に,予めセットされたデータタグを提供されています.The difference is that in preset data tags, the key field already is given and the user only needs to provide the value field for the preset. In the same example as above 'photographer' can be predefined, and the user needs to provide 'all photos by me'. You can choose the element type by selecting one option in the selectbox. In the popup window, you can provide all the information for the preset data tag.<br />");
