...
while($row = $sql -> db_Fetch()){
	extract($row);
		...
		$text .= "<div style='padding-bottom: 2px;'><img src='".e_PLUGIN."content/images/articles_16.png' style='width: 16px; height: 16px; vertical-align: bottom' alt='' /> ".$content_heading.": ".$count."</div>";
}
