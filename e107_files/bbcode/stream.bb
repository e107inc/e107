...
{
	$MozparmStr .= "<param name='".$tp -> toAttribute($k)."' value='".($v ? "true" : "false")."'\n";
...
$ret .= $MozparmStr;
$ret .= "<embed src='".$tp -> toAttribute($code_text)."' WIDTH='320' HEIGHT='360' id='mediaPlayer' name='mediaPlayer' {$IEparmStr}>
</object>
";
