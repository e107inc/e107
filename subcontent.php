...
if ($action == "") {
	...
	$text = "<div style='text-align:center'><strong>".ARLAN_99."</strong><br/><br/><span class='mediumtext'>". (check_class($pref['subnews_class']) ? "| <a href='".e_BASE."submitnews.php'>".ARLAN_100."</a> " : ""). ($events_installed ? "| <a href='".e_PLUGIN."calendar_menu/event.php?ne.1086062400 '>".ARLAN_101."</a> " : ""). ($pref['article_submit'] && check_class($pref['article_submit_class']) ? "| <a href='".e_BASE."subcontent.php?article'>".ARLAN_102."</a> " : ""). ($pref['review_submit'] && check_class($pref['review_submit_class']) ? "| <a href='".e_BASE."subcontent.php?review'>".ARLAN_103."</a> " : ""). ($pref['link_submit'] && check_class($pref['link_submit_class']) ? "| <a href='".e_BASE."links.php?submit'>".ARLAN_104."</a> " : ""). ($pref['upload_enabled'] && (!$pref['upload_class'] || check_class($pref['upload_class'])) ? "| <a href='".e_BASE."upload.php'>".ARLAN_105."</a> " : "")."| </span> </div>";
...
if (isset($_POST['preview'])) {
	...
	if ($content_author == "<b>".ARLAN_92."<b>") {
		$content_author = "";
	}
}
...
if ($action == "article") {
	...
	$text .= ren_help(1, "addtext2", "help")."
		...
		<td colspan='2'  style='text-align:center' class='forumheader'>". (!$_POST['preview'] ? "<input class='button' type='submit' name='preview' value='".ARLAN_28."' />" : "<input class='button' type='submit' name='preview' value='".ARLAN_91."' />")." ". ($sub_action == "edit" || $_POST['editp']? "<input class='button' type='submit' name='update_article' value='".ADLAN_81." ".ARLAN_20."' />\n<input type='hidden' name='content_id' value='$id'>" : "<input class='button' type='submit' name='create_article' value='".ARLAN_27."' />")."
		</td>
		</tr>
		</table>
		</form>
