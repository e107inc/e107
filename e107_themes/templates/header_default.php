...
|
|   $Id: header_default.php,v 1.44 2004-12-29 02:16:21 e107coders Exp $
+---------------------------------------------------------------+
*/
...
if(!function_exists("checklayout"))
{
        ...
        {
                $sql = new db;
                global $pref, $style, $userthemes, $udirs, $userclass, $menu_pref, $dbq;
                if(strstr($str, "LOGO"))
                {
...
if(file_exists(e_BASE."favicon.ico"))
{
