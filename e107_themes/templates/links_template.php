...
if(!$LINK_SUBMIT_TABLE){
                ...
                <tr>
                        <td class='forumheader3' style='width:30%'><span style='text-decoration:underline'>".LAN_94."</span></td>
                        <td class='forumheader3' style='width:30%'>
                                <input class='tbox' type='text' name='link_name' size='60' value='' maxlength='100' />
                        </td>
                </tr>
                <tr>
                        <td class='forumheader3' style='width:30%'><span style='text-decoration:underline'>".LAN_95."</span></td>
                        <td class='forumheader3' style='width:30%'>
                                <input class='tbox' type='text' name='link_url' size='60' value='' maxlength='200' />
                        </td>
                </tr>
                <tr>
                        <td class='forumheader3' style='width:30%'><span style='text-decoration:underline'>".LAN_96."</span></td>
                        <td class='forumheader3' style='width:30%'>
