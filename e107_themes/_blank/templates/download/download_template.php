...
$DOWNLOAD_TEMPLATE['view']['item'] = "
      <div id='download'>
		   <table class='table table-striped' style='background:red'>
		      ...
		      <tr>
		         <td colspan='2' class='fcaption' style='text-align:left;'>
		            <h4>{DOWNLOAD_VIEW_NAME} {DOWNLOAD_ADMIN_EDIT} {DOWNLOAD_TEST} </h4>
		         </td>
		      </tr>
...
$DOWNLOAD_TEMPLATE['header'] = '{DOWNLOAD_BREADCRUMB} Custom';
//$DOWNLOAD_TEMPLATE['footer'] = '';

$DOWNLOAD_TEMPLATE['other'] = 'test';
