...
if (isset($_POST['mainmenu_link']) && $_POST['type_content'] == 2 && !$_POST['preview']){
	if (!$sql->db_Select("links", "link_id", "link_name='".$_POST['menu_name']."' AND link_category='1' "))	{
		$sql->db_Insert("links", "0, '".$_POST['menu_name']."', '".$PLUGINS_DIRECTORY."custompages/".$_POST['menu_name'].".php', '', '', '1', '0', '0', '0', '".$_POST['link_class']."'");
...
if ((isset($_POST['add_menu']) || isset($_POST['update_menu'])) && $_POST['type_content'] == 1){
	...
	if (!$_POST['menu_name'] || !$_POST['menu_caption'] || !$_POST['menu_text']){
		...
		"global ".chr(36)."tp;\n". chr(36)."caption = ".chr(36)."tp->toHTML(".chr(36)."caption, TRUE);\n".
        chr(36)."lang = (USERLAN ? USERLAN : 'English');\n".
...
.chr(36)."caption['".$custpage_lang."'] = ".chr(34).$_POST['menu_caption'].chr(34).";\n".
chr(36)."content['".$custpage_lang."'] = ".chr(34).$_POST['menu_text'].chr(34).";\n\n".
"global ".chr(36)."tp;\n".
