...
class mailout_main_ui extends e_admin_ui
{
	...
	//	protected $editQry			= "SELECT * FROM #mail_content WHERE cust_id = {ID}";
		...
		protected $fields = array(
			...
			'mail_title' 			=> array('title' => LAN_MAILOUT_140, 'type'=>'text', 'forced' => TRUE, 'data'=>'str', 'inline'=>true, 'writeParms'=>'size=xxlarge&required=1', 'help'=>''),
...
class mailout_admin_form_ui extends e_admin_form_ui
{
	...
	function options($parms, $value, $id, $attributes)
	{
		...
		if($mode == 'main')
		{
			...
			$text .= "<a rel='external' class='btn btn-default e-modal' data-modal-caption='Email ".LAN_PREVIEW."' href='".$preview."'  title='".LAN_PREVIEW."'>".E_32_SEARCH."</a>";
...
class mailout_recipients_form_ui extends e_admin_form_ui
{
	...
	function options($parms, $value, $id, $attributes)
	{
		...
		$text = "<span class='btn-group'>";
		$text .= "<a rel='external' class='btn btn-default e-modal' data-modal-caption='Email ".LAN_PREVIEW."' href='".$preview."' class='btn' title='".LAN_PREVIEW."'>".E_32_SEARCH."</a>";
