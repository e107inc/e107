...
if ($action == "cat") {
	...
	if ($id) {
		$text .= "<input class='button' type='submit' name='update_category' value='".REVLAN_38."' />
			".$rs->form_button("submit", "category_clear", REVLAN_69). $rs->form_hidden("category_id", $id)."
			</td></tr>";
	} else {
...
if ($action == "create") {
	...
	$text .= "
		<tr>
		<td  class='forumheader3'>".REVLAN_71.":&nbsp;&nbsp;</td><td class='forumheader3'>". ($content_pe_icon ? REVLAN_72.": <input type='radio' name='add_icons' value='1' checked='checked' />".REVLAN_73.": <input type='radio' name='add_icons' value='0' />" : REVLAN_72.": <input type='radio' name='add_icons' value='1' />".REVLAN_73.": <input type='radio' name='add_icons' value='0' checked='checked' />")."
		</td>
		</tr>
...
if ($action == "opt") {
	...
	$text = "<div style='text-align:center'>
		...
		<td class='forumheader3' style='width:30%;text-align:center'>". ($pref['review_submit'] ? "<input type='checkbox' name='review_submit' value='1' checked='checked' />" : "<input type='checkbox' name='review_submit' value='1' />")."
		</td>
		</tr>
