...
$text = "<div style='text-align:center'>
	...
	<td style='width:50%' class='forumheader3'>". ($pref['upload_enabled'] == 1 ? $rs->form_radio("upload_enabled", 1, 1)." ".UPLLAN_27.$rs->form_radio("upload_enabled", 0)." ".UPLLAN_28 : $rs->form_radio("upload_enabled", 1)." ".UPLLAN_27.$rs->form_radio("upload_enabled", 0, 1)." ".UPLLAN_28)."
	</td>
	</tr>
