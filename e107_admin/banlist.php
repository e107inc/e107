...
class banlist_admin extends e_admin_dispatcher
{
	...
	protected $adminMenu = array(
		...
		'main/list'			=> array('caption'=> BANLAN_122, 'perm' => '4'), //TODO check for LAN.
		...
		'failed/list'       => array('caption'=> BANLAN_124, 'perm'=>'4'),
...
class banlist_ui extends e_admin_ui
{
		...
		protected $fields 	= array (  
		  ...
		  'banlist_banexpires' 	=>   array ( 'title' => BANLAN_125,	 		'type' => 'method', 	'data' => 'int', 'inline'=>true, 'width' => 'auto', 'batch' => true, 'filter' => true, 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		  'banlist_admin' 		=>   array ( 'title' => BANLAN_126, 		'type' => 'text', 	    'data' => 'int', 'noedit'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'center', 'thclass' => 'center',  ),
		  'banlist_reason' 		=>   array ( 'title' => BANLAN_127, 		'type' => 'text', 		'data' => 'str', 'inline'=>true, 'width' => 'auto', 'help' => '', 'readParms' => 'constant=1', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		  'banlist_notes' 		=>   array ( 'title' => BANLAN_128, 		'type' => 'text', 		'data' => 'str', 'inline'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		...
		public function init()
		{
			...
			if($this->getMode() == 'white')
			{
				...
				if($this->getAction() == 'create')
				{
					...
					$this->fields['banlist_ip']['writeParms']['post'] = "<button class='btn btn-primary' id='useip' data-ip='{$myip}'>".BANLAN_129."</button></div>"; // USERIP;
				}
