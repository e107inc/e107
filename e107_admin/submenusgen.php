...
// Delete news links
$text .= display_dellink(LAN_MENGEN_4, "delNews", LAN_MENGEN_21);

// Delete Links sublinks
$text .= display_dellink(LAN_MENGEN_41, "delLinks", LAN_MENGEN_43);

// Delete forums links
$text .= display_dellink(LAN_MENGEN_5, "delForums", LAN_MENGEN_22);

// Delete articles links
$text .= display_dellink(LAN_MENGEN_6, "delArticles", LAN_MENGEN_23);

// Delete downloads links
$text .= display_dellink(LAN_MENGEN_7, "delDownloads", LAN_MENGEN_24);
...
$text .= "<br /><b class=\"smalltext\" >".LAN_MENGEN_17."</b></td>\n
</tr>\n";
