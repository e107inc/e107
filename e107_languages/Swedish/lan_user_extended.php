...
define("UE_LAN_HOMEPAGE_DESC", "URL till användarens hemsida");
define("UE_LAN_BIRTHDAY", "Födelsedag");
define("UE_LAN_BIRTHDAY_DESC", "Födelsedag");
define("UE_LAN_LANGUAGE", "Språk");
define("UE_LAN_LANGUAGE_DESC", "Användares språk");
define("UE_LAN_COUNTRY", "Land");
define("UE_LAN_COUNTRY_DESC", "Användares land (inkl db-tabell)");
