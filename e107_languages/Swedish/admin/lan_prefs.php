...
define("PRFLAN_4", "Sajt länkknapp");
...
define("PRFLAN_12", "Klicka här för att förhandsgranska teman");
...
define("PRFLAN_27", "T.ex. om du sätter detta till +2 kommer alla tider på din sajt att få två timmar adderade till dem.");
...
define("PRFLAN_47", "Säkerhet & Skydd");
...
define("PRFLAN_117", "Detta tillåter användare att posta HTML-kod var som helst på sajten, välj användarklass att tillåta detta.");
...
define("PRFLAN_123", "Kommer att visa en vad-du-ser-är-vad-du-får redigerare i textareor om tillgänglig. Gäller endast admins och användare som får posta HTML.");
define("PRFLAN_124", "Använd 'klassisk' nästa/föregående utseende");
define("PRFLAN_125", "Aktivering av detta kommer att visa nästa/föregående sidor som 1 2 3 ... 21 22 23, istället för det nya utseendet med rullgardinsmeny.");
