...
define("PRFLAN_64", "När du klickar på knappen kommer ett testbrev att skickas huvudadmina e-postadress");
...
define("PRFLAN_71", "Markering här gör att en SMTP server används att skicka e-post");
