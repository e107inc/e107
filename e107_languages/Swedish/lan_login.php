...
+----------------------------------------------------------------------------+
*/
define("LAN_27", "Du lämnade nödvändigt fält tomt");
define("LAN_300", "Felaktig inloggning. Angivna data matchar inte någon registrerad användare. Kontrollera om du har CAPS-LOCK aktiverad efterom inloggningen är skiftlägeskänslig.");
define("LAN_302", "Du har inte aktiverat ditt konto. Du skall ha fått e-post med instruktioner om hur du aktiverar ditt konto. Om inte, kontakta en sajtadministratör.");
define("LAN_303", "Felaktig kod angiven.");
define("LAN_304", "Den användarnamn/lösenordskombinationen används redan.");
define("LAN_LOGIN_1", "Användarnamn");
define("LAN_LOGIN_2", "Användarlösenord");
define("LAN_LOGIN_3", "Skyddad server");
define("LAN_LOGIN_4", "Ange dina uppgifter för att få tillgång.");
