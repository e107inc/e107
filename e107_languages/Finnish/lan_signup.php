...
define("LAN_104", "That user name already exists in the tietokanta, please choose a different user name");
...
define("LAN_408", "A user with that sähköpostiosoite already exists. Please use the 'forgot password' screen to retrieve your password.");
