...
+----------------------------------------------------------------------------+
*/
define("PAGE_NAME", "Virhe");

define("LAN_1", "virhe 401 - Permission Denied");
...
define("LAN_10", "virhe 500 - Malformed Header");
define("LAN_11", "The server encountered an internal error or misconfiguration ja was unable to complete your request");
...
define("LAN_20", "Please napsauta tästä to go to this site's home page");

define("LAN_ERROR_01", "The requested URL could not be found on this server. The link you followed is probably outdated.");
define("LAN_ERROR_02", "Please napsauta tästä to go to this site's search page");
