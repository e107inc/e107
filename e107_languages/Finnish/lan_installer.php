...
define("LANINS_033", "The MySQL tietokanta you wish e107 to reside in, sometimes refered to as a schema. If the user has tietokanta create permissions you can opt to create the tietokanta automatically if it doesn't already exsist.");
define("LANINS_034", "The prefix you wish for e107 to use when creating the e107 tables. Useful for multiple installs of e107 in one tietokanta schema.");
...
Please click the button to create the tietokanta tables and save all your settings.
...
Please clear the tietokanta and rectify any problems before trying again.");
