...
define("NWSLAN_4", "Existing Uutiset");
define("NWSLAN_5", "Avaa HTML editori");
define("NWSLAN_6", "Aihepiiri");
define("NWSLAN_7", "Muokkaa");
define("NWSLAN_8", "Poista");
define("NWSLAN_9", "Valitse vahvistaaksesi");
define("NWSLAN_10", "No categories set yet.");
define("NWSLAN_11", "Add/Edit Aihepiirit");
define("NWSLAN_12", "Otsikko");
...
define("NWSLAN_27", "Esikatsele");
define("NWSLAN_28", "Uusi story");
define("NWSLAN_29", "Uutiset Lähetä");

define("NWSLAN_30", "Näytä title only");
