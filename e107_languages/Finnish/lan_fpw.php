...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Finnish/lan_fpw.php,v $
|     $Revision: 1.2 $
|     $Date: 2006-01-14 22:26:04 $
|     $Kirjoittaja: stevedunstan $
+----------------------------------------------------------------------------+
*/
define("PAGE_NAME", "Salasana Reset");

define("LAN_02", "Sorry, unable to send email - please contact the pääylläpitäjä.");
define("LAN_03", "Salasana Reset");
...
define("LAN_09", "Salasana reset from ");
define("LAN_112", "Sähköpostiosoite used when signing up ");
define("LAN_156", "Lähetä");
define("LAN_213", "That käyttäjäname/sähköpostiosoite ei löytynyt in tietokanta.");
...
define("LAN_218", "Your käyttäjäname is:");
define("LAN_219", "The password associated with that sähköpostiosoite has already been reset ja cannot be reset again. Please contact the site administrator for more details.");
define("LAN_FPW1","Käyttäjännimi");
...
define("LAN_FPW8","The password for käyttäjäname");
...
define("LAN_FPW16", "If it was not you the requested the password be reset ja you do NOT want it reset, you can simply ignore this email");
