...
define("LANHELP_2", "Sininen");
define("LANHELP_3", "Ruskea");
define("LANHELP_4", "Cyan");
define("LANHELP_5", "Tumman sininen");
define("LANHELP_6", "Tumman punainen");
define("LANHELP_7", "Vihreä");
define("LANHELP_8", "Syvän sininen");
define("LANHELP_9", "Oliivin vihreä");
define("LANHELP_10", "Oranssi");
define("LANHELP_11", "Punainen");
define("LANHELP_12", "Violetti");
define("LANHELP_13", "Valkoinen");
define("LANHELP_14", "Keltainen");

define("LANHELP_15", "Tosi pieni");
define("LANHELP_16", "Pieni");
define("LANHELP_17", "Normaali");
define("LANHELP_18", "Suuri");
define("LANHELP_19", "Suurempi");
define("LANHELP_20", "Massiivinen");
...
define("LANHELP_30", "Tasaus oikealle: [right]Tämä teksti näkyy oikealle tasattuna[/right]");
define("LANHELP_31", "Tekstin lainaus: [blockquote]Tämä teksti näkyy lainattuna (sisennettynä)[/blockquote]");
define("LANHELP_32", "Code - esimuotoiltu teksti: [code]\$foo = bah;[/code]");
