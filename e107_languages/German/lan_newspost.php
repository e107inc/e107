...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/German/lan_newspost.php,v $
|     $Revision: 1.1 $
...
+----------------------------------------------------------------------------+
*/
define("NWSLAN_1", "Newseintrag gelöscht.");
define("NWSLAN_2", "Bitte bestätigen Sie das Löschen dieses Newseintrags, indem Sie die Box markieren.");
define("NWSLAN_3", "Keine Newseinträge bis jetzt.");
define("NWSLAN_4", "Bestehende News");
define("NWSLAN_5", "Öffne den HTML-Editor");
define("NWSLAN_6", "Kategorie");
define("NWSLAN_7", "Bearbeiten");
define("NWSLAN_8", "Löschen");
define("NWSLAN_9", "markiere um zu bestätigen");
