...
define("USRLAN_7", "Der Hauptseitenadministrator lässt sich nicht bannen");
define("USRLAN_8", "Gebannte User.");
define("USRLAN_9", "Nichtgebannte User.");
define("USRLAN_10", "Gelöschte User.");
...
define("USRLAN_54", "Klicke hier um alle unaktivierten User zu löschen");
define("USRLAN_55", "Prune");
define("USRLAN_56", "Gelöscht");
define("USRLAN_57", "Unaktivierte Mitglieder löschen ...");
define("USRLAN_58", "Datei Uploads sind in der php.ini nicht erlaubt");
define("USRLAN_59", "Schnellhinzufügen von Benutzern");
