...
if ($pref['developer']) {
$text .= "<br /><br />
Het aanvullende testvergelijkings hulpmiddel (uitsluitend in de ontwikkelaarsmodus) stelt u in staat om de bestanden op uw server met behulp van reguliere expressies te controleren op teksten. De regex engine die wordt gebruikt is PHP's <a href='http://php.net/pcre'>PCRE</a>
(de preg_* functies). Voer dus uw query in als  #pattern#modifiers in de aangegeven velden.";
}
