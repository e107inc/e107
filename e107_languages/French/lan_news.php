...
*/
  ...
  define("LAN_NEWS_8", "Actualité insérée dans la base de données de toutes les langues. ID:");
  ...
  define("LAN_NEWS_20", "Actualité mise à jour en base de données pour les langues suivantes: ");
