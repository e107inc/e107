...
+---------------------------------------------------------------+
*/
define("PAGE_NAME", "".GLOBAL_LAN_NEWS_4."");
define("LAN_NEWS_1", "".GLOBAL_LAN_NEWS_2." réservée uniquement à certains utilisateurs");
...
define("LAN_NEWS_5", "<strong>Erreur!</strong> N'a pu mettre à jour l".GLOBAL_LAN_L_PREFIX_NEWS.GLOBAL_LAN_NEWS_1." dans la base de données !</strong>");
define("LAN_NEWS_6", "".GLOBAL_LAN_NEWS_2." insérée dans la base de données");
define("LAN_NEWS_7", "<strong>Erreur!</strong> N'a pu insérer l".GLOBAL_LAN_L_PREFIX_NEWS.GLOBAL_LAN_NEWS_1." dans la base de données !</strong>");
define("LAN_NEWS_8", "".GLOBAL_LAN_NEWS_2." insérée dans la base de données de toutes les langues. ID:");
define("LAN_NEWS_9", "Seul le Titre s'affiche - <strong>Seul le titre de l".GLOBAL_LAN_L_PREFIX_NEWS.GLOBAL_LAN_NEWS_1." sera affiché</strong><br />");
define("LAN_NEWS_10", "La proposition d".GLOBAL_LAN_D_PREFIX_NEWS.GLOBAL_LAN_NEWS_3." est <strong>désactivé</strong>. (Elle ne sera pas disponible pour vos visiteurs). ");
define("LAN_NEWS_11", "La proposition d".GLOBAL_LAN_D_PREFIX_NEWS.GLOBAL_LAN_NEWS_3." est <strong>activé</strong>. (Elle sera disponible pour vos visiteurs). ");
...
define("LAN_NEWS_23", "Catégories d".GLOBAL_LAN_D_PREFIX_NEWS.GLOBAL_LAN_NEWS_3." ");
define("LAN_NEWS_24", "Créer un pdf pour cette ".GLOBAL_LAN_NEWS_1."");
define("LAN_NEWS_82", "".GLOBAL_LAN_NEWS_4." - Catégorie");
define("LAN_NEWS_83", "Aucune ".GLOBAL_LAN_NEWS_1." pour le moment - veuillez revenir plus tard.");
define("LAN_NEWS_84", "".GLOBAL_LAN_NEWS_4."");
define("LAN_NEWS_99", "Commentaires");
define("LAN_NEWS_100", "Autorisés");
define("LAN_NEWS_307", "Nombre total d".GLOBAL_LAN_D_PREFIX_NEWS.GLOBAL_LAN_NEWS_4." dans cette catégorie : ");
define("LAN_NEWS_462", "Pas d".GLOBAL_LAN_D_PREFIX_NEWS.GLOBAL_LAN_NEWS_3." pour le mois spécifié");
?>