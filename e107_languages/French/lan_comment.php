...
*/
  ...
  define("COMLAN_6", "Vous devez être identifié pour poster un commentaire sur ce site - merci de vous identifier </br> ou de cliquer");
  ...
  define("COMLAN_11", "Impossible d'enregistrer votre commentaire dans la base de données - merci de retaper votre </br> commentaire en supprimant les caractères spéciaux.");
  define("COMLAN_16", "Nom : ");
  define("COMLAN_99", "Commentaires");
  define("COMLAN_100", "Actualité");
  ...
  define("COMLAN_316", "Pas de références externes à votre contenu (Trackback) pour cet apport d'actualité.");
...
define("COMLAN_322", "pour vous incrire");
