...
*/
  ...
  define("LAN_ERROR_4", "Erreur 403 - L'authentification a échoué");
  define("LAN_ERROR_5", "L'URL que vous avez demandée requiert un nom d'utilisateur et un mot de passe corrects. Soit une des deux informations fournies est incorrecte, soit votre navigateur ne supporte pas cette fonctionnalité.");
  ...
  define("LAN_ERROR_10", "Erreur 500 - Entête mal formée");
  ...
  define("LAN_ERROR_18", "Votre tentative infructueuse d'accéder à <strong> {$errTo} </strong> a été enregistrée.");
  define("LAN_ERROR_19", "Apparemment, vous avez été redirigé par $errFrom - Malheureusement, le lien vers cette adresse est périmé ou totalement éronné .");
  define("LAN_ERROR_20", "Merci de cliquer ici pour retourner sur la page principale");
  ...
  define("LAN_ERROR_22", "Veuillez cliquer ici pour aller à la page de recherche de ce site");
  define("LAN_ERROR_23", "Votre tentative d'accès");
