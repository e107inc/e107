...
*/
  ...
  define("LAN_423", "Veuillez taper l'adresse complète où se trouve l'image");
  ...
  define("LAN_434", "qu'est ce c'est?");
  ...
  define("LAN_SIGNUP_7", " est exigé");
  define("LAN_USET_1", "La largeur de votre avatar est trop grande");
  define("LAN_USET_2", "La largeur permise maximale est");
  define("LAN_USET_3", "La hauteur de votre avatar est trop grande");
  define("LAN_USET_4", "La hauteur permise maximale est");
  // v.616
