...
define("LANINS_009", "Re-tester les permissions des fichiers");
...
define("LANINS_012", "Les fonctions MySQL ne semblent pas exister. Cela signifie probablement que l'extension MySQL de PHP n'est pas installée ou que l'installation PHP n'a pas été compilé avec le support MySQL.");
define("LANINS_013", "Votre version MySQL n'a pas pu être déterminée. Ce n'est pas une erreur grave, donc vous pouvez continuer. Mais gardez à l'esprit que e107 nécessite une version MySQL supérieure à 3.23 pour fonctionner correctement.");
...
define("LANINS_096", "Proposer une actualité");
