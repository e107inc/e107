...
else
{
  ...
  switch ($action)
  {
	case 'justone' :
	  ...
	  break;
	case 'debug' :
	  $text = 'Pour développeurs uniquement. Un deuxième paramètre de requête correspond au champ gen_type de la table “generic”. Ignorez les entêtes des colonnes.';
	  break;
	case 'list' :
	...
	case 'mailouts' :
	  ...
	  $text .= 'Pour ré-envoyer les mails en attente, cliquez sur le bouton “Ré-envoyer”. Cliquez ensuite sur “Exécuter” afin d’ouvrir la fenêtre de progression.<br />';
	  $text .= 'Pour annuler le publipostage il suffit de cliquer sur le bouton “Annuler”.';
	  break;
	case 'savedmail' :
	case 'makemail' :
