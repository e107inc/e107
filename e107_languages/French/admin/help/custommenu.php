...
+---------------------------------------------------------------+
*/
  $text = "À partir de cette page, vous pouvez créer des menus personnalisés avec votre propre contenu.<br /><br /><strong>Attention</strong> : pour utiliser cette fonctionnalité, vous devez faire un CHMOD de 777 sur le dossier /e107_menus/custom/.
  <br /><br />
