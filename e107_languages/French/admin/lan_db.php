...
define("DBLAN_19", "Cliquer sur ce bouton pour ouvrir l'éditeur de préférences (utilisateurs avancés seulement)");
define("DBLAN_20", "Éditeur des préférences");
define("DBLAN_21", "Supprimer les préférences sélectionnées");
define("DBLAN_22", "Extension: visualiser et scanner");
