...
*/
  ...
  define("SEALAN_12", "Laps de temps minimum entre 2 recherches (max 5 mins):");
  ...
  define("SEALAN_28", "Résultats");
  //  define("SEALAN_29", "Ordre");
  ...
  define("SEALAN_49", "Si votre site inclut des langues idéographiques comme le chinois et le japonnais vous devez utiliser la méthode de tri de PHP.");
  ?>
