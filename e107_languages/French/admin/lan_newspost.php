...
*/
  ...
  define("NWSLAN_14", "Étendre l'".GLOBAL_LAN_NEWS_2." (suite)");
  define("NWSLAN_15", "Commentaires");
//  define("NWSLAN_16", "Activé"); // deprecated see lan_admin.php
//  define("NWSLAN_17", "Désactivé"); // deprecated see lan_admin.php
  ...
  define("NWSLAN_25", "Mettre à jour l'".GLOBAL_LAN_NEWS_1." dans la base de données");
  define("NWSLAN_26", "Poster l'".GLOBAL_LAN_NEWS_1."");
  define("NWSLAN_27", "Prévisualiser");
  define("NWSLAN_29", "Envoi d'".GLOBAL_LAN_NEWS_2."");
  define("NWSLAN_31", "".GLOBAL_LAN_NEWS_2."");
  define("NWSLAN_32", "supprimée");
  define("NWSLAN_33", "Catégorie d'".GLOBAL_LAN_NEWS_2."");
  define("NWSLAN_34", "".GLOBAL_LAN_NEWS_2."s proposées");
  ...
  define("NWSLAN_44", "Page principale des ".GLOBAL_LAN_NEWS_1."s");
  define("NWSLAN_45", "Créer une ".GLOBAL_LAN_NEWS_1."");
  define("NWSLAN_46", "Catégories");
  define("NWSLAN_47", "".GLOBAL_LAN_NEWS_2."s proposées");
  define("NWSLAN_48", "Options");
  define("NWSLAN_49", "Proposée par");
  define("NWSLAN_51", "Catégories d'".GLOBAL_LAN_NEWS_1." existantes");
...
//  define("NWSLAN_60", "".GLOBAL_LAN_NEWS_2."s proposées");  //déjà définie
  
  define("NWSLAN_62", "Aller à la page: ");
  define("NWSLAN_63", "Rechercher dans les ".GLOBAL_LAN_NEWS_1."s");
...
//  define("NWSLAN_70", "Le répertoire e107_files/downloads n'est pas inscriptible, vous avez besoin de le mettre au CHMOD 777 avant d'uploader un fichier"); // deprecated see lan_admin.php
//  define("NWSLAN_71", "Le dossier"); // deprecated see lan_admin.php
...
//  define("NWSLAN_78", "Cette option est désactivée comme l'upload n'est pas activé sur votre serveur"); // deprecated see lan_admin.php
  define("NWSLAN_79", "Effacer le contenu des formulaires");
  define("NWSLAN_83", "Étendre l'".GLOBAL_LAN_NEWS_1." (suite)");
  define("NWSLAN_84", "Choisir quels visiteurs pourront accéder à l'".GLOBAL_LAN_NEWS_1."");
  define("NWSLAN_86", "Afficher les ".GLOBAL_LAN_NEWS_1."s par catégories en bas de la page des ".GLOBAL_LAN_NEWS_1."s");
  define("NWSLAN_87", "Nombre de colonnes ?");
  define("NWSLAN_88", "Nombre d'".GLOBAL_LAN_NEWS_2."s à afficher par page ?");
...
//  define("NWSLAN_118", "Afficher Images"); //déjà défini
...
//  define("LAN_NEWS_43", "(Aucune image dans /e107_images/newspost_images)"); // deprecated see lan_admin.php
...
//  define("LAN_NEWS_47", "Image"); // deprecated see lan_admin.php
