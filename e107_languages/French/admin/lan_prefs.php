...
define("PRFLAN_170", "Utiliser le 'reverse DNS' pour permettre de bannir selon l'hôte");
define("PRFLAN_171", "Activer cette option vous permettra de bannir des utilisateurs selon le nom de leur hôte, plutôt que simplement selon leur IP ou leur courriel. <br />NOTE : Ceci pourrait affecter la durée de chargement sur certains hôtes.");
