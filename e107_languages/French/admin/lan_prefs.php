...
*/
  ...
  define("PRFLAN_119", "Geshi est un logiciel libre d'accentuation de la syntaxe multi-langage, voir <a href=http://qbnz.com/highlighter/>qbnz.com/highlighter/ for more information</a>");
  define("PRFLAN_120", "Par défaut: langage de la syntaxe Geshi");
  ...
  define("PRFLAN_146", "Activer pour ouvrir tous les liens dans une nouvelle fenêtre (<i>Ceci est applicable à l'ensemble du site</i>).");
