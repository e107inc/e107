...
*/
  ...
  define("PRFLAN_12", "Cliquez ici pour thèmes en aperçu ");
  ...
  define("PRFLAN_26", "Décallage horaire ");
  ...
  define("PRFLAN_36", "Temps d'attente minumun entre 2 envois consécutifs ");
  ...
  define("PRFLAN_41", "si activé, tous les mots grossiers seront remplacès par le mot suivant");
  ...
  define("PRFLAN_91", "Si quelqu'un est en train d'attaquer votre serveur par de multiples requêtes, son IP sera automatiquement banni !");
  ...
  define("PRFLAN_95", "Affichage info extensions:");
  define("PRFLAN_96", "Affichera l'information sur toutes les pages Admin pour chaque extension disposant de ce type de fonctions");
  ...
  define("PRFLAN_103", "Si activé, les liens postés seront remplacés par le texte écrit dans la boîte à textes ci-dessous, Bloquant l'affichage des liens trop longs désorganisant la disposition des Thèmes");
  define("PRFLAN_104", "Texte remplaçant les liens");
  define("PRFLAN_105", "Texte qui remplace les liens. Pour employer une image à la place du texte, vous devrez utiliser &lt;img tag, avec le chemin complet vers l'image");
  define("PRFLAN_106", "Préférences sauvegardées dans la base de donnée.");
  define("PRFLAN_107", "Texte remplaçant les adresses courriel");
  define("PRFLAN_108", "Texte qui remplace les adresses courriel. Pour employer une image à la place du texte, vous devrez utiliser &lt;img tag, avec le chemin complet vers l'image");
  define("PRFLAN_109", "Couper les mots trop long dans le texte principal");
  define("PRFLAN_110", "Mot plus long que la longueur indiqué seront poursuivis sur une nouvelle ligne");
  ...
  define("PRFLAN_119", "Geshi est un multi-language open source d'accentuation de syntaxe, voir <a href=http://qbnz.com/highlighter/>qbnz.com/highlighter/ for more information</a>");
  define("PRFLAN_120", "Par défaut: Geshi syntax language");
  define("PRFLAN_121", "Si aucun language n'est specifié dans le code bbtag, Ce language sera utilisé pour l'accentuation de syntaxe");
  ...
  define("PRFLAN_128", "Activer cela convertira les liens postées en hyperliens");
  ...
  define("PRFLAN_132", "Activer ceci donnera l'autorisation aux utilisateurs de se servir du [php] code dans leurs posts dans certaines sections");
  ...
  define("PRFLAN_135", "Par exemple, si votre URL est http://foo.com, toutes les requêtes http://www.foo.com seront redirigé automatiquement vers http://foo.com");
  define("PRFLAN_136", "Maximum d'inscriptions permises avec la même adresse IP.");
  ...
  define("PRFLAN_146", "Activer pour ouvrir tous les liens dans une nouvelle fenêtre (<i>Ceci est appliquable à l'ensemble du site</i>).");
  define("PRFLAN_147", "Mode Développeur");
  define("PRFLAN_148", "Activer les fonctions développeur. Réserver aux développeurs . Ne pas utiliser sur des sites commerciaux pour des raisons de sécurité.");
  ...
  define("PRFLAN_154", "Méthode de vérification Nouvel Utilisateur<br />Si 'Approbation Admin' est sélectionné, Il est recommandé d'activer l'alerte par courriel lors d'inscriptions en cliquant <a href='".e_ADMIN."notify.php'>ici</a>.");
