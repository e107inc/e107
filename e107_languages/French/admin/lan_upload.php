...
*/
  ...
  define("UPLLAN_5", "Uploadé par");
  define("UPLLAN_6", "Courriel");
  ...
  define("UPLLAN_16", "installer dans une nouvelle ".GLOBAL_LAN_NEWS_1."");
  ...
  define("UPLLAN_30", "Choisissez comment stocker les fichiers uploadés, soit comme des fichiers normaux sur le serveur, soit en binaire dans votre base de données.<br /><strong>Noter que</strong> le binaire n'est uniquement approprié pour des fichiers de taille inférieure à 500 ko");
  define("UPLLAN_31", "Fichier");
  define("UPLLAN_32", "Binaire");
  define("UPLLAN_33", "Taille maximale du fichier");
  define("UPLLAN_34", "Taille maximale de l'upload en Octets - laisser vide pour vous conformer aux paramètres du php.ini de votre serveur (les paramètres de votre php.ini sont à");
