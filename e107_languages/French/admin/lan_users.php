...
*/
  ...
  define("USRLAN_115", "Merci de vous être inscrit.");
  ...
  define("USRLAN_133", "Forcer les utilisateurs à mettre à jour leurs paramètres");
  define("USRLAN_134", "Introduire cette option renverra l'utilisateur automatiquement vers ces paramètres utilisateur si un champ requis n'est pas rempli.");
  ...
  define("DUSRLAN_13", "Anniversaire");
  ...
  define("DUSRLAN_20", "Viste courante");
  define("DUSRLAN_21", "Dernier Message");
  define("DUSRLAN_22", "Dernier message Chat Box");
  define("DUSRLAN_23", "Commentaire");
  define("DUSRLAN_24", "Messages Frum");
