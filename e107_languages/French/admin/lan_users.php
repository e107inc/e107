...
define("USRLAN_2", "Champs d'extensions du profil sauvegardés.");
...
define("USRLAN_13", "Veuillez confirmer la suppression de cet utilisateur");
...
define("USRLAN_17", "Je confirme la suppression de cet utilisateur");
  ...
  //define("USRLAN_21", "ID de l'utilisateur");
  //define("USRLAN_22", "Nom de l'utilisateur");
  //define("USRLAN_23", "Visites sur le site");
  //define("USRLAN_24", "Statut de l'admin");
  //define("USRLAN_25", "Statut");
  //define("USRLAN_26", "Décroissant");
  //define("USRLAN_27", "Croissant");
  //define("USRLAN_28", "Trier");
define("USRLAN_30", "Bannir");
  // define("USRLAN_31", "Ban -désactivé-");
...
define("USRLAN_78", "Nom de l'utilisateur");
define("USRLAN_79", "Statut");
define("USRLAN_80", "Infos");
  //define("USRLAN_82", "Êtes-vous sûr de vouloir supprimer cet utilisateur ?");
...
define("USRLAN_87", "Paramètres de l'utilisateur mis à jour");
...
define("USRLAN_115", "Merci de vous être inscrit(e).");
define("USRLAN_116", "Veuillez confirmer le renvoie d'un courriel de confirmation à :");
define("USRLAN_117", "Cliquer sur le bouton ci-dessous pour tester le courriel suivant :");
define("USRLAN_118", "Courriel de test");
define("USRLAN_120", "Adjoindre aux groupes");
define("USRLAN_121", "Publipostage");   //Mailing
define("USRLAN_122", "Bienvenue sur");
define("USRLAN_123", "Votre inscription a bien été enregistrée et créée.");
define("USRLAN_124", "Votre compte est actuellement marqué comme inactif, pour l'activer veuillez cliquer sur le lien suivant");
define("USRLAN_125", "De");
define("USRLAN_126", "Autoriser l'évaluation d'utilisateur par les utilisateurs eux-mêmes");
define("USRLAN_126", "Autoriser les utilisateurs à s'évaluer entre eux");
...
define("USRLAN_134", "Activer cette option renverra l'utilisateur automatiquement vers ces paramètres utilisateur si un champ requis n'est pas rempli.");
define("USRLAN_135", "Aucune adresse IP n'a été trouvé dans les infos de l'utilisateur, IP non bannie");
define("USRLAN_136", "De multiples utilisateurs ont été trouvés avec l'adresse IP {d'IP}, IP non bannie.");
...
define("DUSRLAN_7", "Courriel");
define("DUSRLAN_8", "Site web");
define("DUSRLAN_9", "ICQ");
define("DUSRLAN_10", "AIM");
define("DUSRLAN_11", "MSN");
define("DUSRLAN_12", "Résidence");
define("DUSRLAN_13", "Date de naissance");
define("DUSRLAN_14", "Signature");
define("DUSRLAN_15", "Image");
define("DUSRLAN_16", "Fuseau horaire");
define("DUSRLAN_17", "Courriel Caché");
define("DUSRLAN_18", "Date inscription");
...
define("DUSRLAN_26", "Banni");
define("DUSRLAN_27", "Préfs");
define("DUSRLAN_28", "Nouveau");
define("DUSRLAN_29", "Vu ");
...
define("USRLAN_139", "Votre compte a été activé.\n\nVous pouvez visiter {SITEURL} et vous connecter au site en utilisant les informations de connexion que vous avez fournies.");
define("USRLAN_140", "Courriel renvoyé à");
define("USRLAN_141", "Échec du renvoie de courriel à");
define("USRLAN_142", "avec le lien de validation suivant");
define("LAN_BOUNCED","Rebondi");
define("USRLAN_143", "Vérifier les rebonds");
define("USRLAN_144", "Renvoyer un courriel de confirmation à Tous");
define("USRLAN_145", "Utilisateurs rebondis");
define("USRLAN_146", "Les informations des utilisateurs sont accessibles par");
?>
