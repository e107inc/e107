...
*/
  ...
  define("LAN_dl_2", "Aucun fichier pour le moment, merci de revenir plus tard");
  ...
  define("LAN_dl_30", "Courriel de l'auteur");
  ...
  define("LAN_dl_41", "Rechercher les fichiers");
  ...
  define("LAN_dl_50", "Signaler le téléchargement défectueux à un administrateur");
  define("LAN_dl_51", "Annonce sur téléchargement : ");
  define("LAN_dl_52", "Invité");
  ...
  define("LAN_dl_71", "A propos de");
  define("LAN_dl_72", "Fichier de demande : ");
