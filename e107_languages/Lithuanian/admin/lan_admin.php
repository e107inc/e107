...
define("ADLAN_7", "Keisti meniu iðsidëstymo tvarkà");
define("ADLAN_8", "Administratoriai");
define("ADLAN_9", "Pridëti/paalinti svetainës administratorius");
define("ADLAN_10", "Administratoriaus slaptaþodis");
define("ADLAN_11", "Keisti savo slaptaþodá");
...
define("ADLAN_18", "Apþvalgos");
define("ADLAN_19", "Pridëti naujas/redaguoti/trinti apþvalgas");
...
define("ADLAN_29", "Raðyti nekintantá pasisveikinimo tekstà");
define("ADLAN_30", "Bylø tvarkyklë");
define("ADLAN_31", "Tvarkyti/atsiøsti bylas");
define("ADLAN_32", "Pateiktos naujienos");
define("ADLAN_33", "Apþvelgti vartotojø pateiktas naujienas");
define("ADLAN_34", "Draudimø  sàraðas");
define("ADLAN_35", "Apriboti lankytojus");
define("ADLAN_36", "Nariai");
define("ADLAN_37", "Svetainës nariø sàraðas");
define("ADLAN_38", "Nariø grupës");
define("ADLAN_39", "Sukurti/redaguoti nariø grupes");
define("ADLAN_40", "Svetainës prieþiûra");
define("ADLAN_41", "Laikinai uþdaryti svetainæ");
...
define("ADLAN_51", "Praðome pradëti naujà seansà, jei norite patekti á svetainës administravimo sritá.");
...
define("ADLAN_62", "Naujienø ðaltiniai");
define("ADLAN_63", "Tvarkyti naujienø ðaltinius");
define("ADLAN_64", "Seansø þurnalas");
...
define("ADLAN_72", "Vieðai atsiunèiamos bylos");
define("ADLAN_73", "Tvarkyti vieðøjø bylø atsiuntimà");
define("ADLAN_74", "Podëlis");
define("ADLAN_75", "Nustatyti podëlio bûsenà");
define("ADLAN_77", "Yra pateiktø naujienø - praðome jas perþiûrëti.");
define("ADLAN_78", "Papildomi informacijos laukai");
define("ADLAN_79", "Redaguoti papildomus informacijos apie nará laukus");


define("ADLAN_86", "Neteisingas slaptaþodis ");
...
define("ADLAN_90", "Administratoriaus slaptaþodis ");
define("ADLAN_91", "Pradëti seansà");
define("ADLAN_92", "Praðome pradëti naujà seansà, jei norite patekti á svetainës administravimo sritá ...");
...
define("ADLAN_97", "Spauskite èia, jei norite perþiûrëti DUK");
define("ADLAN_98", "Áskiepiø tvarkyklë");
define("ADLAN_99", "Ádiegti/atnaujinti áskiepius");
define("ADLAN_100", "Temos maketas");
define("ADLAN_101", "Ðablono autorius");
define("ADLAN_102", "Nuo administratoriaus slaptaþodþio pakeitimo praëjo daugiau kaip 30 dienø - ");
...
define("ADLAN_113", "Diskusijø þinutës");
define("ADLAN_114", "Komentarai");
define("ADLAN_115", "Pokalbiø pasisakymai");
define("ADLAN_116", "Administratoriaus  þurnalas ...");
define("ADLAN_117", "Parodyti visus elementus");
define("ADLAN_118", "Iðvalyti þurnalà");
...
define("ADLAN_124", "nepatikrintos pateiktos apþvalgos");

define("ADLAN_125", "Nepatikrintos pateiktos diskusijø þinutës");
...
define("ADLAN_LAT_4", "Pateiktos apþvalgos");
define("ADLAN_LAT_5", "Pateiktos nuorodos");
define("ADLAN_LAT_6", "Pateiktos diskusijø þinutës");
define("ADLAN_LAT_7", "Atsiøstos bylos");
define("ADLAN_LAT_8", "There are unmoderated administrator messages");

// Common Terms
define("LAN_EDIT","Taisyti");
define("LAN_DELETE","Iðtrinti");
define("LAN_CREATE","Sukurti");
define("LAN_UPDATE","Atnaujinti");
define("LAN_SAVE","Iðsaugoti");
define("LAN_SAVED","Iðsaugotas");
define("LAN_SETSAVED","Jûsø nuostatos iðsaugotos");
define("LAN_ERROR","Klaida");
define("LAN_CONFIRMDEL","Praðome patvirtinti iðtrynimà");
define("LAN_OPTIONS","Parinktys");
define("LAN_PREFS","Nuostatos");
define("LAN_DELETED","Sëkmingai iðtrinta");
define("LAN_UPDATED","Sëkmingai atnaujinta");
define("LAN_CREATED","Sëkmingai sukurta");
define("LAN_CREATED_FAILED","Nepavyko sukurti");
define("LAN_DELETED_FAILED","Nepavyko iðtrinti");
define("LAN_UPDATED_FAILED","Nepavyko atnaujinti");

define("LAN_RESET","Atstatyti bûsenà");
define("LAN_CLEAR","Iðvalyti");
define("LAN_OK","Gerai");

define("LAN_PRESET","Iðankstinë pasirinktis");
define("LAN_PRESET_SAVED","Iðankstinë pasirinktis sëkmingai iðsaugota");
define("LAN_PRESET_DELETED","Iðankstinë pasirinktis sëkmingai iðtrinta");
define("LAN_PRESET_CONFIRMDEL","Ar tikrai norite iðtrinti iðankstinæ pasirinktá?");
define("LAN_NOTWRITABLE"," is not writable, you need to CHMOD 777 the folder first.");
define("LAN_DATE","Data");
define("LAN_TIME","Laikas");
define("LAN_YES","Taip");
define("LAN_NO","Ne");
define("LAN_EMPTY","Duomenø bazëje áraðø dar nëra");
define("LAN_EXISTING","Esantys áraðai");

define("LAN_CANCEL","Atðaukti");
define("LAN_CONFDELETE","Patvirtinti iðtrynimà");
