...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Italian/lan_fpw.php,v $
|     $Revision: 1.1 $
|     $Date: 2005-05-25 23:34:22 $
|     $Author: e107coders $
+----------------------------------------------------------------------------+
*/
define("PAGE_NAME", "Password Reset");

define("LAN_02", "Spiacente, non sono in grado di spedire email - per favore contatta l'amministratore del sito principale.");
define("LAN_03", "Reimposta Password");
