...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/ChineseTrad/lan_page.php,v $
|     $Revision: 1.1 $
...
define("LAN_PAGE_1", "頁面清單已經被關閉");
define("LAN_PAGE_2", "目前沒有頁面");
define("LAN_PAGE_3", "您要的頁面部存在");
define("LAN_PAGE_4", "評比該頁面");
define("LAN_PAGE_5", "感謝您評比該頁面");
define("LAN_PAGE_6", "您沒有權限瀏覽該頁面");
