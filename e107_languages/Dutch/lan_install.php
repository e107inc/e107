...
define("INSLAN5", "Je gebruikt een versie van PHP die niet in combinatie met e107 draait");
define("INSLAN6", "Script gepauseerd.");
define("INSLAN7", "Geslaagd");
define("INSLAN8", "mySQL Versie");
define("INSLAN9", "e107 was niet in staat het mySQL versie nummer te achterhalen.");
...
define("INSLAN34", "Niet in staat de database te maken, controleer of je de juiste rechten hebt om databases op je server aan te maken.");
...
define("INSLAN43", "E-mailadres Beheerder");
define("INSLAN44", "Je hebt vereiste velden niet ingevuld, vul de gegevens opnieuw in.");
...
define("INSLAN64", "Dit bestand is gegenereerd door het installatiescript.");
define("INSLAN65", "e107 vereist minimaal versie 4.1.0");
define("INSLAN66", "Als je een lokale server op je computer gebruikt, zal je ");
define("INSLAN67", "je PHP-versie  moeten vernieuwen om verder te gaan, zie");
define("INSLAN68", "voor instructies. Als je ");
define("INSLAN69", "e107 probeert te installeren op een hosted server, zul je de");
define("INSLAN70", "beheerders van de server moeten benaderen en vragen of zij de versie van PHP voor je willen vernieuwen.");
define("INSLAN71", "Start dit script opnieuw nadat je de versie van PHP heeft vernieuwd.");
define("INSLAN72", "Dit kan betekenen dat mySQL niet is ge&iuml;nstalleerd of niet draait, of");
define("INSLAN73", "je gebruikt een versie die het versie nummer niet correct toont");
define("INSLAN74", "(v5.x heeft dit probleem). Als de volgende stap van de installatie");
define("INSLAN75", "mislukt, moet je de status van mySQL te controleren.");
define("INSLAN76", "Je beheerscherm is");
define("INSLAN77", "hier");
define("INSLAN78", "klik om daar nu naar toe te gaan. Je zult moeten inloggen met de gebruikersnaam en het wachtwoord dat je tijdens de installatie hebt opgegeven.");
