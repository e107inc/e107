...
define("LAN_10", "dit is de gebruikernaam waarmee je inlogt");
...
define("LAN_107", "Bedankt! Je bent nu geregistreerd als lid van ");
...
define("LAN_114", "Dit voorkomt dat je e-mailadres op deze site wordt getoond");
define("LAN_123", "Aanmelden");
define("LAN_185", "Je hebt een verplicht veld niet ingevuld");
define("LAN_201", "Ja");
define("LAN_200", "Nee");
...
define("LAN_310", "je echte naam, inclusief voor- en achternaam");
...
Je ontvangt nu een e-mail ter bevestiging met daarin je inloggegevens. Volg de link in deze e-mail om je aanmelding af te ronden.");
define("LAN_406", "Hartelijk dank!");
define("LAN_407", " Bewaar deze email voor je eigen administratie, aangezien je wachtwoord versleuteld is en niet opgevraagd kan worden als je een typefout maakt of het vergeten bent. Je kunt wel een nieuw wachtwoord aanvragen, mocht dit toch het geval zijn. Hartelijk bedankt voor je aanmelding. Van");
...
define("LAN_411", "Deze weergavenaam bestaat al in de database, kies een andere weergavenaam");
...
define("LAN_SIGNUP_17", "Verklaar hier dat je dertien jaar of ouder bent.");
...
define("LAN_SIGNUP_29", "Er wordt ter bevestiging een e-mailtje gestuurd aan het door jou opgegeven e-mailadres. Dit adres moet dus geldig zijn.");
define("LAN_SIGNUP_30", "Als je niet wilt dat je e-mailadres wordt weergegeven, kruis dan de optie 'Verbergen e-mailadres' aan.");
define("LAN_SIGNUP_31", "Locatie van je XUP-bestand");
...
define("LAN_SIGNUP_36", "Er is een fout opgetreden bij het aanmaken van je gebruikersregistratie. Neem contact op met de beheerder van deze site");
...
define("LAN_EMAIL_05", "Je wachtwoord is namelijk versleuteld en kan niet worden teruggehaald als je het kwijt bent. Je kunt wel een nieuw wachtwoord aanvragen als dat toch gebeurt.");
