...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Thai/lan_equery_secure.php,v $
|     $Revision: 1.2 $
...
*/
define("EQSEC_LAN1", "คุณกำลังส่งต่อคำสั่งไปให้ระบบจัดการ, ซึ่งบางทีอาจมีผลต่อการเปลี่ยนแปลงฐานข้อมูลในระบบ");
define("EQSEC_LAN2", "กรุณายืนยันการปฏิบัติ:");
define("EQSEC_LAN3", "ไม่มีที่อ้างอิง");
define("EQSEC_LAN4", "ทำมาจาก:");
define("EQSEC_LAN5", "ปฏิบัติต่อ:");
define("EQSEC_LAN6", "ยืนยันการปฏิบัติ");
define("EQSEC_LAN7", "หรือยกเลิก");
?>