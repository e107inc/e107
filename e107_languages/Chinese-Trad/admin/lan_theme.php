...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Chinese-Trad/admin/lan_theme.php,v $
|     $Revision: 1.1 $
...
define("TPVLAN_4", "作者");
define("TPVLAN_5", "網站");
define("TPVLAN_6", "釋出日期");
define("TPVLAN_7", "資訊");
define("TPVLAN_8", "選項");
define("TPVLAN_9", "預覽風格");
define("TPVLAN_10", "設定為網站風格");
define("TPVLAN_11", "版本");
define("TPVLAN_12", "目前無法預覽");
...
define("TPVLAN_22", "該風格有多重樣式");
define("TPVLAN_23", "預設樣式");
define("TPVLAN_24", "沒有相關資訊");
define("TPVLAN_25", "選擇樣式使用, 請到 <a href='".e_ADMIN."prefs.php'>基本設定</a> 中點選 '風格'.");

define("TPVLAN_26", "風格管理");
define("TPVLAN_27", "請選擇使用風格");
define("TPVLAN_28", "開啟");
define("TPVLAN_29", "關閉");
define("TPVLAN_30", "預先瀏覽風格圖片:");

define("TPVLAN_31", "目前控制台使用風格");
define("TPVLAN_32", "設定於控制台風格");

define("TPVLAN_33", "目前網站風格");
define("TPVLAN_34", "目前控制台風格");
define("TPVLAN_35", "儲存選項");
define("TPVLAN_36", "控制台訊息");
define("TPVLAN_37", "已儲存風格選項");
define("TPVLAN_38", "上傳風格");
define("TPVLAN_39", "有效的風格");
define("TPVLAN_40", "控制台風格設定於");
