...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Chinese-Trad/admin/lan_newspost.php,v $
|     $Revision: 1.1 $
|     $Date: 2006-09-16 15:12:33 $
|     $Author: e107coders $
+----------------------------------------------------------------------------+
*/
define("NWSLAN_1", "News story 刪除d.");
define("NWSLAN_2", "請 tick the confirm box to 刪除 this news item.");
define("NWSLAN_3", "No news items yet.");
define("NWSLAN_4", "Existing News");
define("NWSLAN_5", "Open HTML 編輯or");
define("NWSLAN_6", "分區");

define("NWSLAN_9", "tick to confirm");
define("NWSLAN_10", "No news 分區");
define("NWSLAN_11", "Add/編輯 分區");
define("NWSLAN_12", "Title");
define("NWSLAN_13", "Body");
define("NWSLAN_14", "Extended");
define("NWSLAN_15", "評論");
define("NWSLAN_16", "開啟d");
define("NWSLAN_17", "Disabled");
define("NWSLAN_18", "Allow 評論 to be posted to this news item");
...
define("NWSLAN_25", "Update news in 資料庫");
define("NWSLAN_26", "Post news to 資料庫");
define("NWSLAN_27", "Preview");

define("NWSLAN_29", "News Post");

define("NWSLAN_31", "News item");
define("NWSLAN_32", "刪除d");
define("NWSLAN_33", "News 分區");
define("NWSLAN_34", "已送出的news item");
define("NWSLAN_35", "News 分區 已儲存的");
define("NWSLAN_36", "News 分區 Updated");
define("NWSLAN_37", "Are you sure you want to 刪除 this 分區?");
define("NWSLAN_38", "Are you sure you want to 刪除 this 已送出的news item?");
define("NWSLAN_39", "Are you sure you want to 刪除 this news item?");
...
define("NWSLAN_46", "分區");
define("NWSLAN_47", "已送出的News");
define("NWSLAN_48", "News Options");
define("NWSLAN_49", "已送出的by");

define("NWSLAN_51", "Existing News 分區");
define("NWSLAN_52", "分區 Name");
define("NWSLAN_53", "分區 Icon");
define("NWSLAN_54", "View Images");
define("NWSLAN_55", "Update News 分區");
define("NWSLAN_56", "Create News 分區");
define("NWSLAN_57", "Item");
define("NWSLAN_58", "Post");
define("NWSLAN_59", "No 已送出的news");
define("NWSLAN_60", "已送出的News");

define("NWSLAN_62", "Go to page: ");
define("NWSLAN_63", "搜尋 newsposts");
...
define("NWSLAN_70", "The ".e_FILE."下載 folder is not writable, you need to CHMOD 777 the folder before uploading and files.");
...
define("NWSLAN_78", "This option is disabled as file uploading is not已開啟 on your server");
define("NWSLAN_79","Clear Form");

define("NWSLAN_83","Extended news post");
define("NWSLAN_84","Choose which 訪客 will see news item");

define("NWSLAN_86", "Show News-分區 Footer Menu");
define("NWSLAN_87", "News 分區 Columns?");
define("NWSLAN_88", "News posts to display per page?");
define("NWSLAN_89", "Save News Preferences");
define("NWSLAN_90", "News Preferences");
define("NWSLAN_100", "開啟 Image uploading on Submit News page");
define("NWSLAN_101", "Automatic resizing of 已送出的image");
...
define("NWSLAN_107", "開啟 WYSIWYG 編輯or on Submit-News page.");
...
define("NWSLAN_119", "設定 已儲存的");
define("NWSLAN_120", "Text to show at the top of Submit News");

define("LAN_NEWS_5", "錯誤! - Was unable to update news item into 資料庫!");
define("LAN_NEWS_6", "News entered into 資料庫.");
define("LAN_NEWS_7", "錯誤! - Was unable to enter news item into 資料庫!");
...
define("LAN_NEWS_12", "評論 are turned <b>on</b>.");
define("LAN_NEWS_13", "評論 are turned <b>off</b>.");
...
define("LAN_NEWS_18", "資訊");
define("LAN_NEWS_19",  "Now");
define("LAN_NEWS_21", "News updated in 資料庫.");
...
define("LAN_NEWS_44", "Trackback not已開啟.");
