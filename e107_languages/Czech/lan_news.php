...
define("LAN_82", "Kategorie novinek");
define("LAN_83", "V tuto chvíli zde nejsou žádné novinky.");
define("LAN_84", "Novinky");
define("LAN_99", "Komentáře");
define("LAN_100", "Na");
define("LAN_307", "Novinek celkově v této kategorii: ");

define("LAN_NEWS_1", "Novinky pouze pro některé členy");
define("LAN_NEWS_2", "Nemáte povoleno prohlížet si tuto novinku");
define("LAN_NEWS_3", "Smažte prosím instal.php ze serveru");
define("LAN_NEWS_4", "pokud to neuděláte, je zde jisté bezpečnostní riziko průniku do tohoto webu");

define("LAN_NEWS_5", "<b>Chyba!</b> Nebylo možno upravit novinku v databázi!</b>");
define("LAN_NEWS_6", "Novinka byla vložena do databáze.");
define("LAN_NEWS_7", "<b>Chyba!</b> Nebylo možno vložit novinku do databáze!</b>");
...
define("LAN_NEWS_15", "Délka těla novinky: ");
define("LAN_NEWS_16", "Délka rozšířené části novinky: ");
define("LAN_NEWS_17", "Tělo");
