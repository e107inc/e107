...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Chinese-Simp/admin/lan_users.php,v $
|     $Revision: 1.1 $
...
define("USRLAN_47", "最大头像宽度(点)");
define("USRLAN_48", "缺省值为120");
define("USRLAN_49", "最大头像高度(点)");
define("USRLAN_50", "缺省值为100");
define("USRLAN_51", "更新选项");
define("USRLAN_52", "会员选项");
define("USRLAN_53", "允许会员上传照片?");
define("USRLAN_54", "点击这里删除所有未激活的用户");
define("USRLAN_55", "删除");
define("USRLAN_56", "已删除");
define("USRLAN_57", "正在删除未激活的用户 ...");
define("USRLAN_58", "php.ini中的设置不允许文件上传");
define("USRLAN_59", "快速添加用户");
define("USRLAN_60", "添加用户");
define("USRLAN_61", "显示名");
define("USRLAN_62", "密码");
define("USRLAN_63", "重复密码");
define("USRLAN_64", "电子邮件");
define("USRLAN_65", "该用户名无效，请选择另一个用户名");
define("USRLAN_66", "该用户名已存在数据库中，请选择一个不同的用户名");
define("USRLAN_67", "两次输入的密码不匹配");
define("USRLAN_68", "必填字段为空");
define("USRLAN_69", "电子邮件地址不正确");
define("USRLAN_70", "用户已创建");
define("USRLAN_71", "用户管理首页");
define("USRLAN_72", "快速添加用户");
...
define("USRLAN_139", "您的帐号已激活。\n\n您可以访问{SITEURL}，然后用注册时填写的信息登录。");

define("USRLAN_140", "重发电子邮件到");
define("USRLAN_141", "无法重发电子邮件到");
define("USRLAN_142", "和以下激活链接");

define("LAN_BOUNCED","返回邮件");
define("USRLAN_143", "检查返回邮件");
define("USRLAN_144", "重发确认邮件给所有人");
