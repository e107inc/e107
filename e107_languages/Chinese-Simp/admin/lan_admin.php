...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Chinese-Simp/admin/lan_admin.php,v $
|     $Revision: 1.1 $
...
define("ADLAN_12", "论坛");
define("ADLAN_13", "添加/修改论坛");
define("ADLAN_14", "文章");
define("ADLAN_15", "添加/修改/删除文章");
define("ADLAN_16", "内容");
define("ADLAN_17", "添加/修改/删除内容页面");
define("ADLAN_18", "评论");
define("ADLAN_19", "添加/修改/删除评论");
define("ADLAN_22", "链接分类");
define("ADLAN_23", "添加/修改/删除链接分类");
define("ADLAN_24", "下载");
define("ADLAN_25", "管理下载");
define("ADLAN_26", "下载分类");
define("ADLAN_27", "添加/修改/删除下载分类");
define("ADLAN_28", "欢迎信息");
define("ADLAN_29", "设置静态欢迎信息");
define("ADLAN_30", "文件管理");
define("ADLAN_31", "管理/上传文件");
define("ADLAN_32", "提交新闻");
define("ADLAN_33", "查看用户提交的新闻");
define("ADLAN_34", "黑名单");
...
define("ADLAN_50", "权限");
define("ADLAN_51", "请登入后访问管理页面");
define("ADLAN_52", "管理首页");
define("ADLAN_53", "返回网站首页");
define("ADLAN_54", "广告");
define("ADLAN_55", "设置广告");
define("ADLAN_56", "聊天室");
define("ADLAN_57", "设置聊天室");
define("ADLAN_58", "表情");
define("ADLAN_59", "设置表情");
define("ADLAN_60", "首页");
define("ADLAN_61", "设置首页内容");
define("ADLAN_62", "新闻引用");
define("ADLAN_63", "设置新闻引用");
define("ADLAN_64", "日志统计");
define("ADLAN_65", "日志统计");
define("ADLAN_66", "Meta");
define("ADLAN_67", "添加/修改网站meta标签");
define("ADLAN_68", "PHP信息");
define("ADLAN_69", "PHP信息页面");
define("ADLAN_70", "投票");
define("ADLAN_71", "添加/修改投票");
define("ADLAN_72", "上传");
define("ADLAN_73", "设置文件上传");
define("ADLAN_74", "缓存");
define("ADLAN_75", "设置缓存状态");
define("ADLAN_77", "您提交了新闻 - 请点击这里查看。");
define("ADLAN_78", "自定义字段");
define("ADLAN_79", "修改用户自定义字段");


define("ADLAN_86", "密码不正确");
define("ADLAN_87", "数据库忠没有找到管理员名字");
define("ADLAN_88", "无法登入");
define("ADLAN_89", "管理员姓名");
define("ADLAN_90", "管理员密码");
define("ADLAN_91", "登入");
define("ADLAN_92", "请登入后访问管理页面 ...");
define("ADLAN_93", "显示管理功能");
define("ADLAN_94", "显示已安装插件");
define("ADLAN_95", "插件管理");
define("ADLAN_96", "无");
define("ADLAN_97", "点击这里查看FAQ");
define("ADLAN_98", "插件管理");
define("ADLAN_99", "安装/升级插件");
define("ADLAN_100", "布景界面");
define("ADLAN_101", "布景作者");
...
define("ADLAN_107", "不选择提交新闻");
define("ADLAN_108", "不选择文件上传");
define("ADLAN_109", "信息");
...
define("ADLAN_123", "不选择提交的文章");
define("ADLAN_124", "不选择提交的评论");

define("ADLAN_125", "不选择报告的论坛帖子");

define("ADLAN_126", "主要选项");
define("ADLAN_127", "用户");
define("ADLAN_128", "内容");
define("ADLAN_129", "通信");
define("ADLAN_130", "文件管理");
define("ADLAN_131", "其它工具");
...
define("ADLAN_LAT_3", "提交的文章");
define("ADLAN_LAT_4", "提交的评论");
...
define("LAN_PRESET_SAVED","成功保存预置置");
