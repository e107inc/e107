...
define("LANINS_012", "MySQL functies lijken niet te bestaan. Dit betekent vermoedelijk dat de MySQL PHP extensies niet  zijn geÃ¯nstalleerd of dat ze niet goed zijn geconfigureerd."); // help for 012
...
define("LANINS_018", "Zorg ervoor dat alle aangegeven bestanden bestaan en beschrijfbaar zijn door de server. Dat betekent in de regel CHMODden naar 777, maar omdat omgevingen variÃ«ren kun je het beste met je provider contact opnemen als er een probleem bestaat.");
define("LANINS_019", "De op je server geÃ¯nstalleerde versie van PHP kan e107 niet aan. e107 vereist een PHP versie van minimaal 4.3.0. Ofwel upgrade je versie van PHP of neem contact op met je provider voor een upgrade.");
...
Als je root permissies bezit, kun je een nieuwe database creÃ«ren door het vakje aan te kruisen. Als je dat niet hebt, dat moet je zelf de database creÃ«ren of een bestaande gebruiken.

Als je maar Ã©Ã©n database mag aanmaken, gebruik dan een prefix zodat ook andere scripts dezelfde database kunnen gebruiken.
...
define("LANINS_033", "De MySQL database waar e107 gebruik van maakt heet ook wel een schema. Als de gebruiker de rechten heeft om een database te creÃ«ren, kun je ervoor kiezen om de database automatisch te laten aanmaken als die tenminste nog niet bestaat.");
define("LANINS_034", "De prefix die je voor e107 wilt gebruiken bij het aanmaken van de tabellen. Zinvol als meerdere installaties van een applicatie (bijv. e107) gebruik moeten maken van Ã©Ã©n database schema.");
...
define("LANINS_043", "De database kan niet worden gecreÃ«erd. Controleerd of je de juiste permissies hebt om databases op je server te creÃ«ren.");
...
define("LANINS_051", "GeÃ¯nstalleerd");
define("LANINS_052", "Niet geÃ¯nstalleerd");
...
define("LANINS_063", "e107 is succesvol geÃ¯nstalleerd en klaar voor gebruik.");
...
define("LANINS_069", "e107 is succesvol geÃ¯nstalleerd!
