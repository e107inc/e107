...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Spanish/lan_newspost.php,v $
|     $Revision: 1.1 $
...
+----------------------------------------------------------------------------+
*/
define("NWSLAN_1", "Historia de noticia borrada.");
define("NWSLAN_2", "Active para borrarlo.");
define("NWSLAN_3", "Sin noticias todavía.");
...
define("NWSLAN_10", "Sin categorías fijadas todavía.");
...
define("NWSLAN_20", "Dejar en blanco para desactivar la auto-activación");
define("NWSLAN_21", "Activar entre");
define("NWSLAN_22", "Ver");
define("NWSLAN_23", "Activo hará que la noticia sea visible solo a usuarios de esa clase");
...
define("NWSLAN_30", "Mostrar solo el título");
