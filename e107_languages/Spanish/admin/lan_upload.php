...
y añade una lista delimitada de las extensiones en él. No aconsejamos que permita transferir .html, .txt, etc ya que un atacante podría transferir un archivo de este tipo que incluyese código javascript malicioso. No debería tampoco, por supuesto, permitir transferir archivos .php o otro que permitiera scripts ejecutables.");
?>