...
|
|     $Source: /cvs_backup/e107_langpacks/e107_languages/Dutch_formal/admin/lan_theme.php,v $
|     $Revision: 1.1 $
...
define("TPVLAN_15", "Het bestand kon niet worden geupload omdat de permissies op directory ".e_THEME." niet goed staan ingesteld - wijzigt u ze in CHMOD 777 en upload het bestand nogmaals.");
...
define("TPVLAN_19", "Uw theme is geupload en uitgepakt. Blader omlaag om het in de lijst te zien.");
define("TPVLAN_20", "Auto theme upload en uitpakken is gedeactiveerd omdat de permissies op je themes directory onjuist zijn. Wijzigt u de permissies van e107_themes directory in CHMOD 777.");
...
define("TPVLAN_25", "Om het stylesheet te kiezen gaat u naar <a href='".e_ADMIN."prefs.php'>voorkeuren</a> en klik op 'Thema'.");
...
define("TPVLAN_33", "Huidige site theme");
define("TPVLAN_34", "Huidige beheerscherm theme");
