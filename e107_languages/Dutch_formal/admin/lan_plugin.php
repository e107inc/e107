...
define("EPL_ADLAN_1", "De-installeren");
define("EPL_ADLAN_2", "Weet u zeker dat u deze plugin wilt de-installeren?");
...
define("EPL_ADLAN_6", "... klik daarna hier om de installatieprocedure te starten");
define("EPL_ADLAN_7", "Databasetabellen succesvol bijgewerkt.");
...
define("EPL_ADLAN_39", "Het bestand kon niet worden geupload omdat de rechten op de ".e_PLUGIN." directory niet goed zijn ingesteld. Wijzig ze in CHMOD 777 en upload het bestand opnieuw.");
define("EPL_ADLAN_40", "Beheerboodschap");
