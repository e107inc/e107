...
define("PRFLAN_12", "Klik hier om thema's te bekijken");
...
define("PRFLAN_27", "als u dit bijvoorbeeld instelt op +2, zullen alle weergegeven tijden twee uur hoger zijn");
...
define("PRFLAN_38", "Minimale tijd die tussen het plaatsen van 2 berichten nodig is (chatbox, forum). Als een gebruiker te snel plaatst, wordt hij/zij naar de startpagina geleid.");
...
define("PRFLAN_45", "Gebruiken van COPPA op de aanmeld pagina?");
...
define("PRFLAN_59", "aanzetten beperkt de toegang tot deze site, met uitzondering tot de hoofdpagina en de aanmeldfunctie, uitsluitend tot de leden");
define("PRFLAN_60", "Activeren SSL");
define("PRFLAN_61", "activeer SSL alleen <b>als u zeker weet wat u doet!</b>");
...
define("PRFLAN_80", "Klik hier om te bekijken");
...
define("PRFLAN_91", "als iemand uw site aanvalt door meervoudige aanvragen voor uw server, wordt diens IP adres automatisch geblokkeerd. Vervang geen juiste server config!!!");
define("PRFLAN_92", "Beveiligde aanmeldingsverificatie - verbergen wachtwoord in e-mail?");
define("PRFLAN_93", "strftime function at php.net");
...
define("PRFLAN_98", "als deze optie niet aan staan, toont elke plugin de eigen info in een individueel menu. Indien aangekruist wordt alle info in één menu getoond.");
define("PRFLAN_101", "Tekst opmaken");
define("PRFLAN_102", "Vervang aan te klikken URL's");
define("PRFLAN_103", "als deze optie aan staat en 'Maak aanklikbaar' (zie boven) ook, worden geplaatste URL's als een hyperlink getoond door de onderstaande tekst. Dit verhindert dat lange URL's de layout verstoren");
...
define("PRFLAN_112", "Aan");
define("PRFLAN_113", "Uit");
define("PRFLAN_116", "Accepteren HTML berichten");
define("PRFLAN_117", "hierdoor wordt het mogelijk dat leden HTML code op de site invoeren, kies wel de ledenklasse waarvoor dit is toegestaan.");
...
define("PRFLAN_123", "toont alles in de what-you-see-is-what-you-get tekstverwerker in textareas als die beschikbaar zijn.");
...
define("PRFLAN_128", "hierdoor worden aangemelde URL's omgezet in hyperlinks");
...
define("PRFLAN_132", "Activeren van deze functie houdt in dat geautoriseerde gebruikers [php] code in bepaalde gebieden mogen gebruiken");
define("PRFLAN_133", "GD extensie nodig, niet gevonden");
define("PRFLAN_134", "Verwijs alle aanvragen naar site URL");
define("PRFLAN_135", "als bijvoorbeeld de URL van uw site staat ingesteld op http://foo.com, dan wordt iedereen die http://www.foo.com opvraagt doorverwezen naar http://foo.com");
...
define("PRFLAN_155", "Weergavenaam en inlognaam kunnen verschillen voor");
...
define("CUSTSIG_4", "Geboortedatum:");
define("CUSTSIG_5", "Woonplaats:");
define("CUSTSIG_6", "Onderschrift:");
define("CUSTSIG_7", "Avatar");
define("CUSTSIG_8", "Tijdzone:");
...
define("CUSTSIG_17", "Abonneren op inhoud/uitgaande mail");
