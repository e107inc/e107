...
+---------------------------------------------------------------+
|        e107 website system
|        lan_upload.php Dutch-utf language file 
|
...
define("LAN_144", "Websiteadres: ");
define("LAN_402", "U moet een geregistreerde deelnemer zijn om bestanden te kunnen uploaden.");
define("LAN_403", "U bezit niet de juiste rechten om bestanden te kunnen uploaden.");
define("LAN_404", "Bedankt. Uw bijdrage zal door een van de moderators worden beoordeeld en op de site geplaatst als dat mogelijk is.");
define("LAN_405", "Het bestand is groter dan toegestaan - verwijderd.");
define("LAN_406", "Let op");
define("LAN_407", "Elk ander bestandstype wordt onmiddellijk verwijderd.");
define("LAN_408", "Onderstreepte");
