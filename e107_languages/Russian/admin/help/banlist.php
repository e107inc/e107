...
$caption = "Запрет пользователей с вашего сайта";
$text = "Вы можете запрещать определенным пользователям посящать ваш сайт в этом окне.<br />
Вы можете ввести полный IP-адрес, или-же использовать шаблон, чтобы запрещать диапозон IP-адресов. Так же Вы можете ввести адрес электронной почты, чтобы предотвратить его регистрацию в качестве пользователя на вашем сайте.<br /><br />
