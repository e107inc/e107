...
define("ADLAN_11", "Сменить вашего пароль");
...
define("ADLAN_26", "Категории загрузок");
define("ADLAN_27", "Доб/ред/удал категорий загрузок");
...
define("ADLAN_35", "Бан посетители");
...
define("ADLAN_43", "Создать свой пункт меню");
...
define("ADLAN_67", "Доб/ред мета-тэги сайта");
...
define("ADLAN_72", "Общие загрузки"); //Public Uploads
define("ADLAN_73", "Настройка общих загрузок файлов");
define("ADLAN_74", "Кэш");
define("ADLAN_75", "Установка статуса кэша");
...
define("ADLAN_112", "Забаненых пользователей");
...
define("LAN_NOTWRITABLE"," не открыта на запись, нужно вначале сделать CHMOD 777 для этой папки.");
...
define("LAN_UPLOAD_777","Папка отсутствует или не открыта для записи, вам нужно сделать CHMOD 777 для следующей папки перед загрузкой:");
define("LAN_UPLOAD_SERVEROFF", "Это свойство выключено, так как загрузка файлов не включена на вашем сервере");
