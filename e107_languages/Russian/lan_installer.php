...
define("LANINS_086", "<b>Необходимо</b> заполнять поля: Имя, Пароль и Адрес электронной почты администратора. Пожалуйста, вернитесь на предыдущую страницу и убедитесь, что данные введены корректно.");
