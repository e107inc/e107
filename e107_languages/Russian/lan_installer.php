...
e107 была успешно установлена и теперь готова для принятия содержимого.<br />Ваш Админцентр [link=e107_admin/admin.php]находится здесь[/link], нажмите, чтобы перейти туда сейчас. Вам потребуется ввести логин и пароль, которые вы указали в процессе установки.
