...
define("LANINS_010a", "Папка не перезаписываемая: ");
...
Пожалуйста, убедитесь что файл <b>core_sql.php</b> существует в директории <b>/e107_admin/sql</b>");
...
e107 была успешно установлена и теперь готова для принятия содержимого.<br />Ваша область администрирования [link=e107_admin/admin.php]находится здесь[/link], нажмите, чтобы перейти туда сейчас. Вам потребуется ввести логин и пароль, которые вы указали в процессе установки.
...
Темы: [link=http://e107styles.org]http://e107styles.org[/link] | [link=http://e107themes.org]http://e107themes.org[/link]
