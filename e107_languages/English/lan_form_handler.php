...
define("LAN_EFORM_006", "Admin-Only Notice: The folder");
define("LAN_EFORM_007", "is empty. Upload some default avatars images to this folder for users to choose avatars from.");
