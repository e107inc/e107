...
//define("LAN_112", "Email Address: ");//LAN_EMAIL_ADDRESS
//define("LAN_144", "Website URL: ");//LAN_URL ( LAN_AUTHOR )
...
//define("LAN_410", "Version");//LAN_VERSION
//define("LAN_411", "File");//LAN_FILE
//define("LAN_412", "Screenshot");//LAN_SCREENSHOT
//define("LAN_413", "Description");//LAN_DESCRIPTION
define("LAN_414", "Working demo");//FIXME Cannot find in download plugin
define("LAN_415", "enter URL to site where demo can be viewed");
//define("LAN_416", "Submit and Upload");//LAN_SUBMIT
