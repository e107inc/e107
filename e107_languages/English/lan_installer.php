...
If you do not know your MySQL details contact your web host.",
    ...
    'LANINS_033' => "The MySQL database you wish e107 to reside in, sometimes referred to as a schema. If the user has database create permissions you can opt to create the database automatically if it doesn't already exist.",
