...
define("LAN_MENGEN_10","All required links were successfully created.<br />If you need to modify or delete these links later, go to your <a href=\"".e_ADMIN."links.php\" >links section</a>.");
...
define("LAN_MENGEN_17","All links displayed in ALL submenus will be deleted (NOT ONLY submenus for ".LAN_MENGEN_4.", ".LAN_MENGEN_5.", ".LAN_MENGEN_6.", ".LAN_MENGEN_7.")<br />Main links are NOT deleted. If you need to delete them, please go to your <a href=\"".e_ADMIN."links.php\" >links section</a>.");
define("LAN_MENGEN_18","Delete");
define("LAN_MENGEN_19","Clean Main Menu");
define("LAN_MENGEN_20","Delete links in a submenu for");
define("LAN_MENGEN_21","All links displayed in the ".LAN_MENGEN_4." submenu will be deleted.");
define("LAN_MENGEN_22","All links displayed in the ".LAN_MENGEN_5." submenu will be deleted.");
define("LAN_MENGEN_23","All links displayed in the ".LAN_MENGEN_6." submenu will be deleted.");
define("LAN_MENGEN_24","All links displayed in the ".LAN_MENGEN_7." submenu will be deleted.");
...
define("LAN_MENGEN_43","All links displayed in the ".LAN_MENGEN_41." submenu will be deleted.");
?>