...
return [
    ...
    'EPL_ADLAN_258' => "To generate your [x] table creation file, please select your sql table then click 'Refresh'",
    'EPL_ADLAN_259' => "Simple frontend script",
    'EPL_ADLAN_260' => "Create default table data during install, upgrade, uninstall etc",
    'EPL_ADLAN_261' => "Menu item for use in the menu manager.",
    'EPL_ADLAN_262' => "Template to allow layout customization by themes.",
    'EPL_ADLAN_263' => "Shortcodes for the template.",
    'EPL_ADLAN_264' => "Add form elements to existing core admin areas.",
    'EPL_ADLAN_265' => "Include your plugin's cron in the 'Scheduled Tasks' admin area.",
    'EPL_ADLAN_266' => "Include your plugin's notification to the Notify admin area.",
    'EPL_ADLAN_267' => "Add link generation into the sitelinks area.",
    'EPL_ADLAN_268' => "Add your plugin as a frontpage option.",
    'EPL_ADLAN_269' => "Gives your plugin's menu(s) configuration options in the Menu Manager.",
    'EPL_ADLAN_270' => "Allow your plugin to generate content for the featurebox plugin.",
    'EPL_ADLAN_271' => "Add your plugin to the search page.",
    'EPL_ADLAN_272' => "Add a global shortcode which can be used site-wide. (use sparingly)",
    'EPL_ADLAN_273' => "Include a file within class2.php (every page of the site).",
    'EPL_ADLAN_274' => "Hook into core events and process them with custom functions.",
    'EPL_ADLAN_275' => "Override the core commenting system.",
    'EPL_ADLAN_276' => "Add something to the default admin dashboard panel.",
    'EPL_ADLAN_277' => "Have your plugin include code in the head of every page of the site. eg. css",
    'EPL_ADLAN_278' => "Have your plugin include code in the foot of every page of the site. eg. javascript",
    'EPL_ADLAN_279' => "Give your plugin search-engine-friendly URLs",
    'EPL_ADLAN_280' => "Allow the mailing engine to use data from your plugin's database tables.",
    'EPL_ADLAN_281' => "Create dynamic navigation links for your plugin.",
    'EPL_ADLAN_282' => "Allow your plugin to be included in the 'related' links.",
    'EPL_ADLAN_283' => "Give your plugin an rss feed.",
    'EPL_ADLAN_284' => "Use data from your plugin in the user upload form.",
    'EPL_ADLAN_285' => "Have your plugin include data on the user-profile page.",
