...
define("TPVLAN_REFUSED_NOT_SITE_THEME", "The theme options were not saved, because the form named a theme that is not the site theme. Make it the site theme first, then save its options.");
