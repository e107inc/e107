...
define('UCSLAN_92', 'User ID');
define('UCSLAN_93', 'Display Name');
define('UCSLAN_94', 'Raw classes');
define('UCSLAN_95', 'Inherited classes');
define('UCSLAN_96', 'Editable classes');
define('UCSLAN_97', 'Class rights for first 20 users in database');
define('UCSLAN_98', 'Remove DB fields: ');
define('UCSLAN_99', 'Create default class tree: ');
define('UCSLAN_100', "Must add new DB fields first");
define('UCSLAN_101', "Remove default class tree: ");
define('UCSLAN_102', 'Rebuilding tree: ');
define('UCSLAN_103', 'Test Functions and Information');
define('UCSLAN_104', 'DB Status');
define('UCSLAN_105', 'Add new DB fields');
define('UCSLAN_106', 'First required step');
define('UCSLAN_107', 'Remove new DB fields');
define('UCSLAN_108', 'Reverse the process');
define('UCSLAN_109', 'Add class tree');
define('UCSLAN_110', 'Optional default tree');
define('UCSLAN_111', 'Remove class tree');
define('UCSLAN_112', "Deletes the 'core' class entries");
define('UCSLAN_113', "Rebuild class tree");
define('UCSLAN_114', "Sets up all the structures");
define('UCSLAN_115', "Spare");
define('UCSLAN_116', "User classes - test features");
define('UCSLAN_117', "Select box with nested items");
define('UCSLAN_118', "Multiple Select box with nested items");
define('UCSLAN_119', "Classes");
define('UCSLAN_120', "Normalised Classes");
define('UCSLAN_121', "Nested checkboxes, showing the effect of the normalise() routine");
define('UCSLAN_122', "Single class");
define('UCSLAN_123', "Multi-select");
define('UCSLAN_124', "Check boxes");
define('UCSLAN_125', "Click on the button - the settings above should be remembered, and the $_POST values displayed");
