...
define("WMLAN_05","Preferences");
define("WMLAN_06","Enclose");
define("WMLAN_07","If ticked, the message will be rendered inside box");
define("WMLAN_08","Save preferences");
define("WMLAN_09","Preferences saved");
define("WMLAN_10","Override standard system to use {WMESSAGE} shortcode:");
