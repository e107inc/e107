...
define("LANG_LAN_REFUSED_TOKEN_MISSING", "That language check was not run, because the link carried no security token. Start it from the Language Packs list rather than from a bookmark or a link on another site.");