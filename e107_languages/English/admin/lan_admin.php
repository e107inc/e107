...
Below is the list of files that could potentially be malicious:",
    ...
    'LAN_UI_CHANGE_REFUSED_NO_ARCHIVE' => "Record [x] was left as it was: its previous values could not be recorded in Admin History.",
    'LAN_UI_HISTORY_UTF8_SUBSTITUTED' => "Record [x] holds bytes that are not valid text. The Admin History copy has them replaced, so restoring this record would not put the original bytes back.",
