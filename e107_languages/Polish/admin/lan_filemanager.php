...
define("FMLAN_1", "Załadowano");
define("FMLAN_2", "do");
define("FMLAN_3", "katalogu");
define("FMLAN_4", "Rozmiar ładowanego pliku przekracza wartość <i>upload_max_filesize</i> (maksymalny rozmiar ładowanego pliku) znajdującą się w pliku php.ini.");
