...
define("CRELAN_10", "MagpieRSS zapewnia parser RSS dla PHP bazujący na technologii XML.");
define("CRELAN_11", "Biblioteka PclZip oferuje funkcje kompresji i dekompresji archiwów w formacie ZIP (WinZip, PKZIP).");
