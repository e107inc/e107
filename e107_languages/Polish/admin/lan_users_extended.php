...
define("EXTLAN_4", "Prośba");//Req'd
define("EXTLAN_5", "Odpowiedni");
define("EXTLAN_6", "Czytaj dostęp");//Read access
define("EXTLAN_7", "Wpisz dostęp");//Write access
define("EXTLAN_8", "Akcja");
define("EXTLAN_9", "Rozszerzone pola użytkownika");

define("EXTLAN_10", "Nazwa pola");
define("EXTLAN_11", "Nazwa pola jaka będzie zapisana w tabeli bazy danych, musi mieć unikalną nazwę niż pozostałe.");
define("EXTLAN_12", "Pole tekstowe");
define("EXTLAN_13", "Będzie wyświetlona nazwa pola na danej stronie");
define("EXTLAN_14", "Typ Pola");
define("EXTLAN_15", "Pole zawiera tekst");
define("EXTLAN_16", "Domyślna wartość");
define("EXTLAN_17", "Wpisz wartości w jednej lini
Enter each possible value on each line <br /> Dla BD zobacz pomoc.");
