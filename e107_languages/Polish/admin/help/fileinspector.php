...
$text = "Inspektor plików, skanuje oraz analizuje wszystkie pliki oraz foldery .Gdy inspektor napotka pliki w e107 core ,sprawdzi je czy nie są uszkodzone.";

$ns -> tablerender("Pomoc Inspektor plików", $text);
?>
