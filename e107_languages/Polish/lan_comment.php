...
define("COMLAN_6", "Aby wystawiać komentarze na tej stronie, musisz być zalogowany. Zaloguj się lub kliknij ");
...
define("COMLAN_11", "Nie udało się zamieścić komentarza w bazie danych - Aby spróbować ponownie, usuń z komentarza wszystkie nietypowe znaki.");
define("COMLAN_16", "Użytkownik: ");
...
define("COMLAN_310", "Nie mogę zaakceptować wpisu, ponieważ podana nazwa użytkownika jest już zarejestrowana - Jeśli podana login należy do Ciebie, proszę się zalogować, a następnie ponownie wystawić komentarz.");
...
define("COMLAN_315", "Warto przeczytać");
define("COMLAN_316", "Brak powiązań dla tej wiadomości.");
define("COMLAN_317", "Moderuj powiązania");
...
define("COMLAN_328", 'Komentarze zostały wyłączone');
