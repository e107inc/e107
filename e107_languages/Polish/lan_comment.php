...
define("COMLAN_6", "Do wystawianie komentarzy na tej stronie wymagane jest zalogowania się - zaloguj się lub kliknij ");
define("COMLAN_7", "Strona główna administratora");
define("COMLAN_8", "Komentarz");
define("COMLAN_9", "Wyślij komentarz");
define("COMLAN_10", "Administrator");
define("COMLAN_11", "Nie udało się zamieścić komentarza w bazie danych - aby spróbować ponownie, proszę usunąć z treści wszystkie nietypowe znaki.");
define("COMLAN_16", "Nick: ");
...
define("COMLAN_106", "Plik");
define("COMLAN_145", "Zarejestrowany: ");
define("COMLAN_194", "Gość");
define("COMLAN_195", "Zarejestrowany użytkownik");
define("COMLAN_310", "Nie można zaakceptować wpisu, ponieważ podany nick jest już zarejestrowany - jeśli podany nick należy do Ciebie, zaloguj się i ponownie dodaj komentarz.");
define("COMLAN_312", "Wykryto duplikat wypowiedzi - dodanie komentarza zakończyło się niepowodzeniem.");
define("COMLAN_313", "Miejscowość");
define("COMLAN_314", "Moderuj komentarze");
define("COMLAN_315", "Trackbacki");
define("COMLAN_316", "Brak trackbacków dla tej wiadomości.");
define("COMLAN_317", "Moderuj trackbacki");
define("COMLAN_318", "Edycja komentarza");
define("COMLAN_319", "ostatnio zmieniony");
define("COMLAN_320", "Aktualizuj komentarz");
...
define("COMLAN_TYPE_PAGE", "Treści");		// Reall custom page, but use a 'non-technical' description
