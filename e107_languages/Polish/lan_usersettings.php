...
define("LAN_11", "Nazwa, która będzie używana podczas logowania - nie można jej zmienić. Prosimy skontaktować się z administratorem, jeśli musisz dokonać zmiany ze względów bezpieczeństwa.");
...
define("LAN_155", "Aktualizacja ustawień użytkownika");
define("LAN_185", "Pole hasła jest puste ");
define("LAN_308", "Imię i nazwisko: ");
define("LAN_401", "Pozostaw puste, aby zachować istniejące hasło");
define("LAN_402", "Wpisz ścieżkę dostępu lub wybierz awatara");
...
define("LAN_411", "Zaktualizuj swoje ustawienia");
...
define("RESIZE_NOT_SUPPORTED", "Metody zmiany rozmiaru nie są obsługiwane przez ten serwer. Proszę zmienić rozmiar grafiki lub wybrać inną. Plik został usunięty.");
