...
define("LAN_216", "Aby potwierdzić nowe hasło proszę przejść pod następujący URL...");
define("LAN_217", "Twoje nowe hasło zostało potwierdzone, możesz teraz zalogować się używając nowego hasła.");
define("LAN_218", "Login:");
define("LAN_219", "Hasło skojarzone z tym adresem emailowym było już resetowane i nie może być skasowane ponownie. Proszę skontaktować się z administratorem strony w celu uzyskania dokładniejszych informacji.");
