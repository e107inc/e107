...
define("EPL_ADLAN_5", "Inštalácia vytvorila nové nastavenia konfigurácií.");
...
define("EPL_ADLAN_9", "Chybný SQL príkaz. Presvečte sa, že sú aktualizované všetky dostupné upgrady.");
...
define("EPL_ADLAN_35", "Nastavenia analyzátora pridané.");
define("EPL_ADLAN_36", "Chyba kódu analizátora, nepovolené formátovanie.");

define("EPL_ADLAN_37", "Uploadovať plugin (.zip alebo .tar.gz formát)");
define("EPL_ADLAN_38", "Uploadovať plugin");
define("EPL_ADLAN_39", "Súbor nemôže byť uploadovaný do adresára ".e_PLUGIN." , pretože nemá dostatočné práva - prosím, zmente prístupové práva adresára na CHMOD 777 a uploadujte súbor znovu.");
...
define("EPL_ADLAN_43", "Váš plugin bol uploadovaný dekomprimovaný, prosím, prozrite sa nižšie do zoznamu na váš plugin.");
...
define("EPL_CONFIGURE", "Konfigurovať");
