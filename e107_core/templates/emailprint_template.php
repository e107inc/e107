...
$EMAILPRINT_TEMPLATE['email'] = "<a rel='alternate' class='e-tip hidden-print btn btn-default btn-secondary hidden-print' href='{EMAILICON: url=1}' title='".LAN_EMAIL_7."'>452553523".$EMAILPRINT_TEMPLATE['ICON_EMAIL']."</a>";
