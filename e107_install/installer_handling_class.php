...
".(defined("SERVER_PATH") ? "define(\"SERVER_PATH\", \"".SERVER_PATH."\");" : "//define(\"SERVER_PATH\", \"/path_to_e107/\"); // only required in extreme circumstances")."
...
?>";
	...
	function get_lan_file(){
		if($previous_steps && $previous_steps['language'] && is_readable("./{$this->e107->e107_dirs['LANGUAGES_DIRECTORY']}{$previous_steps['language']}/lan_installer.php")){
			include_once("./{$this->e107->e107_dirs['LANGUAGES_DIRECTORY']}{$previous_steps['language']}/lan_installer.php");
	...
	function popup_info($info){
		return "&nbsp;&nbsp;<img src='".$this->e107->http_abs_location("INSTALLER", "images/info.png")."' alt='Info Image (Hover curser to read info)' title='{$info}' />";
	}
