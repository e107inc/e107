...
{
    define("SM_ICO_EXP", "<img onclick=\"if(this.src.indexOf('" . THEME . "images/extand_ico.png')!=-1){this.src='" . THEME . "images/extand2_ico.png'}else{this.src='" . THEME . "images/extand_ico.png'}\" class='icoexp' src='" . THEME . "images/extand_ico.png' style='border: 0px; width: 11px; height: 11px;' alt='expand' />");
    define("SM_ICO_URL", THEME . "images/extand_ico.png");
} 
else
{
    define("SM_ICO_EXP", "<img onclick=\"if(this.src.indexOf('" . e_IMAGE . "generic/extand_ico.png')!=-1){this.src='" . e_IMAGE . "generic/extand2_ico.png'}else{this.src='" . e_IMAGE . "generic/extand_ico.png'}\" class='icoexp' src='" . e_IMAGE . "generic/extand_ico.png' style='border: 0px; width: 11px; height: 11px;' alt='expand' />");
...
\n\n";
// Help
$text .= "<p>\n<a href=\"javascript:void(0);\" onclick=\"ejs_func_todo=ejs_expandall('cats',ejs_func_todo,'subcats');ejs_func_todo2=ejs_expandpics('icoexp',ejs_func_todo2,'" . SM_ICO_URL . "','" . SM_ICO_URL2 . "');\" > " . LANSM_7 . "</a> " . LANSM_31 . " <img src='" . e_IMAGE . "generic/extand_ico.png' style='border: 0px; width: 11px; height: 11px;' alt='' /> " . LANSM_41 . "</p>\n";
