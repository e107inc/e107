 ...
 *
 *
 * $Source: /e107_languages/Russian/lan_installer.php,v $
 * $Revision$
 * $Date$
 * $Author: NixanR $
 */
...
define("LANINS_013", "Невозможно определить версию MySQL. Это не фатальная ошибка, поэтому, пожалуйста, продолжайте установку, но имейте в виду, что e107 требует MySQL v4.1.2, чтобы корректно функционировать.");
...
define("LANINS_019", "Установлена версия PHP не совместима с e107. Необходима версия ".MIN_PHP_VERSION." или выше. Либо сделайте апгрейд вашей версии PHP, либо обратитесь к хост-провайдеру, чтобы он сделал апгрейд.");
define("LANINS_020", "Продолжить установку");
define("LANINS_021", "2");
define("LANINS_022", "Информация о сервере MySQL");
define("LANINS_023", "Пожалуйста, введите настройки своей базы данных. Если вы обладаете правами root, Вы можете создать новую базу данных, отметив соответствующий чекбокс, если нет, Вы должны создать базу данных или использовать имеющуюся.Если у вас только одна база данных, используйте префикс так, чтобы другие скрипты могли совместно использовать ту же самую базу данных. Если вам не известна информация о сервере MySQL, свяжитесь с вашим хост-провайдером.");
...
define("LANINS_033", "База данных MySQL, в которой вы хотите, чтобы находилась система e107. Если Вы обладаете правами создания базы данных, Вы можете создать новую базу данных, отметив соответствующий чекбокс.");
...
define("LANINS_053", "e107 0.8.x требует установленного PHP XML расширения. Свяжитесь с Администрацией хостинга, или почитайте об этом на <a href='http://php.net/manual/en/ref.xml.php' target='_blank'>php.net</a> перед продолжением");
define("LANINS_055", "Подтверждение установки");
define("LANINS_056", "6");
define("LANINS_057", " e107 теперь имеет всю необходимую информацию для завершения установки. Пожалуйста, щелкните по кнопке, чтобы создать таблицы базы данных и сохранить все Ваши настройки.");
define("LANINS_058", "7");
define("LANINS_060", "Невозможно прочитать файл данных sql. Пожалуйста, убедитесь что файл <b>core_sql.php</b> существует в каталоге <b>/e107_admin/sql</b>");
define("LANINS_061", "e107 не смог создать нужные таблицы в базе данных. Пожалуйста, очистите базу данных и устраните все проблемы перед тем как попробовать ещё раз.");
define("LANINS_062", "[b]Добро пожаловать на Ваш новый веб-сайт![/b]e107 была успешно установлена и теперь готова для принятия контента.Ваш Админцентр [link=e107_admin/admin.php]находится здесь[/link], нажмите, чтобы перейти туда сейчас.Вам потребуется ввести имя пользователя и пароль, которые вы указали в процессе установки.[b]Поддержка[/b]Домашняя страница e107: [link=http://e107.org]http://e107.org[/link], здесь вы найдете FAQ и документацию.Форумы: [link=http://e107.org/e107_plugins/forum/forum.php]http://e107.org/e107_plugins/forum/forum.php[/link]Сообщество разработчиков плагинов: [link=http://www.e107coders.org]http://e107coders.org[/link][b]Загрузки[/b]Плагины: [link=http://plugins.e107.org]http://plugins.e107.org[/link]Темы: [link=http://themes.e107.org]http://themes.e107.org[/link]Спасибо за то, что вы используете e107, мы надеемся, что эта система удовлетворит нужды вашего веб-сайта.(Вы можете удалить это сообщение, войдя в раздел администрирования.)");
define("LANINS_063", "Добро пожаловать в e107");
define("LANINS_069", "e107 успешно установлена!Из соображений безопасности вы должны сейчас установить права доступа к файлу<b>e107_config.php</b> равными 644.Также удалите файл install.php с Вашего сервера после того, как Вы нажмёте на кнопку внизу.");
define("LANINS_070", "e107 не смогла сохранить главный файл конфигурации на ваш сервер.Пожалуйста, убедитесь что у файла <b>e107_config.php</b> установлены корректные права доступа");
...
define("LANINS_105", "Имя или префикс базы данных, начинающиеся с цифр с последующими буквами [E] - недопустимы");
...
define("LANINS_107", "Название моего сайта");
define("LANINS_108", "например. 'Мой блог'");
define("LANINS_109", "Тема (оформление) сайта");
define("LANINS_110", "");
define("LANINS_111", "Включить содержимое/конфигурации");
define("LANINS_112", "Быстрое воспроизведение внешнего вида темы или демо. (Если имеется)");
define("LANINS_113", "Пожалуйста, введите имя сайта");
...
define("LANINS_119", "Установить все плагины, необходимые для темы.");
define("LANINS_120", "8");
define("LANINS_121", "e107_config.php не пустой файл");
define("LANINS_122", "Возможно, Вы уже устанавливали CMS ");
