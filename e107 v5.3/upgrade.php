...
if(IsSet($_POST['usubmit'])){
  ...
  userclass_class varchar(100) NOT NULL default ''
			...
			$sql -> db_Update("e107", "e107_version='5.3'");
			$sql -> db_Update("e107", "e107_build ='1'");
			

			if($sql -> db_Select("prefs", "pref_name='sitetag' AND pref_value REGEXP('Website System') ")){
				$sql -> db_Update("prefs", "pref_value ='Website System v5.3' WHERE pref_name='sitetag' ");
			}

			$text .= "<br /><b>Version number updated to 5.3.</b><br />";
		}
	}else{
