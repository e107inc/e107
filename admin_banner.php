	...
	*/
	...
	private function menuPageSave()
	{
		...
		public function menuPage()
		{
			...
			return e107::getMessage()->addInfo(BNRLAN_MENU_MANAGER_CONFIG)->render();
	...
	function banner_image($curVal,$mode)
	{
		...
		//	break;
			...
			case 'write': // Edit Page
				...
				$tab2 = "<p>". $this->text('banner_image_remote',$val2, 255, array('size'=>'xxlarge', 'placeholder'=>'eg. http://some-website.com/banner-image.jpg', 'title'=>BNRLAN_TITLE_REMOTE_IMAGE))."</p>";
		...
		switch($mode)
		{
			...
			case 'write': // Edit Page
				if (count($this->campaigns)) 
				{
					...
					$text .= $frm->text('banner_campaign','','',array('size'=>'xlarge', 'class'=>'e-hideme','placeholder'=> BNRLAN_PLACEHOLDER_ENTER_CAMPAIGN));
				}
				else
				{
