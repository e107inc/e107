 ...
 * (e107_handlers/user_handler.php:1771-1781) registers system/xup/login as the
 ...
 *
 * Left alone it reaches $sql->insert('user', $insert, true) at :157 and
 * new userlogin(...) at :163 on a session already connected with the
