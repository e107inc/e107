 ...
 *
 * Only the ITEMVIEW arm of the switch is reachable here, and that is not a gap
 * in the fixture: $this->action is the first dot-separated field of the whole
 * query string, so any URL carrying ?page= lands in default:. The NEWSLIST_LIMIT
 * arm needs a query string that is exactly cat/all/tag/author, which leaves no
 * room for a page parameter.
 */
class NewsPaginationCest
{
	...
	/** The news menus in the sidebar carry titles, so only a body proves the listing rendered the item. */
