...
<e107Plugin name="e107 Tests 6024" version="1.0" date="2026-08-23" compatibility="2.0" installRequired="true">
	...
	<description>Fixture for SingleEntryErrorPageCest. Removed again in the Cest's _after().</description>
...
XML;
	...
	private function shortcodeSource()
	{
		return <<<'PHP'
<?php
// Fixture for SingleEntryErrorPageCest. Removed again in the Cest's _after().
