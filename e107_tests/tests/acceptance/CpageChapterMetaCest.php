...
class CpageChapterMetaCest
{
	...
	{
		$I->writeAppFile($this->templatePath(), $this->templateSource());
	...
	{
		$I->deleteAppFile($this->templatePath());
	}
	...
	/**
	 * @return string path of the fixture template, relative to the app root
	 */
	private function templatePath()
	{
		return 'e107_themes/'.\Helper\Acceptance::INSTALL_SITETHEME.'/templates/chapter_template.php';
	}
