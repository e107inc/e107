 ...
 * starts the scan from a control inside the page. Two things are asserted here:
 * the poll is only answered for somebody who may run the scan, and the scan's
 * options reach the server in the request body rather than in the link that
 * commits to the work.
 *
