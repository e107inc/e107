 ...
 * save handler used to call {@see e_pref::reset()}, which marks the object as
 * a complete replacement, so pressing Save wrote a row holding login_menu and
 * nothing else. It also copied $_POST['pref'] wholesale, storing any key the
