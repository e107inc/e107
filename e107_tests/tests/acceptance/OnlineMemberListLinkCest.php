 ...
 * both, in the shape ForumNamesOutsideTheFeedCest established.
 */
class OnlineMemberListLinkCest
{
	...
	const TEMPLATE_FILE = 'e107_themes/bootstrap5/online_template.php';
	...
	private function probeSource()
	{
		...
		return <<<PHP
<?php
// Fixture for OnlineMemberListLinkCest.
