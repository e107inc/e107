 ...
 *
 * secure_imageTest exercises the handler in process, and ContactFormCest
 ...
 * ContactFormCest: mail_log_options is set to "1,1" for the duration, so
...
class CaptchaLifecycleCest
{
	...
	private function probeSource()
	{
		return <<<'PHP'
<?php
// Fixture for CaptchaLifecycleCest.
