 ...
 */
class uploadFormTest extends \Test\Unit
{
	...
	{
		$this->writeAppFile(e_SYSTEM.'filetypes.xml', '<?xml version="1.0" encoding="utf-8"?>
<e107Filetypes>
	<class name="public" type="zip,gz,jpg,jpeg,png,gif,webp,xml,pdf" maxupload="2M" />
		...
		self::assertDoesNotMatchRegularExpression('/Undefined (array key|index|variable)[^\n]*upload\.php/i', $printed,
