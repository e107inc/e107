 ...
 * over nothing at all.
 */
class navigation_menuTest extends \Codeception\Test\Unit
{
	...
	{
		e107::getDb()->delete('links', "link_name = '".self::MARKER."'");
	}

	private function countLinksInEmptyCategory()
	{
		return (int) e107::getDb()->count('links', '(*)', 'WHERE link_category = '.self::EMPTY_CATEGORY);
	}
}
