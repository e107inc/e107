 ...
 */
class login_menu_classTest extends \Test\Unit
{
	...
	{
		$this->assertIsArray($this->loginMenu()->parse_external_list(true, false));
	}
	...
	public function testParseExternalListCachesWhatItScanned()
	{
		...
		$this->assertIsArray(e107::getRegistry('loginbox_elist_1'));
