...
class PluginNewsTest extends \Codeception\Test\Unit
{
	...
	public function testTheDefaultNewsPageDoesNotWarnWhenTheThemeSetsNewsstyle()
	{
		...
		$property = new \e107\Reflection\ReflectionProperty($news, "text");
		$this->assertStringContainsString(
			$marker,
	...
	public function testTheItemBreadcrumbSurvivesARenderPathThatNeverSetCurrentRow()
	{
		...
		$property = new \e107\Reflection\ReflectionProperty($news, "route");
		...
		try
		{
			$method = new \e107\Reflection\ReflectionMethod($news, "setBreadcrumb");
			$method->invoke($news);
		}
		finally
		{
