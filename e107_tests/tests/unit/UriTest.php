 ...
 * deprecation without failing on it, and neither parsing the tree on the floor
 * nor the downgrade fixed-point check has an opinion on an attribute, so the
 * marker is asserted from the source here: a re-vendor rewrites this file and
 * drops the attribute, and this is the only thing that would notice.
 */
class UriTest extends \Test\Unit
{
