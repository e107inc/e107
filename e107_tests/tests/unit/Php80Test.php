 ...
 * successful match included. php-floor-lint parses and does not run, which is
 * why only an executing test catches this shape.
 */
class Php80Test extends \Test\Unit
{
