...
*/
			...
			public function testCheckboxes()
			{
				...
				$expected = "<div id='name-container' class='checkboxes' style='display:inline-block'><label class='checkbox'><input type='checkbox' name='name[1]' value='1' id='name-1-1' /><span>one</span></label><label class='checkbox'><input type='checkbox' name='name[2]' value='1' id='name-2-1' checked='checked' /><span>two</span></label><label class='checkbox'><input type='checkbox' name='name[3]' value='1' id='name-3-1' /><span>three</span></label></div>";
				$this->assertEquals($expected,$result);

				$result = $this->_frm->checkboxes('name', $opts, 2, array('useKeyValues'=> 1));
				$expected = "<div id='name-container' class='checkboxes' style='display:inline-block'><label class='checkbox'><input type='checkbox' name='name[]' value='1' id='name-1' /><span>one</span></label><label class='checkbox active'><input type='checkbox' name='name[]' value='2' id='name-2' checked='checked' /><span>two</span></label><label class='checkbox'><input type='checkbox' name='name[]' value='3' id='name-3' /><span>three</span></label></div>";
				$this->assertEquals($expected,$result);

				$result = $this->_frm->checkboxes('name', $opts, 'two', array('useLabelValues'=> 1));
				$expected= "<div id='name-container' class='checkboxes' style='display:inline-block'><label class='checkbox'><input type='checkbox' name='name[]' value='one' id='name-one' /><span>one</span></label><label class='checkbox active'><input type='checkbox' name='name[]' value='two' id='name-two' checked='checked' /><span>two</span></label><label class='checkbox'><input type='checkbox' name='name[]' value='three' id='name-three' /><span>three</span></label></div>";
				$this->assertEquals($expected,$result);
...
//Check Opt 2, Check Opt 3
	...
	public function testRenderElement()
	{
		...
		$expected = array(
			...
			'checkboxes_001'       => "<div id='checkboxes-001-container' class='checkboxes' style='display:inline-block'><label class='checkbox'><input type='checkbox' name='checkboxes_001[1]' value='1' id='checkboxes-001-1-1' checked='checked' tabindex='8' /><span>Check Opt 1</span></label><label class='checkbox'><input type='checkbox' name='checkboxes_001[2]' value='1' id='checkboxes-001-2-1' tabindex='9' /><span>Check Opt 2</span></label><label class='checkbox'><input type='checkbox' name='checkboxes_001[3]' value='1' id='checkboxes-001-3-1' tabindex='10' /><span>Check Opt 3</span></label><label class='checkbox'><input type='checkbox' name='checkboxes_001[4]' value='1' id='checkboxes-001-4-1' tabindex='11' /><span><img src=\"images/foo.jpg\" /></span></label></div>",
