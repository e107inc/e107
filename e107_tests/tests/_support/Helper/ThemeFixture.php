...
class ThemeFixture extends CodeceptionModule
{
	...
	private static $files = array('theme.php', 'theme.xml', 'fpw_template.php');
	...
	/** Put the site back on the theme this test found, then take the fixture themes back out and remove the probe. */
