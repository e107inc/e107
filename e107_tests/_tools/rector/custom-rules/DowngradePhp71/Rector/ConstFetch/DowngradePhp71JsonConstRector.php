...
namespace E107\Rector\DowngradePhp71\Rector\ConstFetch;
...
final class DowngradePhp71JsonConstRector extends AbstractRector
{
     ...
     * @var string
     */
    private const UNESCAPED_LINE_TERMINATORS = 'JSON_UNESCAPED_LINE_TERMINATORS';
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): Expr|If_|null|int
    {
        ...
        return $this->jsonConstCleaner->clean($node, [self::UNESCAPED_LINE_TERMINATORS]);
    }
