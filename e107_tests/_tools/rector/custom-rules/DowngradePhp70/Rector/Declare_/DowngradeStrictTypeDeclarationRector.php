...
namespace E107\Rector\DowngradePhp70\Rector\Declare_;
...
CODE_SAMPLE
    ...
    /**
     * @param Declare_ $node
     * @return int|null NodeVisitor::REMOVE_NODE to drop the declare, or null to keep it
     */
    public function refactor(Node $node)
    {
        ...
        // Rector 2.x dropped AbstractRector::removeNode(); returning the
        // php-parser REMOVE_NODE sentinel deletes the statement instead.
