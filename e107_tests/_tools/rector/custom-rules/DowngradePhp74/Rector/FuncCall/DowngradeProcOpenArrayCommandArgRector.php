...
namespace E107\Rector\DowngradePhp74\Rector\FuncCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?FuncCall
    {
        ...
        if ($this->isAlreadyDowngraded($firstArg->value)) {
            return null;
        }
    ...
    private function isAlreadyDowngraded(\PhpParser\Node $value): bool
    {
        return $value instanceof \PhpParser\Node\Expr\Ternary
            && $value->cond instanceof \PhpParser\Node\Expr\FuncCall
            && $this->isName($value->cond, 'is_array');
    }
}
