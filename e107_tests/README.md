...
You can generate code coverage reports for all PHP files in the app.  Code coverage is enabled for the unit suite but disabled for the acceptance suite by default.
