...
?>";
	...
	function create_tables() {
		...
		mysql_query("INSERT INTO `{$this->previous_steps['mysql']['prefix']}menus` VALUES (9, 'powered_by_menu', 2, 1, '0', '', 'powered_by_menu/')");
		...
		mysql_query("INSERT INTO `{$this->previous_steps['mysql']['prefix']}menus` VALUES (13, 'online_extended_menu', 2, 2, '0', '', 'online_extended_menu/')");
		...
		mysql_query("INSERT INTO {$this->previous_steps['mysql']['prefix']}generic VALUES (0, 'wmessage', 1145848343, 1, '', 0, '[center][img]{e_IMAGE}splash.jpg[/img][/center]')");
