...
//Check Opt 2, Check Opt 3
	...
	public function testRenderElement()
	{
		...
		$expected = array(
			...
			'templates_001'     => "<select name='templates_001' id='templates-001' class='tbox select form-control' tabindex='13'><option value='bbcode'>Bbcode</option><option value='forum_icons'>Forum Icons</option><option value='forum_poll'>Forum Poll</option><option value='forum_posted'>Forum Posted</option><option value='forum_post'>Forum Post</option><option value='forum_preview'>Forum Preview</option><option value='forum'>Forum</option><option value='forum_viewforum'>Forum Viewforum</option><option value='forum_viewtopic'>Forum Viewtopic</option><option value='newforumposts_menu'>Newforumposts Menu</option></select>",
