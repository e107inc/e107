...
//Check Opt 2, Check Opt 3
	...
	public function testRenderElement()
	{
		...
		$expected = array(
			...
			'checkboxes_001'       => "<div class='checkboxes' style='display:inline-block'><label class='checkbox'><input type='checkbox' name='checkboxes_001[1]' value='1' id='checkboxes-001-1-1' checked='checked' tabindex='1' />Check Opt 1</label><label class='checkbox'><input type='checkbox' name='checkboxes_001[2]' value='1' id='checkboxes-001-2-1' tabindex='2' />Check Opt 2</label><label class='checkbox'><input type='checkbox' name='checkboxes_001[3]' value='1' id='checkboxes-001-3-1' tabindex='3' />Check Opt 3</label><label class='checkbox'><input type='checkbox' name='checkboxes_001[4]' value='1' id='checkboxes-001-4-1' tabindex='4' /><img src=\"images/foo.jpg\" /></label></div>",
			...
			'ip_001'            =>  "<input type='text' name='ip_001' value='::1' maxlength=32  id='ip-001' class='tbox form-control' tabindex='13' />",
			'templates_001'     => "<select name='templates_001' id='templates-001' class='tbox select form-control' tabindex='14'><option value='bbcode'>Bbcode</option><option value='forum_icons'>Forum Icons</option><option value='forum_poll'>Forum Poll</option><option value='forum_post'>Forum Post</option><option value='forum_posted'>Forum Posted</option><option value='forum_preview'>Forum Preview</option><option value='forum'>Forum</option><option value='forum_viewforum'>Forum Viewforum</option><option value='forum_viewtopic'>Forum Viewtopic</option><option value='newforumposts_menu'>Newforumposts Menu</option></select>",
			...
			'tags_001'          => "<input type='text' name='tags_001' value='keyword1,keyword2,keyword3' maxlength=255  id='tags-001' tabindex='15' />",
