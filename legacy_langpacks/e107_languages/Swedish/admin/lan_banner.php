...
define("BNRLAN_2", "Vänligen bekräfta att du vill radera denna banner - väl raderad kan den inte återfås");
define("BNRLAN_5", "Bekräfta radering av banner");
...
define("BNRLAN_43", "Välj bannerbild");
define("BNRLAN_45", "Startar");
define("BNRLAN_46", "Kod");
define("BNRLAN_58", "banners förstasida");
