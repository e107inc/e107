...
$text = " file inspector, site serverindeki dosyalarýnýzý tarama ve analiz eder.Þayet  inspector bir 
 e107 core dosyasý bulursa özünün bozuk olup olmadýðýný kontrol eder.";

$ns -> tablerender("File Inspector Yardým", $text);
?>
