...
|
|     $Source: /cvs_backup/e107_langpacks/legacy_langpacks/e107_languages/Spanish/lan_login.php,v $
|     $Revision: 1.2 $
...
define("LAN_LOGIN_4", "Por favor escriba sus detalles para tener acceso");
define("LAN_LOGIN_5", "Pulse aquí para registrarse");
define("LAN_LOGIN_6", "No se aceptan miembros nuevos en este momento");
define("LAN_LOGIN_7", "Código");
define("LAN_LOGIN_8", "Recordarme");
define("LAN_LOGIN_9", "Conectar");
define("LAN_LOGIN_10", "Click para conectarse");
define("LAN_LOGIN_11", "Registrarse");
define("LAN_LOGIN_12", "Olvidé la contraseña");
define("LAN_LOGIN_13", "Escriba el texto de la imagen");
