...
|
|        $Source: /cvs_backup/e107_langpacks/legacy_langpacks/e107_languages/Danish/lan_submitnews.php,v $
|        $Revision: 1.1 $
...
define("LAN_134", "Dit indl&aelig;g er blevet modtaget og vil blive genneml&aelig;st og vurderet.");
define("LAN_135", "Nyhed: ");
define("LAN_136", "Send nyhed");
define("NWSLAN_6", "Kategori");
define("NWSLAN_10", "Ingen nyhedskategorier");
define("NWSLAN_11", "Du har ikke adgang til dette omr&aring;de.");
define("NWSLAN_12", "Adgang n&aelig;gtet.");
define("SUBNEWSLAN_1", "Du skal skrive en titel.");
define("SUBNEWSLAN_2", "Du skal skrive noget tekst i nyheden.");
define("SUBNEWSLAN_3", "Din vedh&aelig;ftning skal enten v&aelig;re et jpg, gif eller png fil");
