...
define("NLLAN_04", "Plugin för nyhetsbrev har installerats. För att konfigurera, gå till admins huvudsida och klicka på 'Nyhetsbrev' i plugin sektionen.");
...
define("NLLAN_13", "[ Värd ID ] Ämne/Titel");
define("NLLAN_14", "Skickat?");
define("NLLAN_15", "Alternativ");
define("NLLAN_16", "ja");
define("NLLAN_17", "Ej utsänt - klicka för att sända");
...
define("NLLAN_39", "Nyhetsbrevsutgåva sparad i databasen - för att skicka ut, klicka på 'Släpp utgåva' knappen i alternativmenyn.");
...
define("NLLAN_50", "Klicka på knappen för att prenumerera ( den prenumerationsadress är");
