...
|
|     $Source: /cvs_backup/e107_langpacks/legacy_langpacks/e107_plugins/chatbox_menu/languages/Spanish/Spanish_config.php,v $
|     $Revision: 1.4 $
|     $Date: 2006-03-14 20:39:27 $
|     $Author: natxocc $
+----------------------------------------------------------------------------+
*/
define("CHBLAN_1", "Parámetros de chatbox actualizados.");
...
define("CHBLAN_14", "Si activa, los enlaces de los mensajes serán cambiados por lo que ponga en el texto");
define("CHBLAN_15", "Reemplazar cadena si está activado");
define("CHBLAN_16", "Los enlaces serán reemplazados por esta cadena");
define("CHBLAN_17", "Contador de palabras ocultas");
define("CHBLAN_18", "Palabras mas largas del numero definido serán ocultadas");
define("CHBLAN_19", "Actualizar parámetros del chatbox");
define("CHBLAN_20", "Parámetros chatbox");
define("CHBLAN_21", "Purga");
define("CHBLAN_22", "Borrar mensajes más viejos de cierta fecha");
define("CHBLAN_23", "Borra mensajes más antiguos de ");
...
define("CHBLAN_36", "Mostrar opciones Chatbox");
