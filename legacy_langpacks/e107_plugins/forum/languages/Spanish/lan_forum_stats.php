...
|
|     $Source: /cvs_backup/e107_langpacks/legacy_langpacks/e107_plugins/forum/languages/Spanish/lan_forum_stats.php,v $
|     $Revision: 1.2 $
|     $Date: 2005-11-11 23:57:58 $
|     $Author: natxocc $
+----------------------------------------------------------------------------+
*/
define("e_PAGETITLE", "Estadísticas del foro");

define("FSLAN_1", "General");
define("FSLAN_2", "Foro abierto");
define("FSLAN_3", "Abierto para");
define("FSLAN_4", "Envíos totales");
define("FSLAN_5", "Temas del foro");
define("FSLAN_6", "Respuestas del foro");
define("FSLAN_7", "Temas vistos del foro");
define("FSLAN_8", "Tamaño de la base de datos (solo tablas)");
define("FSLAN_9", "Tamaño medio de la fila en la tabla del foro");
define("FSLAN_10", "Temas más activos");
define("FSLAN_11", "Rango");
define("FSLAN_12", "Tema");
define("FSLAN_13", "Respuestas");
define("FSLAN_14", "Iniciado por");
define("FSLAN_15", "Fecha");
define("FSLAN_16", "Temas más vistos");
