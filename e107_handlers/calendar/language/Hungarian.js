...
"Idõ kiválasztása:\n" +
"- Katt az idõ bármely részére a növeléséhez\n" +
"- vagy Shift-katt a csökkentéshez\n" +
"- vagy katt és fogd a gyorsabb kiválasztáshoz.";

Calendar._TT["PREV_YEAR"] = "Elõzõ év (tartsd a menühöz)";
Calendar._TT["PREV_MONTH"] = "Elõzõ hónap (tartsd a menühöz)";
Calendar._TT["GO_TODAY"] = "Ugrás mai napra";
Calendar._TT["NEXT_MONTH"] = "Következõ hónap (tartsd a menühöz)";
Calendar._TT["NEXT_YEAR"] = "Következõ év (tartsd a menühöz)";
...
Calendar._TT["DAY_FIRST"] = "%s elsõként megjelenít";
