 ...
 */
	...
	private function adminLinksArray() // Assuming this is inside a class; adjust the name if needed
	{
	    ...
	    $array_definitions = array(
	        ...
	        9  => array(e_ADMIN_ABS.'history.php', 'LAN_HISTORY', 'LAN_HISTORY', '0', 4, 'E_16_UNDO', 'E_32_UNDO'),
	        ...
	        17 => array(e_ADMIN_ABS.'newspost.php', 'ADLAN_0', 'ADLAN_1', 'H|N|H0|H1|H2|H3|H4|H5', 3, 'E_16_NEWS', 'E_32_NEWS'),
