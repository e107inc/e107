...
class e107_traffic {
    ...
    var $calPassBoth;   // Calibration offset when both parameters are passed
    var $calPassOne;    // Calibration offset when only one parameter is passed
    var $calTime;       // Total time spent in overhead, based on calibration
