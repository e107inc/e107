...
class e_pref extends e_front_model
{
	...
	public function save($from_post = true, $force = false, $session_messages = null)
	{
		...
		{
			e107::getMessage()->addInfo(LAN_SETTINGS_NOT_SAVED_AS_NO_CHANGES_WERE_MADE, $this->prefid, $session_messages)->moveStack($this->prefid);
			return 0;
		}
		...
		{
			e107::getMessage()->addInfo(LAN_SETTINGS_NOT_SAVED_AS_NO_CHANGES_WERE_MADE, $this->prefid, $session_messages);
