...
final class Message
{
     ...
     * @return string
     */
    private static function trimTrailingIncompleteUtf8Character($summary, $lookahead)
    {
        ...
        return (string) substr($summary, 0, $start);
    }
     ...
     * @return string
     */
    private static function normalizePathForOriginForm($path)
    {
        if (0 === strpos($path, '//')) {
            return '/'.ltrim($path, '/');
        }
     ...
     * @return string|null
     */
    private static function getHostFromHeaders(array $headers)
    {
