...
class JWK
{
    ...
    const KNOWN_UNSUPPORTED_EC_CURVES = [
        'P-521',   // RFC 7518
        'Ed25519', // RFC 8037
        'Ed448',   // RFC 8037
        'X25519',  // RFC 8037
     ...
     * @uses parseKey
     */
    public static function parseKeySet(array $jwks, $defaultAlg = null)
    {
        $keys = [];
     ...
     */
    public static function parseKey(array $jwk, $defaultAlg = null)
    {
        if (empty($jwk)) {
