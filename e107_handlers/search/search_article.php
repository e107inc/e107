...
$c = 0;
if($results = $sql -> db_Select("content", "*", "content_type=0 AND content_class!=255 AND (content_heading LIKE('%".$query."%') OR content_summary LIKE('%".$query."%')
 OR content_subheading LIKE('%".$query."%') OR content_content LIKE('%".$query."%')) ")){
