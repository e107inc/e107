...
$c = 0;
if($results = $sql -> db_Select("content", "*", "content_type=3 AND content_class!=255 AND (content_heading LIKE('%".$query."%') OR content_subheading LIKE('%".$query."%') OR content_content LIKE('%".$query."%')) ")){
